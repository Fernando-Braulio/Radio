        ...
        return (
          o(t, [
            ...
            },
            {
              ...
              value: function(t) {
                return Boolean(~this.getContentsLowercase().lastIndexOf(t));
              }
            },
            {
          ...
          o(t, [
            {
              ...
              value: function() {
                ...
                s(r + "[data-filter]").on("click.Filterizr", function(t) {
                  ...
                  e.setOptions({ filter: i }), e.filter(e.options.filter);
                }),
                  s(r + "[data-multifilter]").on("click.Filterizr", function(
                    t
                  ) {
                    var r = s(t.target),
            ...
            },
            {
              ...
              value: function() {
                ...
                s(t + "[data-filter]").off("click.Filterizr"),
                  s(t + "[data-multifilter]").off("click.Filterizr"),
                  s(t + "[data-shuffle]").off("click.Filterizr"),
                  s(t + "[data-search]").off("keyup.Filterizr"),
                  s(t + "[data-sortAsc]").off("click.Filterizr"),
                  s(t + "[data-sortDesc]").off("click.Filterizr");
              }
            }
          ]),
          t
