...
(function(c) {
  ...
  function s(b, a, d) {
    ...
    if (l[e]) return l[e];
    for (
      var c = [], b = b.cell(a, d).node().childNodes, a = 0, d = b.length;
      a < d;
      a++
    )
      c.push(b[a]);
  ...
  var n = c.fn.dataTable,
    h = function(b, a) {
      ...
      this.s.dt.settings()[0].responsive ||
        ...
        (this.c = c.extend(!0, {}, h.defaults, n.defaults.responsive, a)),
        (b.responsive = this),
        this._constructor());
    };
  c.extend(h.prototype, {
    ...
    _columnsVisiblity: function(b) {
      ...
      for (f = g.length; e < f; e++) {
        var m = g[e].columnIdx;
        "-" === i[m] &&
          (!d[m].control && d[m].minWidth) &&
          (o || 0 > a - d[m].minWidth ? ((o = !0), (i[m] = !1)) : (i[m] = !0),
          (a -= d[m].minWidth));
      }
      g = !1;
      e = 0;
    ...
    _classLogic: function() {
            ...
            if ("max-" === g) {
              ...
              if ("not-" === g) {
                ...
                for (g = a.length; d < g; d++)
                  -1 === a[d].name.indexOf(h) && f(c, a[d].name);
              }
            }
      ...
      e.each(function(b, e) {
        for (
          var d = b.className.split(" "), f = !1, h = 0, k = d.length;
          h < k;
          h++
        ) {
          var j = c.trim(d[h]);
    ...
    _resize: function() {
      ...
      l &&
        ...
        0 === a.page.info().recordsDisplay && a.draw());
    },
