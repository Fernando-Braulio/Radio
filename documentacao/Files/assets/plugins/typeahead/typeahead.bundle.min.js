          ...
          return (
            ...
            function() {
              ...
              return (
                ...
                (i = arguments),
                c <= 0
                  ? (clearTimeout(r), (r = null), (o = a), (s = t.apply(n, i)))
                  : r || (r = setTimeout(u, c)),
                s
              );
            }
    ...
    s = (function() {
      ...
      function o(t) {
        var e,
          ...
          r = u.length;
        for (e = 0; e < r; e++)
          (n = u.key(e)).match(t) && i.push(n.replace(t, ""));
        return i;
      }
      var u;
      try {
        (u = window.localStorage).setItem("~~~", "!"), u.removeItem("~~~");
      } catch (t) {
        u = null;
      }
      return (
        e.mixin(n.prototype, {
          ...
          set: function(t, n, s) {
            return (
              e.isNumber(s)
                ? this._safeSet(this._ttlKey(t), r(i() + s))
    ...
    o = (function() {
      ...
      function n(t) {
        (t = t || {}),
          ...
          (this._cache = !1 === t.cache ? new r(0) : u);
      }
      var i = 0,
        s = {},
        o = 6,
          ...
          search: function(t) {
            ...
            return (
              ...
              e.each(n, function(t) {
                ...
                (s = e[a].slice(0)), (r = r ? o(r, s) : s);
              }),
              r
                ? e.map(s(r), function(t) {
                    return c.datums[t];
                  })
                : []
            );
      ...
      function i(i) {
        ...
        return i
          ? ((r = {
            ...
            (i.transport = i.transport ? u(i.transport) : t.ajax),
            i)
          : null;
      }
      function r(n) {
        ...
        if (n)
          return (
            ...
            (n.prepare = s(n)),
            (n.limiter = o(n)),
            (n.transport = n.transport ? u(n.transport) : t.ajax),
            delete n.replace,
            delete n.wildcard,
  ...
  return (function() {
    ...
    return (
      ...
      e.mixin(n.prototype, {
        ...
        get: function(t) {
          return (
            (t = e.isArray(t) ? t : [].slice.call(arguments)), this.index.get(t)
          );
        },
    ...
    var e = (function() {
      ...
      n = (function() {
        ...
        function t(t) {
          ...
          return (
            (u = e.mixin({}, s, t)),
            (o = { css: r(), classes: u, html: n(u), selectors: i(u) }),
            {
              css: o.css,
              html: o.html,
              classes: o.classes,
      ...
      r = (function() {
        ...
        function r(t) {
          ...
          if (!this._callbacks) return this;
          for (
            t = t.split(u), i = [].slice.call(arguments, 1);
      ...
      s = (function(t) {
        ...
        return function(r) {
          function s(e) {
            ...
            return (
              (n = u.exec(e.data)) &&
                ((s = t.createElement(r.tagName)),
                r.className && (s.className = r.className),
                (i = e.splitText(n.index)).splitText(n[0].length),
          ...
          (r = e.mixin({}, i, r)).node &&
            ...
            (u = n(r.pattern, r.caseSensitive, r.wordsOnly)),
            o(r.node, s));
        };
      })(window.document),
      o = (function() {
        ...
        return (
          ...
          e.mixin(n.prototype, r, {
            ...
            _setQuery: function(t, e) {
              var n, i;
              (i = !!(n = s(t, this.query)) && this.query.length !== t.length),
                (this.query = t),
                e || n
      ...
      u = (function() {
        ...
        function n(n, r) {
          ((n = n || {}).templates = n.templates || {}),
            ...
            n.name && !u(n.name) && t.error("invalid dataset name: " + n.name),
            r.mixin(this),
        ...
        return (
          ...
          (n.extractData = function(e) {
            var n = t(e);
            return n.data(a.obj)
              ? { val: n.data(a.val) || "", obj: n.data(a.obj) || null }
              : null;
          }),
          e.mixin(n.prototype, r, {
              ...
              return (
                ...
                e.each(i, function(e) {
                  ...
                  (s = o._injectQuery(n, e)),
                    (i = t(o.templates.suggestion(s))
                      .data(a.obj, e)
                      .data(a.val, o.displayFn(e))
                      .addClass(
                ...
                this.highlight &&
                  s({ className: this.classes.highlight, node: r, pattern: n }),
                t(r)
              );
            },
            ...
            update: function(e) {
              function n(t) {
                o ||
                  ...
                  (u = t.length),
                  r._overwrite(e, t),
                  u < r.limit && r.async && r.trigger("asyncRequested", e));
              }
              function i(n) {
                (n = n || []),
                  !s &&
                    ...
                    ((r.cancel = t.noop),
                    (u += n.length),
                    r._append(e, n.slice(0, r.limit - u)),
      ...
      a = (function() {
        ...
        function n(n, i) {
          function r(e) {
            ...
            return (
              (e.node = n.length ? n : t("<div>").appendTo(s.$node)),
              new u(e, i)
            );
          }
          var s = this;
      ...
      c = (function() {
        ...
        var n = a.prototype;
        return (
          e.mixin(t.prototype, a.prototype, {
            open: function() {
              return (
        ...
        return (
          e.mixin(n.prototype, {
            ...
            _minLengthMet: function(t) {
              return (
                (t = e.isString(t) ? t : this.input.getQuery() || "").length >=
                this.minLength
              );
            },
              ...
              (t = this.menu.getTopSelectable()),
                ...
                !n || e.isBlankString(i) || this.input.hasOverflow()
                  ...
                  : ((r = o.normalizeQuery(i)),
                    ...
                    (u = new RegExp("^(?:" + s + ")(.+$)", "i").exec(n.val)) &&
                      this.input.setHint(i + u[1]));
            },
            isEnabled: function() {
              return this.enabled;
            },
          ...
          initialize: function(r, l) {
            function f() {
              ...
              e.each(l, function(t) {
                ...
                (A = _ ? c : a),
                (b = new i({ el: n })),
                (w = new o({ hint: m, input: n }, p)),
                (S = new A({ node: y, datasets: l }, p)),
                (x = new h(
                  { input: w, menu: S, eventBus: b, minLength: r.minLength },
                  p
                )),
                n.data(g.www, p),
                n.data(g.typeahead, x);
            }
            var p;
            return (
              (l = e.isArray(l) ? l : [].slice.call(arguments, 1)),
              (r = r || {}),
              (p = n(r.classNames)),
              this.each(f)
            );
