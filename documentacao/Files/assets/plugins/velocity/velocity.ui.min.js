!(function(a) {
  ...
  return (function(a, b, c, d) {
    ...
    (e.RegisterEffect = e.RegisterUI = function(a, b) {
      function c(a, b, c, d) {
        ...
        f.each(a.nodeType ? [a] : a, function(a, b) {
          ...
          "border-box" ===
            e.CSS.getPropertyValue(b, "boxSizing")
              .toString()
              .toLowerCase() && (i = ["height"]),
            f.each(i, function(a, c) {
          ...
          e.animate(
            ...
            { height: ("In" === b ? "+" : "-") + "=" + h },
            {
              queue: !1,
              easing: "ease-in-out",
              duration: c * ("In" === b ? 0.6 : 1)
            }
          );
      }
      return (
        (e.Redirects[a] = function(d, g, h, i, j, k, l) {
          var m = h === i - 1,
            n = 0;
          (l = l || b.loop),
            "function" == typeof b.defaultDuration
              ? (b.defaultDuration = b.defaultDuration.call(j, j))
              : (b.defaultDuration = parseFloat(b.defaultDuration));
          ...
          for (o = 0; o < b.calls.length; o++) {
            ...
            if (
              (void 0 !== g.duration
                ? (s = g.duration)
                : void 0 !== b.defaultDuration && (s = b.defaultDuration),
              (v.duration = s * ("number" == typeof t ? t : p)),
              (v.queue = g.queue || ""),
              (v.easing = u.easing || "ease"),
              (v.delay = parseFloat(u.delay) || 0),
              (v.loop = !b.loop && u.loop),
              (v._cacheValues = u._cacheValues || !0),
              0 === o)
            ) {
              if (
                ((v.delay += parseFloat(g.delay) || 0),
                0 === h &&
                  (v.begin = function() {
                    ...
                    b &&
                      "In" === b[0] &&
                      void 0 !== r.opacity &&
                      f.each(j.nodeType ? [j] : j, function(a, b) {
                        e.CSS.setPropertyValue(b, "opacity", 0);
                      }),
                      g.animateParentHeight &&
                        b &&
                        c(j, b[0], s + v.delay, g.stagger);
                  }),
                null !== g.display)
              )
                if (void 0 !== g.display && "none" !== g.display)
                  v.display = g.display;
                else if (/In$/.test(a)) {
              ...
              g.visibility &&
                "hidden" !== g.visibility &&
                (v.visibility = g.visibility);
            }
            if (o === b.calls.length - 1) {
              var x = function() {
                (void 0 !== g.display && "none" !== g.display) ||
                  !/Out$/.test(a) ||
                  f.each(j.nodeType ? [j] : j, function(a, b) {
                    e.CSS.setPropertyValue(b, "display", "none");
                  }),
                  g.complete && g.complete.call(j, j),
                  k && k.resolver(j || d);
              };
              (v.complete = function() {
                if (
                  ...
                  for (var c in b.reset)
                    if (b.reset.hasOwnProperty(c)) {
                      var f = b.reset[c];
                      void 0 !== e.CSS.Hooks.registered[c] ||
                        ("string" != typeof f && "number" != typeof f) ||
                        (b.reset[c] = [b.reset[c], b.reset[c]]);
                    }
    ...
    for (var j in e.RegisterEffect.packagedEffects)
      e.RegisterEffect.packagedEffects.hasOwnProperty(j) &&
        e.RegisterEffect(j, e.RegisterEffect.packagedEffects[j]);
    e.RunSequence = function(a) {
      var b = f.extend(!0, [], a);
      b.length > 1 &&
        (f.each(b.reverse(), function(a, c) {
          var d = b[a + 1];
          if (d) {
            var g = c.o || c.options,
              h = d.o || d.options,
