...
!(function(a) {
  ...
  (b.prototype = {
    ...
    add: function(b, c) {
      ...
      if (
        !(
          (d.options.maxTags && d.itemsArray.length >= d.options.maxTags) ||
          (b !== !1 && !b)
        )
      ) {
        if (
          ("string" == typeof b && d.options.trimValue && (b = a.trim(b)),
          "object" == typeof b && !d.objectItems)
        )
        ...
        if (!b.toString().match(/^\s*$/)) {
          ...
          if (!k || d.options.allowDuplicates) {
            if (
              !(
                d.items().toString().length + b.length + 1 >
                d.options.maxInputLength
              )
            ) {
              ...
              if ((d.$element.trigger(l), !l.cancel)) {
                ...
                if (
                  (m.data("item", b),
                  d.findInputWrapper().before(m),
                  m.after(" "),
                  d.isSelect &&
                    !a(
                      'option[value="' + encodeURIComponent(h) + '"]',
                      d.$element
                    )[0])
                ) {
                ...
                c || d.pushVal(),
                  (d.options.maxTags === d.itemsArray.length ||
                    d.items().toString().length === d.options.maxInputLength) &&
                    d.$container.addClass("bootstrap-tagsinput-max"),
      ...
      if (
        ...
        a(".tag", d.$container)
          ...
          a("option", d.$element)
            ...
            .remove(),
          -1 !== a.inArray(b, d.itemsArray) &&
            d.itemsArray.splice(a.inArray(b, d.itemsArray), 1);
      }
      c || d.pushVal(),
        d.options.maxTags > d.itemsArray.length &&
          d.$container.removeClass("bootstrap-tagsinput-max"),
