...
(function() {
        ...
        on: function(b, d, g, h, k) {
          ...
          if (0 > f.getListenerIndex(d)) {
            ...
            for (var w = f.length - 1; 0 <= w; w--)
              if (f[w].priority <= k)
                return f.splice(w + 1, 0, n), { removeListener: q };
            f.unshift(n);
          }
        ...
        fire: (function() {
          ...
          return function(k, n, q) {
            ...
            if (f) {
              var w = f.listeners;
              if (w.length)
                for (var w = w.slice(0), A, G = 0; G < w.length; G++) {
                  if (f.errorProof)
                    try {
                      A = w[G].call(this, q, n, b, h);
                    } catch (x) {}
                  else A = w[G].call(this, q, n, b, h);
  ...
  (function() {
    ...
    CKEDITOR.tools = {
      ...
      extend: function(a) {
        ...
        for (var k = 1; k < f; k++) {
          var d = arguments[k],
            n;
          for (n in d)
            if (!0 === b || null == a[n]) if (!c || n in c) a[n] = d[n];
        }
        return a;
      },
      ...
      transformPlainTextToHtml: function(a, f) {
        ...
        b ||
          (c = c.replace(
            new RegExp("\x3cbr\x3e(?\x3d\x3c/" + k + "\x3e)"),
            function(a) {
      ...
      normalizeCssText: function(a, f) {
        var b = [],
          c,
          k = CKEDITOR.tools.parseCssText(a, !0, f);
      ...
      normalizeHex: function(a) {
        return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(
          a,
          b,
          c,
          k
      ...
      parseCssText: function(a, f, b) {
        ...
        a.replace(/&quot;/g, '"').replace(
          ...
          function(a, b, k) {
            f &&
              ((b = b.toLowerCase()),
              "font-family" == b && (k = k.replace(/\s*,\s*/g, ",")),
              (k = CKEDITOR.tools.trim(k)));
            c[b] = k;
          }
        );
        return c;
      ...
      convertArrayToObject: function(a, f) {
        ...
        for (var c = 0, k = a.length; c < k; ++c) b[a[c]] = f;
        return b;
      },
      fixDomain: function() {
        for (var a; ; )
      ...
      enableHtml5Elements: function(a, f) {
        for (
          var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(
              " "
            ),
            c = b.length,
            k;
          ...
          (k = a.createElement(b[c])), f && a.appendChild(k);
      },
      checkIfAnyArrayItemMatches: function(a, f) {
        for (var b = 0, c = a.length; b < c; ++b) if (a[b].match(f)) return !0;
        return !1;
      },
      checkIfAnyObjectPropertyMatches: function(a, f) {
        for (var b in a) if (b.match(f)) return !0;
        return !1;
      },
      keystrokeToString: function(a, b) {
        var c = b & 16711680,
          ...
          e = [];
        c & CKEDITOR.CTRL &&
          (n.push(d ? "⌘" : a[17]), e.push(d ? a[224] : a[17]));
        c & CKEDITOR.ALT && (n.push(d ? "⌥" : a[18]), e.push(a[18]));
        c & CKEDITOR.SHIFT && (n.push(d ? "⇧" : a[16]), e.push(a[16]));
        k &&
          (a[k]
            ? (n.push(a[k]), e.push(a[k]))
            : (n.push(String.fromCharCode(k)), e.push(String.fromCharCode(k))));
      ...
      getCookie: function(a) {
        ...
        for (var b = document.cookie.split(";"), c, k, d = 0; d < b.length; d++)
          if (
            ((c = b[d].split("\x3d")),
            (k = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase())),
            k === a)
          )
      ...
      getCsrfToken: function() {
        ...
        if (!a || 40 != a.length) {
          ...
          for (c = 0; c < a.length; c++)
            var k = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36),
              b = b + (0.5 < Math.random() ? k.toUpperCase() : k);
          a = b;
  ...
  CKEDITOR.dtd = (function() {
    var a = CKEDITOR.tools.extend,
      d = function(a, b) {
        for (
          var c = CKEDITOR.tools.clone(a), k = 1;
          k < arguments.length;
          k++
        ) {
          b = arguments[k];
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getIndex: function(a) {
      function d(a, c) {
        ...
        return n && n.nodeType == CKEDITOR.NODE_TEXT
          ? b(n)
            ? d(n, c)
            : n
          : null;
  ...
  (function() {
    ...
    function c(a) {
      for (var b = 0, c = 0, f = h[a].length; c < f; c++)
        b += parseFloat(this.getComputedStyle(h[a][c]) || 0, 10) || 0;
      return b;
    }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
          ...
          if (c && c.type == CKEDITOR.NODE_ELEMENT) {
            for (
              ...
              if (
                ...
                return;
            if (b.isIdentical(c)) {
              for (var k = f ? b.getLast() : b.getFirst(); d.length; )
                d.shift().move(b, !f);
              c.moveChildren(b, !f);
              c.remove();
      ...
      getDocumentPosition: function(a) {
        ...
        if (
          ...
          var e = this.$.getBoundingClientRect(),
            ...
            h = !0;
          CKEDITOR.env.ie &&
            ((h = f.getDocumentElement().contains(this)),
          ...
          h &&
            ...
            (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ...
              : ((c = w ? d.$ : g), (b = c.scrollLeft), (c = c.scrollTop)),
            (b = e.left + b - m),
            (c = e.top + c - x));
        } else
          for (
            x = this, m = null;
            x && "body" != x.getName() && "html" != x.getName();

          ) {
            b += x.$.offsetLeft - x.$.scrollLeft;
            c += x.$.offsetTop - x.$.scrollTop;
            x.equals(this) ||
              ((b += x.$.clientLeft || 0), (c += x.$.clientTop || 0));
            for (; m && !m.equals(x); )
      ...
      scrollIntoParent: function(a, b, c) {
        ...
        function x(a, b) {
          ...
          f = a.getWindow();
          f.equals(b) ||
            ((f = x(CKEDITOR.dom.element.get(f.$.frameElement), b)),
            (c.x += f.x),
            (c.y += f.y));
          return c;
        }
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = h ? w.getBody() : w.getDocumentElement());
        CKEDITOR.env.webkit &&
          (w = this.getEditor(!1)) &&
          (w._.previousScrollTop = null);
        w = a.getWindow();
        d = x(this, w);
        var z = x(a, w),
          I = this.$.offsetHeight;
      ...
      copyAttributes: function(a, b) {
        ...
        for (var f = 0; f < c.length; f++) {
          var d = c[f],
            ...
            e;
          if (!(w in b))
            if ("checked" == w && (e = this.getAttribute(w)))
              a.setAttribute(w, e);
            else if (!CKEDITOR.env.ie || this.hasAttribute(w))
              (e = this.getAttribute(w)),
                null === e && (e = d.nodeValue),
                a.setAttribute(w, e);
        }
        "" !== this.$.style.cssText &&
  ...
  (function() {
            ...
            ? f.type == CKEDITOR.NODE_ELEMENT &&
              (f =
                0 < D
                  ...
                  : !1 === g(f, !0)
                    ? null
                    : f.getPreviousSourceNode(!0, r, g))
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f =
                    !1 === g(d, !0) ? null : d.getNextSourceNode(!0, r, g)))),
          f && !1 === g(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
    ...
    var f = CKEDITOR.dom.walker.empty(),
      D = (CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(
        (function(a) {
          var b = {},
            c;
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
            (b.type == CKEDITOR.NODE_ELEMENT &&
              (b.is(CKEDITOR.dtd.$inline) ||
                ...
                (!CKEDITOR.env.needsBrFiller && b.is(D) && f(b))))
            ? !0
            : !1;
        return !!(a ^ b);
      };
  ...
  (function() {
    ...
    function d(a, b, c, d, e) {
      function g(a, b, c, f) {
        var X = c ? a.getPrevious() : a.getNext();
        if (f && h) return X;
        l || f
          ? b.append(a.clone(!0, e), c)
          : (a.remove(), q && b.append(a, c));
        return X;
      }
      function m() {
        var a,
      ...
      function k() {
        ...
        b < t - 1 || b < F - 1 || c
          ? (c
              ? a.moveToPosition(J, CKEDITOR.POSITION_BEFORE_START)
              : F == b + 1 && y
                ? a.moveToPosition(p[b], CKEDITOR.POSITION_BEFORE_END)
                : a.moveToPosition(p[b + 1], CKEDITOR.POSITION_BEFORE_START),
            d &&
              (b = O[b + 1]) &&
              b.type == CKEDITOR.NODE_ELEMENT &&
      ...
      if (
        l &&
        J.type == CKEDITOR.NODE_TEXT &&
        (r.equals(J) ||
          (r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(J)))
      )
        c.append(a.document.createText(J.substring(H, E)));
      else {
        J.type == CKEDITOR.NODE_TEXT
          ? l
            ? (n = !0)
          ...
          : 0 < J.getChildCount()
            ? E >= J.getChildCount()
              ? ((J = J.getChild(E - 1)), (y = !0))
              : (J = J.getChild(E))
            : (B = y = !0);
        r.type == CKEDITOR.NODE_TEXT
          ? l
            ? (L = !0)
            : r.split(H)
          : 0 < r.getChildCount()
        ...
        for (
          ...
          U = Y.getNext();
          for (
            P != t || (Y.equals(p[P]) && t < F)
              ? b && (X = N.append(Y.clone(0, e)))
              : u
                ? g(Y, N, !1, v)
                : L && N.append(a.document.createText(Y.substring(H)));
            U;
        ...
        N = c;
        for (P = C; P <= F; P++)
          if (((c = p[P]), (U = c.getPrevious()), c.equals(O[P])))
            b && (N = N.getChild(0));
          else {
            P != F || (c.equals(O[P]) && F < t)
              ? b && (X = N.append(c.clone(0, e)))
              : y
                ? g(c, N, !1, B)
                : n && N.append(a.document.createText(c.substring(0, E)));
            if (P > ea) for (; U; ) U = g(U, N, !0);
            N = X;
          }
        l || k();
      }
    ...
    CKEDITOR.dom.range.prototype = {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            var g = function(a, b) {
              ...
              for (
                ...
                u = f != a ? f.getText() : f.substring(b);
                if (d.test(u)) return !1;
              }
              return !0;
            };
            ...
            E.type == CKEDITOR.NODE_TEXT
              ? (y &&
                  ((E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E),
                  (H = !!E)),
                E && ((r = E.getPrevious()) || (l = E.getParent())))
              : (y && (r = E.getChild(y - 1) || E.getLast()), r || (l = E));
            for (l = c(l); l || r; ) {
              if (l && !r) {
                !J && l.equals(m) && (J = !0);
                if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                (H && "inline" == l.getComputedStyle("display")) ||
                  ((H = !1), J ? (h = l) : this.setStartBefore(l));
                r = l.getPrevious();
              }
              for (; r; )
                if (((E = !1), r.type == CKEDITOR.NODE_COMMENT))
                  r = r.getPrevious();
                else {
                  if (r.type == CKEDITOR.NODE_TEXT)
                    ...
                    (r.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
                      (b && r.is("br"))) &&
                    !r.data("cke-bookmark")
                  )
                    if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                      u = r.getText();
                      if (d.test(u)) r = null;
                      else
                        for (
                          var y = r.$.getElementsByTagName("*"), v = 0, B;
                          (B = y[v++]);
            ...
            J = H = !1;
            E.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(E.substring(y)).length
                ? (H = !0)
                : ((H = !E.getLength()),
                  y == E.getLength()
                    ? (r = E.getNext()) || (l = E.getParent())
                    : g(E, y) && (l = E.getParent()))
              : (r = E.getChild(y)) || (l = E);
            for (; l || r; ) {
              if (l && !r) {
                ...
                if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                (H && "inline" == l.getComputedStyle("display")) ||
                  ((H = !1), J ? (q = l) : l && this.setEndAfter(l));
                r = l.getNext();
              }
              for (; r; ) {
                E = !1;
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            this.setStartAt(
              L,
              !L.is("br") &&
              ((!l && this.checkStartOfBlock()) || (l && L.contains(l)))
            ...
            this.setEndAt(
              L,
              (!l && this.checkEndOfBlock()) || (l && L.contains(l))
        ...
        if (!this.collapsed) {
          ...
          m &&
            ...
            (h
              ? h >= m.getLength()
                ? g.setStartAfter(m)
                : (g.setStartBefore(m), (c = 0))
              : g.setStartBefore(m));
          k &&
            k.type == CKEDITOR.NODE_TEXT &&
            (q
              ? q >= k.getLength()
                ? g.setEndAfter(k)
                : (g.setEndAfter(k), (l = 0))
          ...
          c &&
            (m = g[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
            this.setStartAt(
              m,
      ...
      splitBlock: function(a, b) {
        ...
        "br" != a &&
          (e ||
            ((e = this.fixBlock(!0, a)),
            (g = new CKEDITOR.dom.elementPath(this.endContainer, this.root)
              .block)),
          g || (g = this.fixBlock(!1, a)));
      ...
      _getTableElement: function(a) {
        ...
        return CKEDITOR.env.safari && d && c.equals(this.root)
          ...
          : this.getEnclosedNode()
            ...
            : d && e && (d.equals(e) || d.contains(e) || e.contains(d))
              ? b.getAscendant(a, !0)
              : null;
      },
      ...
      _find: function(a, b) {
        ...
        if (c && c.find)
          for (m = c.find(a), g = 0; g < m.count(); g++)
            if (((c = m.getItem(g)), b || !c.isReadOnly()))
              (k =
  ...
  (function() {
    ...
    function b(a, c, e, g) {
      ...
      if (!g) return 0;
      if (
        (k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) &&
        !k.check(c)
      )
    ...
    a.prototype = {
      getNextParagraph: function(a) {
        ...
        if (!this._.started) {
          ...
          h =
            x.endContainer.hasAscendant("pre", !0) ||
            x.startContainer.hasAscendant("pre", !0);
          x.enlarge(
            (this.forceBrBreak && !h) || !this.enlargeBr
              ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS
              : CKEDITOR.ENLARGE_BLOCK_CONTENTS
          );
          x.collapsed ||
            ((h = new CKEDITOR.dom.walker(x.clone())),
            ...
            (h.evaluator = m),
            (h = h.previous()),
            (this._.lastNode = h.getNextSourceNode(!0, null, x.root)),
            this._.lastNode &&
            ...
            (this._.lastNode && x.root.contains(this._.lastNode)) ||
              ((this._.lastNode = this._.docEndMarker = x.document.createText(
                ""
              )),
        ...
        for (this._.nextNode = null; m; ) {
          var K = 0,
            z = m.hasAscendant("pre"),
            I = m.type != CKEDITOR.NODE_ELEMENT,
            l = 0;
          if (I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0);
          else {
            var r = m.getName();
            if (
              ...
              m.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })
            ) {
              if ("br" == r) I = 1;
              else if (!h && !m.getChildCount() && "hr" != r) {
                d = m;
                w = m.equals(x);
                break;
              }
          ...
          if (h && !K)
            for (; !m.getNext(k) && !w; ) {
              r = m.getParent();
              if (r.isBlockBoundary(this.forceBrBreak && !z && { br: 1 })) {
                K = 1;
                I = 0;
                w || r.equals(x);
                h.setEndAt(r, CKEDITOR.POSITION_BEFORE_END);
                break;
              }
              m = r;
              I = 1;
          ...
          !m.equals(h.root)
            ...
            : !d || (this.enforceRealBlocks && d.is(n))
              ? ((d = this.range.document.createElement(a)),
                ...
                (A = G = !0))
              : "li" != d.getName()
                ? (h.checkStartOfBlock() && h.checkEndOfBlock()) ||
                  ((d = d.clone(!1)),
                  h.extractContents().appendTo(d),
                  d.trim(),
                  (G = h.splitBlock()),
                  ...
                  h.insertNode(d))
                : w ||
                  (this._.nextNode = d.equals(x)
                    ? null
                    : this._getNextSourceNode(
                        h.getBoundaryNodes().endNode,
                        1,
                        x
                      ));
        }
        A &&
          ...
          ("br" == A.getName()
            ? A.remove()
            : A.getLast() &&
              "br" == A.getLast().$.nodeName.toLowerCase() &&
              A.getLast().remove());
        G &&
          (A = d.getLast()) &&
          A.type == CKEDITOR.NODE_ELEMENT &&
          "br" == A.getName() &&
          (!CKEDITOR.env.needsBrFiller || A.getPrevious(g) || A.getNext(g)) &&
          A.remove();
        this._.nextNode ||
          (this._.nextNode =
            w || d.equals(x) || !x ? null : this._getNextSourceNode(d, 1, x));
        return d;
      },
  ...
  (function() {
    function a(a, b, c, d, e) {
      ...
      for (f in b) {
        ...
        l =
          "boolean" == typeof l
            ...
            : "function" == typeof l
              ? { match: l }
              : v(l);
        "$" != f.charAt(0) && (l.elements = f);
        c && (l.featureName = c.toLowerCase());
        var t = l;
        ...
        for (g in V) {
          ...
          for (C in F)
            "!" == C.charAt(0) &&
              ((C = C.slice(1)), y.push(C), (m[C] = !0), (B = !1));
          for (; (C = y.pop()); ) (F[C] = F["!" + C]), delete F["!" + C];
          p[r] = (B ? !1 : m) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        f = v(a[c]);
        l = !0 === f.classes || !0 === f.styles || !0 === f.attributes;
        t = f;
        g = r = u = void 0;
        for (u in V) t[u] = K(t[u]);
        p = !0;
        for (g in O) {
          u = O[g];
          r = t[u];
        ...
        if (!0 === f.elements || null === f.elements)
          ...
          for (k in ((t = f.elements), delete f.elements, t))
            if (b[k]) b[k][l ? "unshift" : "push"](f);
            else b[k] = [f];
      }
    }
    function d(a, c, d, e) {
          ...
          if (
            ...
            if (a)
              if (!0 === a) a = !0;
                ...
                for (var f = 0, l = c.length, t; f < l; ++f)
                  (t = c[f]), e[t] || (e[t] = a(t));
                a = !1;
              }
            else a = !1;
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        b = b.classes;
        if (a) {
          for (var d = !1, f = !0 === a, t = b.length; t--; )
            if (f || a(b[t])) b.splice(t, 1), (d = !0);
          a = d;
        } else a = !1;
    ...
    function f(a) {
      var b,
        ...
        f = {},
        t = 1;
      for (a = B(a); (b = a.match(p)); )
        (c = b[2])
          ? ((d = D(c, "styles")), (e = D(c, "attrs")), (c = D(c, "classes")))
          : (d = e = c = null),
          (f["$" + t++] = {
            elements: b[1],
            classes: c,
    ...
    function A(a, b, e, f) {
      var l = 0,
        u;
      f.toHtml && (b.name = b.name.replace(t, "$1"));
      if (f.doCallbacks && a.elementCallbacks) {
        a: {
          u = a.elementCallbacks;
          for (var v = 0, g = u.length, p; v < g; ++v)
            if ((p = u[v](b))) {
              u = p;
              break a;
            }
      ...
      if (f.doTransform && (u = a._.transformations[b.name])) {
        w(b);
        for (v = 0; v < u.length; ++v) r(a, b, u[v]);
        x(b);
      }
      if (f.doFilter) {
        a: {
          ...
          if (a || u) {
            ...
            if (u) for (B = 0, C = u.length; B < C; ++B) d(u[B], b, y, p);
            a = y;
          } else a = null;
        }
    ...
    function I(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || y.$block[a.name])
      );
    }
    function l(a, b, c) {
      var d = a.name;
      if (y.$empty[d] || !a.children.length)
        "hr" == d && "br" == b
          ? a.replaceWith(z())
          : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
      else if (y.$block[d] || "tr" == d)
        if ("br" == b)
          a.previous && !I(a.previous) && ((b = z()), b.insertBefore(a)),
            a.next && !I(a.next) && ((b = z()), b.insertAfter(a)),
          ...
          b: {
            e = y[b];
            for (var f = 0, t = d.length, l; f < t; ++f)
          ...
          if (e)
            ...
            for (
              ...
              (l = d[--t]),
                f &&
                (l.type == CKEDITOR.NODE_TEXT ||
                  (l.type == CKEDITOR.NODE_ELEMENT && y.$inline[l.name]))
                  ? (v ||
                      ((v = new CKEDITOR.htmlParser.element(b)),
                      v.insertAfter(a),
                      c.push({ check: "parent-down", el: v })),
                    v.add(l, 0))
                  : ((v = null),
                    (u = y[e.name] || y.span),
                    l.insertAfter(a),
    ...
    function J(a, b) {
      ...
      for (f in d)
        if ("class" == f)
          for (
            c = d[f].split(/\s+/), t = a.classes.join("|");
            (v = c.pop());

          ) {
            if (-1 == t.indexOf(v)) return !1;
          }
        else if (a.attributes[f] != d[f]) return !1;
      for (l in e) if (a.styles[l] != e[l]) return !1;
      return !0;
    }
    function H(a, b) {
      var c, d;
      ...
      if (a instanceof CKEDITOR.editor) {
        ...
        !0 === b
          ...
          : (b || (this.customConfig = !1),
            ...
            this.allow(
              L[a.enterMode] + " " + L[a.shiftEnterMode],
              "default",
              1
            ),
    ...
    CKEDITOR.filter.prototype = {
      allow: function(b, c, d) {
        ...
        if ("string" == typeof b) b = f(b);
          ...
          d &&
            ((d = v(d)),
            (e.classes = d["class"] ? d["class"].split(/\s+/) : null),
            (e.requiredClasses = e.classes),
            delete d["class"],
            (e.attributes = d),
            (e.requiredAttributes = d && CKEDITOR.tools.objectKeys(d)));
      ...
      applyTo: function(a, b, c, d) {
              ...
              a: {
                ...
                if (t)
                  for (p = 0; p < t.length; ++p)
                    if ((r = d.match(t[p])) && r[0].length == d.length) {
                      c = !0;
                      break a;
                    }
        ...
        for (; (p = a.pop()); )
          if (((c = p.el), c.parent))
            switch (((r = y[c.parent.name] || y.span), p.check)) {
              case "it":
                y.$removeEmpty[c.name] && !c.children.length
                  ? l(c, d, a)
                  : m(c) || l(c, d, a);
                break;
              case "el-up":
          ...
          for (e = 0; e < a.length; ++e) {
            ...
            for (l = 0; l < b.length; ++l)
              (t = b[l]),
                ...
                g instanceof CKEDITOR.style && (g = E(g)),
                c.push({
                  check: v == f ? null : v,
                  left: g,
                  right: "string" == typeof p ? u(p) : p
                });
            b = f;
            d[b] || (d[b] = []);
            d[b].push(c);
      ...
      check: function(a, b, c) {
        ...
        if ("string" == typeof a) {
          ...
          (d = a.getDefinition()),
            (e = d.styles),
            (t = d.attributes || {}),
            e && !CKEDITOR.tools.isEmpty(e)
              ? ((e = v(e)), (t.style = CKEDITOR.tools.writeCssText(e, !0)))
              : (e = {}),
            (e = {
              name: d.element,
              attributes: t,
              classes: t["class"] ? t["class"].split(/\s+/) : [],
              styles: e,
              children: []
            });
        ...
        if (!1 !== b && (g = this._.transformations[e.name])) {
          for (d = 0; d < g.length; ++d) r(this, e, g[d]);
          x(e);
        }
        A(this, t, u, {
          doFilter: !0,
        ...
        b =
          0 < u.length
            ? !1
            : CKEDITOR.tools.objectCompare(e.attributes, t.attributes, !0)
              ? !0
              : !1;
      ...
      transform: function(a, b) {
        if ("string" == typeof b) a.name = b;
          ...
          for (f in e)
            if ("class" == f)
              for (
                c = a.classes.join("|"), l = e[f].split(/\s+/);
                (v = l.pop());

              )
                -1 == c.indexOf(v) && a.classes.push(v);
  ...
  (function() {
    var a,
      d = function(b) {
        ...
        a ||
          (g && (a = !1 !== h.execCommand(g, { from: "keystrokeHandler" })),
                    ...
                    (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat)
                      ? (f.$.onreadystatechange = function() {
                          if (
                            ...
                            (f.$.onreadystatechange = null), w(b, !0);
                        })
                      : ((f.$.onload = function() {
                          setTimeout(function() {
                            w(b, !0);
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    load: function(a, d, b) {
      ...
      for (
        var c = this.loaded, e = this.registered, g = [], h = {}, k = {}, n = 0;
        n < a.length;
        n++
      ) {
        var q = a[n];
            ...
            a.call(
              ...
              function(a) {
                ...
                for (f in a) {
                  ...
                  if (!d[f]) {
                    if (k.icons)
                      for (var A = k.icons.split(","), G = A.length; G--; )
                        CKEDITOR.skin.addIcon(
                          A[G],
                          k.path +
                            "icons/" +
                            (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") +
                            A[G] +
                            ".png"
                        );
                    d[f] = 1;
  ...
  (function() {
    ...
    function h(a) {
      ...
      c.fn
        ? (c.fn.call(a, a.config),
          (CKEDITOR.getUrl(a.config.customConfig) != b && h(a)) ||
    ...
    function q(a) {
      CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function(
        b,
        c
      ) {
                ...
                (h =
                  h != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, h)
                    ...
                    : 0 <= CKEDITOR.tools.indexOf(k, "en")
                      ? "en"
                      : k[0])),
            r.langEntries && r.langEntries[h]
              ? ((a.lang[l] = r.langEntries[h]), (h = null))
              : f.push(CKEDITOR.getUrl(r.path + "lang/" + h + ".js")));
          e.push(h);
          d.push(r);
        }
        CKEDITOR.scriptLoader.load(f, function() {
          for (
            var c = ["beforeInit", "init", "afterInit"], f = 0;
            f < c.length;
            f++
          )
            for (var l = 0; l < d.length; l++) {
              ...
              0 === f &&
                ...
                v.lang &&
                v.langEntries &&
                (a.lang[v.name] = v.langEntries[e[l]]);
              if (v[c[f]]) v[c[f]](a);
            }
          a.fireOnce("pluginsLoaded");
          b.keystrokes && a.setKeystroke(a.config.keystrokes);
          for (l = 0; l < a.config.blockedKeystrokes.length; l++)
            a.keystrokeHandler.blockedKeystrokes[
              a.config.blockedKeystrokes[l]
            ] = 1;
          a.status = "loaded";
          a.fireOnce("loaded");
    ...
    function A(a, b) {
      ...
      for (
        var e = new CKEDITOR.dom.documentFragment(), f, g, k, h = 0;
        h < a.length;
        h++
      ) {
        var u = a[h],
          y = u.startContainer.getAscendant("tr", !0);
        c(u)
          ? (f ||
              ((f = y.getAscendant("table").clone()),
              f.append(
                y.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()
              ),
              e.append(f),
              (f = f.findOne("thead, tbody, tfoot"))),
            (g && g.equals(y)) || ((g = y), (k = y.clone()), f.append(k)),
            k.append(d(u)))
          : e.append(u.cloneContents());
      }
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function(g, h, k) {
      function n(a) {
        var b;
        if (0 < m.length)
          for (var c = 0; c < m.length; c++) {
            var d = m[c],
              e = d.name,
              f = CKEDITOR.dtd[e],
              l = z.name && CKEDITOR.dtd[z.name];
            (l && !l[e]) || (a && f && !f[a] && CKEDITOR.dtd[a])
              ? e == z.name && (D(z, z.parent, 1), c--)
              : (b || (q(), (b = 1)),
                (d = d.clone()),
                (d.parent = z),
                (z = d),
      ...
      function D(b, c, d) {
        ...
        var e = z;
        void 0 === b.previous &&
          (w(c, b) && ((z = c), G.onTagOpen(k, {}), (b.returnPoint = c = z)),
          f(b),
          (a(b) && !b.children.length) || c.add(b),
          "pre" == b.name && (l = !1),
          "textarea" == b.name && (I = !1));
        b.returnPoint
          ? ((z = b.returnPoint), delete b.returnPoint)
          : (z = d ? c : e);
      }
      function w(a, b) {
        if (
      ...
      var G = new CKEDITOR.htmlParser(),
        x =
          h instanceof CKEDITOR.htmlParser.element
            ? h
            : "string" == typeof h
              ? new CKEDITOR.htmlParser.element(h)
        ...
        if (a(f)) m.push(f);
          ...
          if ("br" == e) K.push(f);
            ...
            for (
              ...
              !((k = (g = z.name)
                ? CKEDITOR.dtd[g] ||
                  (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : c),
              f.isUnknown || z.isUnknown || k[e]);

            )
              if (z.isOptionalClose) G.onTagClose(g);
              else if (e in b && g in b)
                (g = z.children),
                  ((g = g[g.length - 1]) && "li" == g.name) ||
                    D((g = new CKEDITOR.htmlParser.element("li")), z),
                  !f.returnPoint && (f.returnPoint = z),
                  (z = g);
              else if (e in CKEDITOR.dtd.$listItem && !A(e, g))
                G.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
              else if (g in d && !A(e, g))
                !f.returnPoint && (f.returnPoint = z), (z = z.parent);
              else if ((g in CKEDITOR.dtd.$inline && m.unshift(z), z.parent))
                D(z, z.parent, 1);
              else {
                f.isOrphan = 1;
                break;
      ...
      G.onText = function(a) {
        if (
          !((z._.hasInlineStarted && !K.length) || l || I) &&
        ...
        var b = z.name,
          f = b
            ? CKEDITOR.dtd[b] ||
              (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
            : c;
        if (!I && !f["#"] && b in d) G.onTagOpen(e[b] || ""), G.onText(a);
        else {
          q();
          n();
          l || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    a.prototype = {
      ...
      addMany: function(a, c, d) {
        for (var g = [this.findIndex(c), 0], h = 0, k = a.length; h < k; h++)
          g.push({ value: a[h], priority: c, options: d });
      ...
      execOnName: function(a, c) {
        for (var d = 0, g = this.rules, h = g.length, k; c && d < h; d++)
          (k = g[d]),
            (a.nonEditable && !k.options.applyToAll) ||
              (a.nestedEditable && k.options.excludeNestedEditable) ||
              (c = c.replace(k.value[0], k.value[1]));
        return c;
      }
    };
  })();
  (function() {
        ...
        return function(e) {
          if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var t = [],
              ...
              p;
            if (l)
              for (u(l, 1) && t.push(l); l; )
                g(l) &&
                  (v = c(l)) &&
                  u(v) &&
                  ((p = c(v)) && !g(p)
                    ? t.push(v)
                    : (f(y).insertAfter(v), v.remove())),
                  (l = l.previous);
            for (l = 0; l < t.length; l++) t[l].remove();
            if ((t = !a || !1 !== ("function" == typeof d ? d(e) : d)))
              y ||
              CKEDITOR.env.needsBrFiller ||
              e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? y ||
                  ...
                  !(
                    ...
                    e.name in CKEDITOR.dtd.tr ||
                    e.name in CKEDITOR.dtd.$listItem
                  )
                  ? ((t = b(e)),
                    (t = !t || ("form" == e.name && "input" == t.name)))
                  : (t = !1)
                : (t = !1);
            t && e.add(f(a));
          }
      ...
      function u(a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          ...
          (c.index &&
            ...
            (a.value = c[0])),
          (!CKEDITOR.env.needsBrFiller && y && (!b || a.parent.name in B)) ||
            (!y && (((c = a.previous) && "br" == c.name) || !c || g(c))))
          ? !0
          : !1;
      }
      var p = { elements: {} },
    ...
    function w(a) {
      return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g, function(
        a
      ) {
        return (
          "\x3c!--" +
    ...
    function x(a, b) {
      ...
      a = a.replace(
        /<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g,
        function(a) {
          return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function(
            a,
            b
          ) {
      ...
      return (a = a.replace(
        ...
        function(a, c, d, e) {
          return "\x3c" + c + d + "\x3e" + G(A(e), b) + "\x3c/" + c + "\x3e";
        }
      ));
    }
      ...
      b.on(
        ...
        function(a) {
          ...
          CKEDITOR.env.ie &&
            9 > CKEDITOR.env.version &&
            "pre" == e &&
            ((e = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (l = 1));
          ...
          e &&
            ((l = c),
            !l.children.length &&
              CKEDITOR.dtd[l.name][e] &&
              ((e = new CKEDITOR.htmlParser.element(e)), l.add(e)));
          a.dataValue = c;
        },
        null,
        null,
    ...
    var m = /(?:&nbsp;|\xa0)$/,
      ...
      l = CKEDITOR.tools.extend({}, z.$blockLimit, z.$block),
      r = { elements: { input: k, textarea: k } },
      J = {
        attributeNames: [
          [/^on/, "data-cke-pa-on"],
        ...
        elements: {
          ...
          table: function(a) {
            a.children.slice(0).sort(function(a, b) {
              ...
              a.type == CKEDITOR.NODE_ELEMENT &&
                b.type == a.type &&
                ((c = CKEDITOR.tools.indexOf(I, a.name)),
                (d = CKEDITOR.tools.indexOf(I, b.name)));
              (-1 < c && -1 < d && c != d) ||
      ...
      new CKEDITOR.htmlParser.node(),
      {
        ...
        find: function(a, b) {
          ...
          for (h = 0; h < this.children.length; h++) {
            ...
            "function" == typeof a && a(k)
              ? d.push(k)
              : "string" == typeof a && k.name === a && d.push(k);
  ...
  (function() {
    ...
    function b(a) {
      ...
      h &&
        a.ui.space("contents").setStyle("height", CKEDITOR.tools.cssLength(h));
    ...
    CKEDITOR.editor.prototype.setMode = function(a, b) {
      ...
      if (a != d.mode && h && h[a]) {
        ...
        if (d.mode) {
          ...
          "source" == d.mode &&
            h == n &&
            (d.fire("lockSnapshot", { forceUpdate: !0 }), (q = 1));
    ...
    CKEDITOR.editor.prototype.resize = function(a, b, d, h) {
      ...
      h.setSize("width", a, !0);
      q && (q.style.width = "1%");
      var f = (h.$.offsetHeight || 0) - (n.$.clientHeight || 0),
  ...
  (function() {
    function a(a) {
      ...
      if (CKEDITOR.env.gecko || (CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller))
        if ((g = d(g, e))) g.appendBogus(), (y = CKEDITOR.env.ie);
      h(b, e.block, f) &&
        u.collapsed &&
        !u.getCommonAncestor().isReadOnly() &&
        ((e = u.clone()),
    ...
    function g(a) {
      ...
      if (e.startPath().contains(f)) {
        var u = e.clone();
        u.collapse(1);
        u.setStartAt(a, CKEDITOR.POSITION_AFTER_START);
        a = new CKEDITOR.dom.walker(u);
        a.guard = b();
        a.checkBackward();
        if (d)
          return (
            (u = e.clone()),
            u.collapse(),
            u.setEndAt(d, CKEDITOR.POSITION_AFTER_END),
            (a = new CKEDITOR.dom.walker(u)),
            (a.guard = b(!0)),
            (d = !1),
            a.checkForward(),
        ...
        insertElementIntoRange: function(a, b) {
          ...
          b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            (b.startContainer.is({
              ...
              ? m(b)
              : b.startContainer.is(CKEDITOR.dtd.$list) && K(b));
          var g, v;
          if (f)
            for (
              ;
              (g = b.getCommonAncestor(0, 1)) &&
              (v = CKEDITOR.dtd[g.getName()]) &&
              (!v || !v[e]);
        ...
        extractHtmlFromRange: function(a, b) {
          ...
          if (b) {
            ...
            c.autoParagraph(this.editor, a),
              w(a.startContainer) && a.startContainer.appendBogus();
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(a, "key", function(b) {
              ...
              if (0 !== b.getRanges().length) {
                if (c in y) {
                  ...
                  (e = g(b))
                    ? (a.fire("saveSnapshot"),
                      u.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START),
                      e.remove(),
                      u.select(),
                      a.fire("saveSnapshot"),
                      (d = 1))
                    : u.collapsed &&
                      ((C = p.block) &&
                      (k = C[c ? "getPrevious" : "getNext"](f)) &&
                      k.type == CKEDITOR.NODE_ELEMENT &&
                      k.is("table") &&
                      u[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                        ? (a.fire("saveSnapshot"),
                          u[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                            C.remove(),
                          u["moveToElementEdit" + (c ? "End" : "Start")](k),
                          u.select(),
                          a.fire("saveSnapshot"),
                          (d = 1))
                        : p.blockLimit &&
                          p.blockLimit.is("td") &&
                          (t = p.blockLimit.getAscendant("table")) &&
                          u.checkBoundaryOfElement(
                            t,
                            c ? CKEDITOR.START : CKEDITOR.END
                          ) &&
                          (k = t[c ? "getPrevious" : "getNext"](f))
                          ? (a.fire("saveSnapshot"),
                            u["moveToElementEdit" + (c ? "End" : "Start")](k),
                            u.checkStartOfBlock() && u.checkEndOfBlock()
                              ? k.remove()
                              : u.select(),
                            a.fire("saveSnapshot"),
                            (d = 1))
                          : (t = p.contains(["td", "th", "caption"])) &&
                            u.checkBoundaryOfElement(
                              t,
                              c ? CKEDITOR.START : CKEDITOR.END
                            ) &&
            ...
            CKEDITOR.env.gecko &&
              this.attachListener(this, "mouseup", function(b) {
                if (
                  2 == b.data.$.button &&
                  ((b = b.data.getTarget()), !b.getOuterHtml().replace(G, ""))
                ) {
                  var c = a.createRange();
    ...
    G = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi;
    x = (function() {
      function a(b) {
                ...
                H && u in CKEDITOR.dtd.$list
                  ...
                  : ((g = !!k[u]),
                    "br" != u ||
                      ...
                      (h && h != n - 1) ||
                      ((E =
                        (f = h ? y[h - 1].node : B.getItem(h + 1)) &&
                        (!a(f) || !f.is("br"))),
                      (f = f && a(f) && v.$block[f.getName()])),
                    -1 != L || g || (L = h),
                    g || (q = h),
                    y.push({
                      isElement: 1,
                    ...
                    (f = E = 0)))
              : y.push({ isElement: 0, node: e, allowed: 1 });
        -1 < L && (y[L].firstNotAllowed = 1);
        -1 < q && (y[q].lastNotAllowed = 1);
        return y;
      }
      function d(b, c) {
        var e = [],
      ...
      function f(b) {
        return (
          b &&
          a(b) &&
          (b.is(v.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
        );
      }
      function u(b, c, d, e) {
        var f = b.clone(),
        ...
        (g = new CKEDITOR.dom.walker(f).next()) &&
          ...
          (v = g.getPrevious()) &&
          a(v) &&
          !v.getParent().equals(b.startContainer) &&
          d.contains(v) &&
          e.contains(g) &&
          g.isIdentical(v) &&
          (g.moveChildren(v), g.remove(), u(b, c, d, e));
      }
      function g(b, c) {
        function d(b, c) {
          if (
      ...
      var v = CKEDITOR.dtd,
        ...
        n = CKEDITOR.tools.extend({}, v.$inline);
      delete n.br;
      return function(B, p, C, t) {
        var F = B.editor,
          N = !1;
        "unfiltered_html" == p && ((p = "html"), (N = !0));
        if (!t.checkReadOnly()) {
          var q =
            new CKEDITOR.dom.elementPath(t.startContainer, t.root).blockLimit ||
            t.root;
          B = {
            type: p,
            dontFilter: N,
          ...
          var m, w;
          "text" == B.type &&
            p.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) &&
            ((m = CKEDITOR.dom.element.createFromHtml(
              "\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
              p.document
            )),
            p.insertNode(m),
          ...
          for (; (w = e(p)) && a(w) && w.isBlockBoundary() && N.contains(w); )
            p.moveToPosition(w, CKEDITOR.POSITION_BEFORE_END);
          u(p, B.blockLimit, N, q);
          m && (p.setEndBefore(m), p.collapse(), m.remove());
          m = p.startPath();
          if ((F = m.contains(f, !1, 1)))
            p.splitElement(F),
              (B.inlineStylesRoot = F),
              (B.inlineStylesPeak = m.lastElement);
          m = p.createBookmark();
          (F = m.startNode.getPrevious(c)) && a(F) && f(F) && t.push(F);
          (F = m.startNode.getNext(c)) && a(F) && f(F) && t.push(F);
          for (F = m.startNode; (F = F.getParent()) && f(F); ) t.push(F);
          p.moveToBookmark(m);
          if ((m = C)) {
            m = B.range;
            if ("text" == B.type && B.inlineStylesRoot) {
              ...
              for (t = B.inlineStylesRoot.getParent(); !w.equals(t); )
                (p = p.appendTo(w.clone())), (w = w.getParent());
              C = p
                .getOuterHtml()
                .split("{cke-peak}")
                .join(C);
            }
            w = B.blockLimit.getName();
            ...
            if (
              ...
              a: {
                ...
                if (
                  ...
                  m = 0;
                  for (t = D.count(); m < t; m++)
                    if (((p = D.getItem(m)), !p.is(n))) break a;
          ...
          if (m) {
            ...
            var N = B.endPath.elements[0],
              ...
              q = N.getPosition(p),
              x =
                !!N.getCommonAncestor(p) &&
                q != CKEDITOR.POSITION_IDENTICAL &&
                !(
                  q &
            ...
            for (g(p, A); t < p.length; t++) {
              ...
              if ((M = q.isLineBreak)) {
                ...
                q.hasBlockSibling
                  ? (M = 1)
                  : (R = M.startContainer.getAscendant(v.$block, 1)) &&
                    R.is({ div: 1, p: 1 })
                    ? ((Z = R.getPosition(I)),
                      Z == CKEDITOR.POSITION_IDENTICAL ||
                      Z == CKEDITOR.POSITION_CONTAINS
                        ? (M = 0)
                        : ((I = M.splitElement(R)),
                          M.moveToPosition(I, CKEDITOR.POSITION_AFTER_START),
                          (M = 1)))
                    : (M = 0);
              }
              if (M) C = 0 < t;
                ...
                M = A.startPath();
                !q.isBlock &&
                  h(B.editor, M.block, M.blockLimit) &&
                  (S = k(B.editor)) &&
                  ((S = m.createElement(S)),
                  S.appendBogus(),
                  A.insertNode(S),
                  CKEDITOR.env.needsBrFiller &&
                    (z = S.getBogus()) &&
                    z.remove(),
                  A.moveToPosition(S, CKEDITOR.POSITION_BEFORE_END));
                if ((M = A.startPath().block) && !M.equals(G)) {
                  if ((z = M.getBogus())) z.remove(), D.push(M);
                  G = M;
                }
                q.firstNotAllowed && (F = 1);
                if (F && q.isElement) {
                  M = A.startContainer;
                  for (I = null; M && !v[M.getName()][q.name]; ) {
                    if (M.equals(w)) {
                      M = null;
                      break;
                    }
                ...
                q.lastNotAllowed &&
                  t < p.length - 1 &&
                  ((K = x ? N : K) &&
                    A.setEndAt(K, CKEDITOR.POSITION_AFTER_START),
                  (F = 0));
                A.collapse();
              }
            }
            1 != p.length
              ...
              : ((z = p[0]),
                (z =
                  z.isElement &&
                  "false" == z.node.getAttribute("contenteditable")));
            z &&
              ((C = !0),
              (M = p[0].node),
              A.setStartAt(M, CKEDITOR.POSITION_BEFORE_START),
              A.setEndAt(M, CKEDITOR.POSITION_AFTER_END));
            B.dontMoveCaret = C;
          ...
          for (W = z.createBookmark(); (G = B.zombies.pop()); )
            G.getParent() &&
              ((S = z.clone()),
              S.moveToElementEditStart(G),
              S.removeEmptyBlocksAtEnd());
          if (K)
            for (; (G = K.pop()); )
              CKEDITOR.env.needsBrFiller
                ? G.appendBogus()
                : G.append(z.document.createText(" "));
          for (; (G = B.mergeCandidates.pop()); ) G.mergeSiblings();
          z.moveToBookmark(W);
          if (!B.dontMoveCaret) {
            for (G = e(z); G && a(G) && !G.is(v.$empty); ) {
              if (G.isBlockBoundary())
                z.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
              else {
                if (f(G) && G.getHtml().match(/(\s|&nbsp;)$/g)) {
                  Q = null;
                  break;
                }
                Q = z.clone();
                Q.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
              }
              G = G.getLast(c);
            }
            Q && z.moveToRange(Q);
      ...
      return {
        list: {
          detectMerge: function(a, b) {
            ...
            a.mergeList =
              g && k && g.getParent().equals(k.getParent()) && !g.equals(k);
            a.mergeListItems =
              e.block &&
              f.block &&
              e.block.is(CKEDITOR.dtd.$listItem) &&
        ...
        table: (function() {
          function a(c) {
            ...
            g.guard = function(a, g) {
              if (a.type == CKEDITOR.NODE_ELEMENT) {
                var F = "visited_" + (g ? "out" : "in");
                if (a.getCustomData(F)) return;
                CKEDITOR.dom.element.setMarker(p, a, F, 1);
              }
              if (g && k && a.equals(k))
                (f = c.clone()),
                  f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END),
                  e.push(f);
              else if (!g && h && a.equals(h))
                (f = c.clone()),
                ...
                if ((F = !g))
                  F =
                    ...
                    (!k || b(a, k)) &&
                    (!h || b(a, h));
                F && ((f = c.clone()), f.selectNodeContents(a), e.push(f));
              }
            };
            g.lastForward();
          ...
          return {
            ...
            detectRanges: function(e, f) {
              ...
              p.is(CKEDITOR.dtd.$tableContent) &&
                !p.is(d) &&
                (p = p.getAscendant("table", !0));
              l = p;
              ...
              if (p || l)
                p && l && b(p, l)
                  ? ((e.tableSurroundingRange = k),
                    k.setStartAt(p, CKEDITOR.POSITION_AFTER_END),
                    k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                    (k = g.clone()),
                    k.setEndAt(p, CKEDITOR.POSITION_AFTER_END),
                    (h = g.clone()),
                  ...
                  : p
                    ? l ||
                      ((e.tableSurroundingRange = k),
                      k.setStartAt(p, CKEDITOR.POSITION_AFTER_END),
                      g.setEndAt(p, CKEDITOR.POSITION_AFTER_END))
                    : ((e.tableSurroundingRange = k),
                      k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                      g.setStartAt(l, CKEDITOR.POSITION_AFTER_START)),
                  (e.tableContentsRanges = h ? h : a(g));
            },
            deleteRanges: function(a) {
              for (var b; (b = a.tableContentsRanges.pop()); )
                b.extractContents(),
                  w(b.startContainer) && b.startContainer.appendBogus();
  ...
  (function() {
    function a(a, b) {
      ...
      if ((c = !b && 1 === a.length) && !(c = a[0].collapsed)) {
        ...
        c && c.equals(f) && !c.findOne("td, th, tr, tbody, table")
          ? ((e = e.cloneContents()),
            (c = e.getFirst()
              ? d(e.getFirst().getText()) !== d(c.getText())
              : !0))
          : (c = !1);
      }
      if (c) return !1;
    ...
    function e() {
      ...
      if (b) {
        ...
        if (!(d = !c) && (d = !c.isHidden())) {
          ...
          g && (t || f) ? (p && !h && d.selectRanges(e), (d = !0)) : (d = !1);
          d = !d;
        }
        d && (b.reset(), (b = 0));
      }
    ...
    function h() {
      l = null;
      r && (CKEDITOR.tools.setTimeout(e, 0, this), (r = !1));
    }
    function k(a) {
      return J(a) ||
      ...
      for (var b = 0; b < a.length; b++) {
        ...
        if (!c.collapsed) {
          ...
          d &&
            ...
            (f >= d.getLength() ? p.setStartAfter(d) : p.setStartBefore(d));
          e &&
            e.type == CKEDITOR.NODE_TEXT &&
            (g ? p.setEndAfter(e) : p.setEndBefore(e));
          ...
          d.evaluator = function(d) {
            if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
              ...
              d.getPosition(p.endContainer) & CKEDITOR.POSITION_CONTAINS ||
    ...
    CKEDITOR.on("instanceCreated", function(a) {
      ...
      c.on("contentDom", function() {
        ...
        function b() {
          ...
          u.removeListener("mouseup", b);
          var a = CKEDITOR.document.$.selection,
            c = a.createRange();
          "None" != a.type &&
            c.parentElement() &&
            c.parentElement().ownerDocument == k.$ &&
            c.select();
        }
        function d(a) {
          if (CKEDITOR.env.ie) {
            var b = (a = a.getRanges()[0])
        ...
        h.attachListener(
          ...
          function() {
            y &&
              ...
              (y =
                c._.previousActive &&
                c._.previousActive.equals(k.getActive())) &&
              null != c._.previousScrollTop &&
              c._.previousScrollTop != h.$.scrollTop &&
              (h.$.scrollTop = c._.previousScrollTop);
            c.unlockSelection(y);
            y = 0;
          },
          null,
        ...
        if (CKEDITOR.env.ie || l)
          x
            ? h.attachListener(h, "beforedeactivate", a, null, null, -1)
            : h.attachListener(c, "selectionCheck", a, null, null, -1),
            h.attachListener(
              h,
              ...
              u.on("mousedown", function(a) {
                function b(a) {
                  ...
                  if (m) {
                    ...
                    m.setEndPoint(
                      0 > w.compareEndPoints("StartToStart", c)
                        ? "EndToEnd"
                        : "StartToStart",
                      c
                    );
                ...
                function c() {
                  u.removeListener("mousemove", b);
                  p.removeListener("mouseup", c);
                  u.removeListener("mouseup", c);
                  m.select();
                }
                a = a.data;
                if (
                  ...
                  m = t.$.createTextRange();
                  try {
                    m.moveToPoint(a.$.clientX, a.$.clientY);
                  } catch (d) {}
                  w = m.duplicate();
                  u.on("mousemove", b);
                  p.on("mouseup", c);
        ...
        if (l && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          var r;
          h.attachListener(h, "mousedown", function() {
            r = 1;
          });
          h.attachListener(k.getDocumentElement(), "mouseup", function() {
            r && g.call(c);
            r = 0;
          });
        } else
          h.attachListener(
            CKEDITOR.env.ie ? h : k.getDocumentElement(),
            "mouseup",
            g,
            c
          );
          ...
          function() {
            ...
            c &&
              (c.getCustomData("ready")
                ? (f(a), a.editor.fire("selectionCheck"))
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
      ...
      _createFillingCharSequenceNode: q,
    ...
    CKEDITOR.dom.selection.prototype = {
        ...
        : function() {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              d == c.endContainer &&
                ...
                E[d.childNodes[c.startOffset].nodeName.toLowerCase()] &&
              ...
              var b = function(b, c) {
                ...
                for (
                  ...
                  if (
                    ...
                    (q = h.compareEndPoints("StartToStart", b)),
                    0 < q)
                  )
                    l = u - 1;
                  else if (0 > q) k = u + 1;
                  else return { container: d, offset: a(f) };
                if (-1 == u || (u == e.length - 1 && 0 > q)) {
                ...
                for (; 0 < h; )
                  try {
                    (g = f[0 < q ? "previousSibling" : "nextSibling"]),
                      g.nodeType == CKEDITOR.NODE_TEXT &&
                        ((h -= g.nodeValue.length), (n = g)),
                      (f = g);
                  } catch (m) {
      ...
      unlock: function(b) {
        if (this.isLocked) {
          ...
          this.reset();
          b &&
            (b = d || (e[0] && e[0].getCommonAncestor())) &&
            b.getAscendant("body", 1) &&
            (a(e)
              ? c.call(this, e)
              : f
                ? this.fake(d)
      ...
      selectRanges: function(b) {
        ...
        this.reset();
        if (e)
          for (var e = this.root, g, h = 0; h < b.length; ++h)
            (g = b[h]),
              g.endContainer.equals(e) &&
                (g.endOffset = Math.min(g.endOffset, e.getChildCount()));
        if (b.length)
          if (this.isLocked) {
            ...
            a: {
              ...
              if (
                ...
                l.type == CKEDITOR.NODE_ELEMENT &&
                ((C = C.clone()),
                C.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                (p = C.getEnclosedNode()) &&
            ...
            if (l) this.fake(l);
              ...
              if (x) {
                ...
                1 < b.length &&
                  ((d = b[b.length - 1]),
                  b[0].setEnd(d.endContainer, d.endOffset));
                d = b[0];
                b = d.collapsed;
                var t, F, m;
                if (
                ...
                if (
                  (d.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    d.startContainer.getName() in C) ||
                  (d.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                    d.endContainer.getName() in C)
                )
                  d.shrink(CKEDITOR.NODE_ELEMENT, !0), (b = d.collapsed);
                m = d.createBookmark();
                C = m.startNode;
                b || (k = m.endNode);
                ...
                k
                  ? ((l = d.document.$.body.createTextRange()),
                    l.moveToElementText(k.$),
                    m.setEndPoint("EndToEnd", l),
                    m.moveEnd("character", -1))
                  : ((t = C.getNext(p)),
                    (F = C.hasAscendant("pre")),
                    (t =
                      !(t && t.getText && t.getText().match(l)) &&
                      (F ||
                        !C.hasPrevious() ||
                        (C.getPrevious().is && C.getPrevious().is("br")))),
                    (F = d.document.createElement("span")),
                    F.setHtml("\x26#65279;"),
                    F.insertBefore(C),
                    t && d.document.createText("﻿").insertBefore(C));
                d.setStartBefore(C);
                C.remove();
                b
                  ? (t
                    ...
                    F.remove())
                  : (d.setEndBefore(k), k.remove(), m.select());
              } else {
                k = this.getNative();
                if (!k) return;
                ...
                for (m = 0; m < b.length; m++) {
                  if (
                    ...
                    (F = b[m + 1]),
                    (l = t.clone()),
                    l.setStart(t.endContainer, t.endOffset),
                    l.setEnd(F.startContainer, F.startOffset),
                    !l.collapsed &&
                      (l.shrink(CKEDITOR.NODE_ELEMENT, !0),
                      (d = l.getCommonAncestor()),
                      (l = l.getEnclosedNode()),
                      d.isReadOnly() || (l && l.isReadOnly())))
                  ) {
                    F.setStart(t.startContainer, t.startOffset);
                    b.splice(m--, 1);
                    continue;
                  }
                  d = b[m];
                  ...
                  d.collapsed &&
                    ...
                    "br" == t.getName()
                      ? (f(this.root),
                        d.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START))
                      : d.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
                  F.setStart(d.startContainer.$, d.startOffset);
                  try {
                    F.setEnd(d.endContainer.$, d.endOffset);
                  } catch (r) {
                    if (0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                      d.collapse(1), F.setEnd(d.endContainer.$, d.endOffset);
                    else throw r;
                  }
                  k.addRange(F);
                }
      ...
      selectBookmarks: function(b) {
        ...
        b.isFake &&
          ((d = a(c) ? c[0]._getTableElement() : c[0].getEnclosedNode()),
          (d && d.type == CKEDITOR.NODE_ELEMENT) ||
            (CKEDITOR.warn("selection-not-fake"), (b.isFake = 0)));
  ...
  (function() {
        ...
        for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r; ) {
          ...
          if (r.equals(u)) (r = null), (l = !0);
            ...
            var A = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
              ...
              D = A && r.getAttribute("data-nostyle");
            if (A && r.data("cke-bookmark")) {
            ...
            if (x && m && CKEDITOR.dtd.$block[A])
              for (
                var z = r,
                  ...
                  H = y.length,
                  I = 0,
                  z = H && new CKEDITOR.dom.range(z.getDocument());
                I < H;
                ++I
              ) {
                var E = y[I],
                  J = CKEDITOR.filter.instances[E.data("cke-filter")];
                if (J ? J.check(this) : 1)
                  z.selectNodeContents(E), b.call(this, z);
              }
            y = A ? (!q[A] || D ? 0 : x && !m ? 0 : d(r, u, h, V)) : 1;
            if (y)
              if (
                ((E = r.getParent()),
                (y = h),
                ...
                (I = k),
                !E ||
                  (!(E.getDtd() || CKEDITOR.dtd.span)[H] && !I) ||
                  (y.parentRule && !y.parentRule(E)))
              )
                l = !0;
              else {
                if (
                  (v ||
                    (A &&
                      CKEDITOR.dtd.$removeEmpty[A] &&
                      (r.getPosition(u) | V) != V) ||
                    ((v = c.clone()), v.setStartBefore(r)),
                  (A = r.type),
                  A == CKEDITOR.NODE_TEXT ||
                    x ||
                    (A == CKEDITOR.NODE_ELEMENT && !r.getChildCount()))
                ) {
                  for (
                    var A = r, L;
                    (l = !A.getNext(B)) &&
                    ((L = A.getParent()), q[L.getName()]) &&
                    d(L, w, h, O);
            ...
            r = r.getNextSourceNode(D || x);
          }
          if (l && v && !v.collapsed) {
            for (
              var l = K(this, f),
                x = l.hasAttributes(),
                D = v.getCommonAncestor(),
                A = {},
                y = {},
                E = {},
                H = {},
              ...
              if (D.getName() == g) {
                for (T in h.attributes)
                  !H[T] &&
                    (ba = D.getAttribute(Q)) &&
                    (l.getAttribute(T) == ba ? (y[T] = 1) : (H[T] = 1));
                for (Q in h.styles)
                  !E[Q] &&
                    (ba = D.getStyle(Q)) &&
                    (l.getStyle(Q) == ba ? (A[Q] = 1) : (E[Q] = 1));
              }
              D = D.getParent();
            }
            for (T in y) l.removeAttribute(T);
            for (Q in A) l.removeStyle(Q);
            x && !l.hasAttributes() && (l = null);
            l
              ? (v.extractContents().appendTo(l),
                v.insertNode(l),
                G.call(this, l),
                l.mergeSiblings(),
      ...
      function b() {
        for (
          var a = new CKEDITOR.dom.elementPath(d.getParent()),
            c = new CKEDITOR.dom.elementPath(q.getParent()),
            e = null,
            f = null,
            g = 0;
          g < a.elements.length;
        ...
        for (
          ...
          if (this.checkElementRemovable(k)) {
            ...
            (a.checkBoundaryOfElement(k, CKEDITOR.END) ||
              (m = a.checkBoundaryOfElement(k, CKEDITOR.START)))
              ? ((g = k), (g.match = m ? "start" : "end"))
              : (k.mergeSiblings(),
                k.is(this.element)
                  ? A.call(this, k)
                  : x(k, l(this)[k.getName()]));
          }
        if (g) {
          e = d;
          for (h = 0; ; h++) {
    ...
    function A(a, b) {
      ...
      for (g in d)
        if (
          ...
          a.getAttribute(g) == r(g, d[g])
        )
          (b && "data-" == g.slice(0, 5)) ||
            ((f = a.hasAttribute(g)), a.removeAttribute(g));
      for (var h in c)
        (this._.definition.fullMatch && a.getStyle(h) != r(h, c[h], !0)) ||
    ...
    function I(a, b) {
      for (var c in a)
        a[c] = a[c].replace(v, function(a, c) {
          return b[c];
        });
    }
    function l(a) {
    ...
    attachStyleStateChange: function(a, d) {
      ...
      b ||
        ...
        this.on("selectionChange", function(a) {
          for (var d = 0; d < b.length; d++) {
            var g = b[d],
              h = g.style.checkActive(a.data.path, this)
        ...
        if (n.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (
            ...
            if ((q = !g && "div" == q)) {
              a: {
                q = n.getChildren();
                for (var f = 0, D = q.count(); f < D; f++) {
                  var w = q.getItem(f);
                  if (
                    w.type == CKEDITOR.NODE_ELEMENT &&
                    CKEDITOR.dtd.$block[w.getName()]
                  ) {
                    q = !0;
                    break a;
                  }
  ...
  (function() {
    function a(a, c, d) {
      ...
      h.equals(n.getPrevious())
        ? ((c.startOffset =
            c.startOffset - h.getLength() - a.getPrevious().getLength()),
          (h = a.getNext()))
        : h.equals(a.getPrevious()) &&
          ((c.startOffset -= h.getLength()), (h = a.getNext()));
    ...
    var d = {
        ...
        return {
          getNextRange: function(h) {
            ...
            if (k && 1 < a.length) {
              ...
              for (k.moveToBookmark(d.shift()); q--; )
                (n = a[++g]),
                  n.moveToBookmark(d.shift()),
                  k.setEnd(n.endContainer, n.endOffset);
            }
            return k;
          }
        };
      ...
      createBookmarks: function(b) {
        for (var c = [], d, g = 0; g < this.length; g++) {
          ...
          for (var h = g + 1; h < this.length; h++)
            (this[h] = a(d, this[h])), (this[h] = a(d, this[h], !0));
        }
        return c;
      },
      createBookmarks2: function(a) {
...
*/
      ...
      CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(
        ...
        q,
        {
          ...
          reset: function() {
            ...
            e ||
              ((e = this.formLoadedNumber = CKEDITOR.tools.addFunction(
                function() {
                  this.fire("formLoaded");
                },
                this
              )),
              (m = this.formUnloadNumber = CKEDITOR.tools.addFunction(
                function() {
        ...
        uiElement: function(a, b, c, e, d, f, g) {
          if (!(4 > arguments.length)) {
            ...
            "function" == typeof b.setValue &&
              (this.setValue = CKEDITOR.tools.override(this.setValue, function(
                a
              ) {
                return function(c) {
            ...
            "function" == typeof b.getValue &&
              (this.getValue = CKEDITOR.tools.override(this.getValue, function(
                a
              ) {
                return function() {
  ...
  Area.prototype = {
    ...
    _layout: function() {
      ...
      f && f.isVisible() && l.bottom > d.top && l.bottom < d.bottom - r.height
        ? a.setStyles({
            position: "fixed",
            top: k(l.bottom)
          })
        : 0 < d.top
          ...
          : e.y + d.height - r.height > p.y
            ? a.setStyles({ position: "fixed", top: 0 })
            : a.setStyles({
                position: "absolute",
                top: k(e.y + d.height - r.height)
              });
      var n =
        "fixed" == a.getStyle("position")
          ? d.left
          : "static" != t.getComputedStyle("position")
            ? e.x - u.x
            : e.x;
      d.width < g + h
        ? e.x + g + h > p.x + q.width
        ...
        : e.x + g + h > p.x + q.width
          ? a.setStyle("left", k(n))
          : e.x + d.width / 2 + g / 2 + h > p.x + q.width
            ? a.setStyle("left", k(n - e.x + p.x + q.width - g - h))
  ...
  (function() {
    ...
    function y(b) {
          ...
          exec: function(b, a) {
            function c(a, g) {
              ...
              a
                ? ((a.method = "paste"),
                  a.dataTransfer ||
                    (a.dataTransfer = m.initPasteDataTransfer()),
                  q(b, a, g))
                : d &&
                  b.showNotification(
                    l,
      ...
      function k(a, c) {
        ...
        if (!d.getById("cke_pastebin")) {
          ...
          CKEDITOR.env.webkit
            ? (e.append(f),
              ...
              e.is("body") ||
                ...
                (k = k.getDocumentPosition().y)))
            : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(f);
          f.setStyles({
            position: "absolute",
          ...
          CKEDITOR.env.safari &&
            f.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text"));
          (k = f.getParent().isReadOnly())
            ? (f.setOpacity(0), f.setAttribute("contenteditable", !0))
            : f.setStyle(
          ...
          setTimeout(function() {
            CKEDITOR.env.webkit &&
              (CKEDITOR.document.getBody().$.scrollTop = p);
            h && h.removeListener();
      ...
      function v() {
        ...
        a.lock();
        if (b.editable().fire(m.mainPasteEvent) && !e("paste"))
          return a.unlock(), !1;
        a.unlock();
        return !0;
      }
      ...
      function t(a) {
        ...
        e && m.canClipboardApiBeTrusted(c.dataTransfer, b)
          ? (a.data.preventDefault(),
            setTimeout(function() {
              q(b, c);
            }, 0))
    ...
    function A(b, a) {
      function c(b) {
        return (
          CKEDITOR.tools.repeat("\x3c/p\x3e\x3cp\x3e", ~~(b / 2)) +
          (1 == b % 2 ? "\x3cbr\x3e" : "")
        );
      }
      a = a
      ...
      CKEDITOR.env.webkit &&
        ...
        a.match(/<div>(<br>|)<\/div>/) &&
          (a =
            "\x3cp\x3e" +
            a.replace(/(<div>(<br>|)<\/div>)+/g, function(b) {
        ...
        e.attachListener(
          ...
          function() {
            ...
            CKEDITOR.env.ie &&
              ...
              ((a.dragStartContainerChildCount = c
                ? g(c.startContainer)
                : null),
              (a.dragEndContainerChildCount = c ? g(c.endContainer) : null));
          },
          null,
          null,
          100
          ...
          if (CKEDITOR.env.edge) b.data.preventDefault();
            ...
            a && a.is && a.is("html")
              ...
              : CKEDITOR.env.ie &&
                ...
                b.data.$.dataTransfer.types.contains("Files") &&
                b.data.preventDefault();
          }
        });
        e.attachListener(
          ...
          b.on(
            ...
            function(a) {
              ...
              if (
                ...
                1 == h.getFilesCount() &&
                f != h.id &&
                ((h = h.getFile(0)), -1 != CKEDITOR.tools.indexOf(d, h.type))
              ) {
          ...
          function(a) {
            ...
            if (!a.data.dataValue) {
              ...
              if (d) (a.data.dataValue = d), (a.data.type = "html");
                ...
                (a.data.dataValue = b.editable().transformPlainTextToHtml(d)),
                  (a.data.type = "text");
            }
          },
          null,
        ...
        b.on(
          ...
          function(b) {
            ...
            -1 < a.indexOf("Apple-") &&
              ...
              -1 <
                a.indexOf('\x3cbr class\x3d"Apple-interchange-newline"\x3e') &&
                ((b.data.startsWithEOL = 1),
                (b.data.preSniffing = "html"),
                (a = a.replace(/<br class="Apple-interchange-newline">/, ""))),
              (a = a.replace(/(<[^>]+) class="Apple-[^"]*"/gi, "$1")));
            if (a.match(/^<[^<]+cke_(editable|contents)/i)) {
              var d,
                f,
                l = new CKEDITOR.dom.element("div");
              for (
                l.setHtml(a);
                1 == l.getChildCount() &&
                (d = l.getFirst()) &&
            ...
            CKEDITOR.env.ie
              ? (a = a.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(a, e) {
                  return e.toLowerCase() in c
                    ? ((b.data.preSniffing = "html"), "\x3c" + e)
                    : a;
                }))
              : CKEDITOR.env.webkit
                ? (a = a.replace(/<\/(\w+)><div><br><\/div>$/, function(a, e) {
                    return e in c
                      ? ((b.data.endsWithEOL = 1), "\x3c/" + e + "\x3e")
                      : a;
                  }))
        ...
        b.on(
          ...
          function(a) {
            ...
            var e = b._.nextPasteType || a.type,
              d = a.dataValue,
              f,
              n = b.config.clipboard_defaultContentType || "html",
            ...
            "text" == e && "html" == f
              ? (d = x(b, d, c.get("plain-text")))
              : l == CKEDITOR.DATA_TRANSFER_EXTERNAL &&
                b.pasteFilter &&
                !a.dontFilter &&
                (d = x(b, d, b.pasteFilter));
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      canClipboardApiBeTrusted: function(b, a) {
        return b.getTransferType(a) != CKEDITOR.DATA_TRANSFER_EXTERNAL ||
          ...
          (CKEDITOR.env.gecko &&
            (b.getData("text/html") || b.getFilesCount())) ||
          (CKEDITOR.env.safari &&
      ...
      fixSplitNodesAfterDrop: function(b, a, c, d) {
        ...
        "number" == typeof d &&
          "number" == typeof c &&
          g.type == CKEDITOR.NODE_ELEMENT &&
          (f(b.startContainer, g, c) || f(b.endContainer, g, d));
      },
      isDropRangeAffectedByDragRange: function(b, a) {
        var c = a.startContainer,
          d = a.endOffset;
        return (b.endContainer.equals(c) && b.endOffset <= d) ||
          (b.startContainer.getParent().equals(c) &&
            b.startContainer.getIndex() < d) ||
          (b.endContainer.getParent().equals(c) &&
            b.endContainer.getIndex() < d)
          ? !0
          : !1;
      },
      ...
      getRangeAtDropPosition: function(b, a) {
        ...
        if (
          ...
          a.document.$.caretRangeFromPoint(d, f)
        )
          (c = a.document.$.caretRangeFromPoint(d, f)),
          ...
          if (document.body.createTextRange) {
            ...
            try {
              ...
              if (h) {
                ...
                q = m.getClientRect();
                d < q.left
                  ? e.setStartAt(m, CKEDITOR.POSITION_AFTER_START)
                  : e.setStartAt(m, CKEDITOR.POSITION_BEFORE_END);
                e.collapse(!0);
              }
            } catch (u) {
              return null;
    ...
    var n = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported
      ? "cke/id"
      : "Text";
      ...
      getData: function(b, a) {
        ...
        "text/html" != b || a
          ? "Text" == b &&
            ...
            (c = "")
          : ((c = c.replace(this._.metaRegExp, "")),
            (d = this._.bodyRegExp.exec(c)) &&
              d.length &&
              ((c = d[1]), (c = c.replace(this._.fragmentRegExp, ""))));
        "string" === typeof c &&
          ((d = c.indexOf("\x3c/html\x3e")),
          (c = -1 !== d ? c.substring(0, d + 7) : c));
        return c;
      },
        ...
        onKeyDown: function(a, b) {
          ...
          switch (e) {
            ...
            case "mouseup":
              return (
                (d = this._.focusIndex),
                (c = 0 <= d && this.element.getElementsByTag("a").getItem(d)) &&
                  (c.$[e] ? c.$[e]() : c.$["on" + e]()),
                !1
              );
          }
      ...
      proto: {
        ...
        render: function(a, b) {
          ...
          c = {
            ...
            cls: this.className || "",
            titleJs:
              c.gecko && !c.hc ? "" : (this.title || "").replace("'", ""),
            keydownFn: m,
            focusFn: n,
            clickFn: e
          };
  ...
  (function() {
      ...
      function f(b) {
        ...
        for (
          var g = l.isIndent ? 1 : -1,
            ...
            h = k[e.getCustomData("listarray_index")].indent,
      ...
      for (
        ...
        if (!b) {
          ...
          h &&
            ...
            h.getName() in p &&
            (c.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
    ...
    CKEDITOR.plugins.add("indentlist", {
      ...
      init: function(d) {
            ...
            function(f) {
              ...
              if (
                ...
                !n ||
                  ...
                  (d.execCommand(this.relatedGlobal), f.cancel());
              }
            },
            this
          );
        ...
        l.registerCommands(d, {
          indentlist: new f(d, "indentlist", !0),
          outdentlist: new f(d, "outdentlist")
        });
    ...
    function r(c, b) {
      ...
      for (var g = 0; g < d.length; g++)
        (a = d[g].toLowerCase()),
          (f = b[a]),
          0 < g && e.push(","),
          e.push("'", f ? p(encodeURIComponent(b[a])) : "", "'");
      e.push(")");
      return e.join("");
    }
    function n(c) {
    ...
    CKEDITOR.plugins.link = {
      getSelectedLink: function(c, b) {
        ...
        for (d = 0; d < f.length; d++)
          if (
            ((g = a.getRanges()[d]),
            g.shrink(CKEDITOR.SHRINK_TEXT, !1, { skipBogus: !0 }),
      ...
      getEditorAnchors: function(c) {
        for (
          ...
          (e.data("cke-saved-name") || e.hasAttribute("name")) &&
            d.push({
              name: e.data("cke-saved-name") || e.getAttribute("name"),
              id: e.getAttribute("id")
            });
        for (f = 0; (e = a.getItem(f++)); )
          (e = this.tryRestoreFakeAnchor(c, e)) &&
            d.push({ name: e.getAttribute("name"), id: e.getAttribute("id") });
        return d;
      },
      fakeAnchor: !0,
      ...
      parseLinkAttributes: function(c, b) {
            ...
            : f &&
              a.replace(B, function(a, b, c) {
                if (b == d.name) {
                  ...
                  b = /(^')|('$)/g;
                  c = c.match(/[^,\s]+/g);
                  for (var e = c.length, f, h, k = 0; k < e; k++)
                    (f = decodeURIComponent),
                      (h = c[k].replace(b, "").replace(/\\'/g, "'")),
                      (h = f(h)),
                      (f = d.params[k].toLowerCase()),
                      (a[f] = h);
        ...
        if (b) {
          if ((a = b.getAttribute("target")))
            ...
            for (g.target = { type: "popup", name: a[1] }; (f = D.exec(a[2])); )
              ("yes" != f[2] && "1" != f[2]) ||
              f[1] in { height: 1, width: 1, top: 1, left: 1 }
                ? isFinite(f[2]) && (g.target[f[1]] = f[2])
                : (g.target[f[1]] = !0);
    ...
    CKEDITOR.unlinkCommand.prototype = {
      exec: function(c) {
        if (CKEDITOR.env.ie) {
          ...
          b.collapsed &&
            a &&
            ((d = b.createBookmark()), b.selectNodeContents(a), b.select());
        }
    ...
    CKEDITOR.removeAnchorCommand.prototype = {
      exec: function(c) {
        ...
        if (
          ...
          (d.getChildCount()
            ? d.is("a")
            : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, d))
        )
          d.remove(1);
    ...
    function ca(a) {
      ...
      return !f && 0 <= c.size.top && q(d.y, 0, c.size.top + e)
        ...
        : f &&
          ...
          ? ((a =
              a.inInlineMode ||
              q(c.size.bottom, b.pane.height - e, b.pane.height)
                ? D
                : x),
            new z([c, null, da, M, a]))
          : null;
        ...
        a.on(
          ...
          function() {
            ...
            d.is(B.$inline) ||
              ...
              d.attachListener(b.inInlineMode ? d : g, "mousemove", function(
                c
              ) {
                f = !0;
  ...
  (function() {
    function l(a, c, f) {
      ...
      d
        ? f()
        : ((a = CKEDITOR.getUrl(
            a.config.pasteFromWordCleanupFile || c + "filter/default.js"
          )),
        ...
        a.addCommand("pastefromword", {
          ...
          exec: function(a, b) {
            ...
            a.execCommand("paste", {
              type: "html",
              notification:
                b && "undefined" !== typeof b.notification ? b.notification : !0
            });
          }
        });
        a.ui.addButton &&
        ...
        a.on(
          ...
          function(d) {
            var b = d.data,
              g =
                (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported
                  ? b.dataTransfer.getData("text/html", !0)
                  : null) || b.dataValue,
              e = { dataValue: g },
        ...
        b.data.name in c.options.disablingCommandExec && "wysiwyg" == a.mode
          ...
          : ("bold" !== b.data.name &&
            ...
            a.fire("reloadMarkupScayt", {
              removeOptions: { removeInside: g, forceBookmark: f, language: e },
              timeout: 0
            }));
      });
    ...
    menuGenerator: function(a, c) {
      ...
      h
        ...
        : k &&
          ...
          (m = d.getProblemDescriptionText(e, g)),
          b.grayt_problemdescription &&
            m &&
            (b.grayt_problemdescription.label = m),
      ...
      for (var l in b)
        (h &&
          ...
          (k &&
            "grayt_problemdescription" !== l &&
            -1 == CKEDITOR.tools.indexOf(f, l.replace("grayt_", "")) &&
            "all" != a.config.scayt_contextCommands) ||
          ((e[l] =
    ...
    CKEDITOR.plugins.add("stylescombo", {
      ...
      init: function(c) {
        ...
        c.ui.addRichCombo("Styles", {
          ...
          onOpen: function() {
            var b = c.getSelection().getSelectedElement() || c.editable(),
              b = c.elementPath(b),
              a = [0, 0, 0, 0];
            this.showAll();
            this.unmarkAll();
  ...
  (function() {
    function q(d, f) {
      ...
      function c(b) {
        0 < e.length ||
          b.type != CKEDITOR.NODE_ELEMENT ||
          !F.test(b.getName()) ||
          b.getCustomData("selected_cell") ||
          (CKEDITOR.dom.element.setMarker(a, b, "selected_cell", !0),
          e.push(b));
      }
      var e = [],
        a = {};
      ...
      for (var g = d.getRanges(), k = 0; k < g.length; k++) {
        var h = g[k];
        if (h.collapsed)
          (h = h.getCommonAncestor().getAscendant({ td: 1, th: 1 }, !0)) &&
            b(h) &&
            e.push(h);
        else {
          var h = new CKEDITOR.dom.walker(h),
            l;
          for (h.guard = c; (l = h.next()); )
            (l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table)) ||
              ((l = l.getAscendant({ td: 1, th: 1 }, !0)) &&
                !l.getCustomData("selected_cell") &&
                b(l) &&
                (CKEDITOR.dom.element.setMarker(a, l, "selected_cell", !0),
                e.push(l)));
        }
      }
    ...
    function r(d, f) {
      for (
        ...
        var h;
        1 < e[k].rowSpan && g && e[k] == g[k]
          ? ((h = e[k]), (h.rowSpan += 1))
          : ((h = new CKEDITOR.dom.element(e[k]).clone()),
            h.removeAttribute("rowSpan"),
            h.appendBogus(),
            c.append(h),
            (h = h.$));
        k += h.colSpan - 1;
    ...
    function B(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        for (d = a; d <= g; d++) {
          for (
            var k = e[d], h = new CKEDITOR.dom.element(c.$.rows[d]), l = 0;
            l < k.length;
            l++
          ) {
            ...
            1 == m.$.rowSpan
              ...
              : (--m.$.rowSpan,
                n == d &&
                  ((n = e[d + 1]),
                  n[l - 1]
                    ? m.insertAfter(new CKEDITOR.dom.element(n[l - 1]))
                    : new CKEDITOR.dom.element(c.$.rows[d + 1]).append(m, 1)));
            l += m.$.colSpan - 1;
          }
          b.push(h);
        }
        ...
        a = new CKEDITOR.dom.element(
          e[g + 1] || (0 < a ? e[a - 1] : null) || c.$.parentNode
        );
    ...
    function v(d, f) {
      for (var b = d.getParent().$.cells, c = 0, e = 0; e < b.length; e++) {
        var a = b[e],
          c = c + (f ? 1 : a.colSpan);
        if (a == d.$) break;
      }
    ...
    function u(d, f) {
      for (
        ...
        c.push(g[h][a]), e.push(f ? g[h][a - 1] : g[h][a + 1]);
      for (h = 0; h < k; h++)
        c[h] &&
          (1 < c[h].colSpan && e[h] == c[h]
            ? ((g = c[h]), (g.colSpan += 1))
            : ((a = new CKEDITOR.dom.element(c[h])),
              (g = a.clone()),
              g.removeAttribute("colSpan"),
              g.appendBogus(),
              g[f ? "insertBefore" : "insertAfter"].call(g, a),
              b.push(g),
              (g = g.$)),
          (h += g.rowSpan - 1));
      return b;
    ...
    function y(d) {
      ...
      for (d = g.length; m < d; m++)
        for (var n = 0, p = g[m].length; n < p; n++)
          void 0 === k && g[m][n] == e.$ && (k = n), g[m][n] == a.$ && (h = n);
      for (m = k; m <= h; m++)
        for (n = 0; n < g.length; n++)
          (a = g[n]),
            (e = new CKEDITOR.dom.element(c.$.rows[n])),
            (a = new CKEDITOR.dom.element(a[m])),
            a.$ &&
              (1 == a.$.colSpan ? a.remove() : --a.$.colSpan,
              (n += a.$.rowSpan - 1),
              e.$.cells.length || l.push(e));
      k =
        g[0].length - 1 > h
          ? new CKEDITOR.dom.element(g[0][h + 1])
          : k && -1 !== g[0][k - 1].cellIndex
            ? new CKEDITOR.dom.element(g[0][k - 1])
    ...
    function z(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        a: {
          ...
          e = b.length - 1;
          for (var g = {}, k, h; (k = b[a++]); )
            CKEDITOR.dom.element.setMarker(g, k, "delete_cell", !0);
          for (a = 0; (k = b[a++]); )
            if (
              ((h = k.getPrevious()) && !h.getCustomData("delete_cell")) ||
              ((h = k.getNext()) && !h.getCustomData("delete_cell"))
            ) {
          ...
          (a = a.getPrevious())
            ? (e = a.getLast())
            : ((a = b[e].getParent()),
              (e = (a = a.getNext()) ? a.getChild(0) : null));
        }
        d.reset();
    ...
    function x(d, f, b) {
      ...
      if (f) {
        ...
        try {
          ...
          n =
            g["up" == f ? l - p : "down" == f ? l + p : l][
              "left" == f ? m - a : "right" == f ? m + a : m
            ];
        } catch (x) {
          return !1;
        }
  ...
  (function() {
    function x(a, b) {
      ...
      for (c = h; c <= m; c++)
        for (h = f; h <= p; h++)
          (d = new CKEDITOR.dom.element(e[c][h])),
            d.$ &&
              !d.getCustomData("selected_cell") &&
              (l.push(d),
              CKEDITOR.dom.element.setMarker(k, d, "selected_cell", !0));
      CKEDITOR.dom.element.clearAllMarkers(k);
      return l;
    }
    function G(a) {
      if (a)
        return (
          ...
          (a = a.getEnclosedNode()) && a.is && a.is(CKEDITOR.dtd.$tableContent)
        );
    }
    function H(a) {
      return (
    ...
    function y(a, b) {
      ...
      for (d = 0; d < c.count(); d++)
        c.getItem(d).removeClass("cke_table-faked-selection");
      0 < c.count() &&
        c
          .getItem(0)
          .getAscendant("table")
    ...
    function J(a, b, c) {
      ...
      if (e) (g.first = b || d[0]), (g.dirty = b ? !1 : 1 !== d.length);
        ...
        g.active &&
        b &&
        g.first.getAscendant("table").equals(b.getAscendant("table"))
      ) {
        d = x(g.first, b);
    ...
    function K(a) {
      ...
      if (b && (y(a), b.isInTable() && b.isFake)) {
        1 === c.length &&
          ...
          (d = c[0]._getTableElement());
        d = u(b, d);
        a.fire("lockSnapshot");
        for (b = 0; b < d.length; b++)
          d[b].addClass("cke_table-faked-selection");
        0 < d.length &&
    ...
    function v(a) {
      ...
      function d(a, d, e, k) {
        return ("mousedown" !== a.name ||
          (CKEDITOR.tools.getMouseButton(a) !== CKEDITOR.MOUSE_BUTTON_LEFT &&
            k)) &&
          ("mouseup" !== a.name || c(a.data.getTarget()) || b(e, k))
          ? !1
          : !0;
      }
      if (a.data.getTarget().getName) {
        ...
        !g.active &&
          ...
          l &&
          ((g = { active: !0 }),
          CKEDITOR.document.on("mouseup", v, null, { editor: e }));
        (k || l) && J(e, k || l, a);
        "mouseup" === a.name &&
          (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT &&
            (c(a.data.getTarget()) || b(m, l)) &&
            I(e),
          (g = { active: !1 }),
    ...
    function M(a, b) {
      ...
      var d = a.getSelection(),
        ...
        B,
        g;
      h.getById("cke_table_copybin") ||
        ((p = h.createElement(f)),
        (r = h.createElement(f)),
        r.setAttributes({ id: "cke_table_copybin", "data-cke-temp": "1" }),
        p.setStyles({
          position: "absolute",
          width: "1px",
          height: "1px",
        ...
        r.append(p),
        a.editable().append(r),
        (g = a.on("selectionChange", c, null, null, 0)),
        k && (B = l.scrollTop),
    ...
    function C(a) {
      ...
      b.getSelection().isInTable() && M(b, "cut" === a.name);
    }
    function q(a) {
      this._reset();
    ...
    function z(a, b, c) {
      a.on("beforeCommandExec", function(d) {
        -1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) &&
          (d.data.selectedCells = u(a.getSelection()));
      });
    ...
    q.prototype.insertRow = function(a, b, c) {
      ...
      for (
        ...
        (m = D(c ? this.cells.all : h, b)),
          (m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(), function(
            a
          ) {
    ...
    q.prototype.insertColumn = function(a) {
      ...
      for (
        var c = this.cells, d = c.all, e = n(c.first), h = n(c.last), c = 0;
        c < a;
        c++
      )
        d = d.concat(CKEDITOR.tools.array.filter(E(d), b));
    ...
    var F = {
      onPaste: function(a) {
        ...
        !h.length ||
          ...
          m
            ? (a.stop(),
              l
                ? (k.insertRow(1, 1 === l, !0), e.selectElement(k.rows.first))
                : (k.emptyCells(), t(d, k.cells.all)),
              (a = k.getTableMap()),
              (f = CKEDITOR.tools.buildTableMap(m)),
              k.insertRow(f.length - a.length),
              k.insertColumn(b(f) - b(a)),
              (a = k.getTableMap()),
              this.pasteTable(k, a, f),
              d.fire("saveSnapshot"),
              setTimeout(function() {
                d.fire("afterPaste");
              }, 0))
      ...
      pasteTable: function(a, b, c) {
        ...
        for (f = 0; f < c.length; f++)
          for (
            l = new CKEDITOR.dom.element(h.$.rows[a.rows.first.$.rowIndex + f]),
              p = 0;
            p < c[f].length;
            p++
          )
            if (
              ((k = new CKEDITOR.dom.element(c[f][p])),
              (d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null),
              k && !k.getCustomData("processed"))
            ) {
              if (d && d.getParent()) k.replace(d);
              else if (0 === p || c[f][p - 1])
                (d = 0 !== p ? new CKEDITOR.dom.element(c[f][p - 1]) : null) &&
                l.equals(d.getParent())
                  ? k.insertAfter(d)
                  : 0 < e
                    ? l.$.cells[e]
                      ? k.insertAfter(new CKEDITOR.dom.element(l.$.cells[e]))
                      : l.append(k)
                    : l.append(k, !0);
        ...
        c.attachListener(
          ...
          (function(a) {
            function c(b, e) {
              ...
              if (g && g.is && g.is(m)) {
                for (
                  var q = g.getAscendant("table", !0),
                    n = g.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q),
                    t = !1,
                    u = function(a) {
                  ...
                  n = n.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                !n &&
                  r &&
                  r.is &&
                  !r.is("table") &&
                  r.getNext() &&
                  ((n = r.getNext().findOne("td, th")), (t = !0));
                if (n) f["moveToElementEdit" + (t ? "Start" : "End")](n);
                else
                  f.setStartBefore(g.getAscendant("table", !0)), f.collapse(!0);
                h[0].deleteContents();
                return [f];
              }
            ...
            return function(l) {
              ...
              if (h[k] && (f = a.getSelection()) && f.isInTable() && f.isFake)
                if (
                  ((g = f.getRanges()),
                  (n = g[0]._getTableElement()),
                  (q = g[g.length - 1]._getTableElement()),
                  l.data.preventDefault(),
                  l.cancel(),
                  8 < k && 46 > k)
                )
                  g[0].moveToElementEditablePosition(m ? n : q, !m),
                    f.selectRanges([g[0]]);
                else {
                  for (l = 0; l < g.length; l++) b(g[l]);
                  (l = c(n, g))
                    ? (g = l)
                    : g[0].moveToElementEditablePosition(n);
                  f.selectRanges(g);
                  a.fire("saveSnapshot");
                }
            };
        ...
        c.attachListener(
          ...
          function(d) {
            var c = a.getSelection(),
              h = d.data.$.charCode || 13 === d.data.getKey(),
              g;
            if (
              c &&
              c.isInTable() &&
              c.isFake &&
              h &&
              !(d.data.getKeystroke() & CKEDITOR.CTRL)
            ) {
              d = c.getRanges();
              ...
              h &&
                (d[0].moveToElementEditablePosition(h), c.selectRanges([d[0]]));
            }
          },
          null,
          null,
      ...
      init: function(a) {
        CKEDITOR.plugins.tableselection.isSupportedEnvironment &&
          ...
          a.on("contentDom", function() {
            ...
            b.attachListener(b, "dragstart", L);
            b.attachListener(a, "selectionCheck", K);
            CKEDITOR.plugins.tableselection.keyboardIntegration(a);
            CKEDITOR.plugins.clipboard &&
              !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported &&
              (b.attachListener(b, "cut", C), b.attachListener(b, "copy", C));
          }),
          a.on("paste", F.onPaste, F),
          z(
            a,
          ...
          z(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function(
            a,
            c
          ) {
            t(a, [c.commandData.cell]);
          }),
          z(a, ["cellDelete"], function(a) {
            y(a, !0);
          }));
      }
    });
