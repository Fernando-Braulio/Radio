(function() {
  ...
  d.prototype.getFirstEnabledButtonInSubgroup = function(a) {
    for (
      var b = (a = this.fullToolbarEditor.buttonsByGroup[a]) ? a.length : 0,
        c = 0;
      c < b;
      c += 1
    ) {
  ...
  d.prototype._removeSeparator = function(a) {
    var b = CKEDITOR.tools.indexOf(this.actualConfig.toolbarGroups, function(
      b
    ) {
  ...
  d.prototype.isButtonRemoved = function(a) {
    return (
      -1 !=
      CKEDITOR.tools.indexOf(this.removedButtons, this._getConfigButtonName(a))
    );
  };
