...
!(function(t) {
    ...
    for (
      ...
      (i = r[n]),
        "string" == typeof i
          ...
          : "function" == typeof i && s.push({ func: i });
    return s;
  }
  function F(t, e, n) {
    var i, s;
  ...
  function O(t, e) {
    ...
    for (
      n = 0;
      n < qt.length && ((i = qt[n]), !((s = V(i, t, e)) >= 1 && ot(s)));
      n++
    );
    return i;
  }
  ...
  function lt(t, e, n) {
    var i,
      ...
      l = function() {
        ...
        u < e
          ? (i = setTimeout(l, e - u))
          : ((i = null), n || ((a = t.apply(r, s)), (r = s = null)));
      };
    return function() {
  ...
  function pt(t, e) {
    return (
      (!t && !e) ||
      (!(!t || !e) && (t.component === e.component && vt(t, e) && vt(e, t)))
    );
  }
  function vt(t, e) {
    for (var n in t)
  ...
  function mt(n) {
    ...
    return (
      ...
      (o = Boolean(o)),
      { eventProps: i, startTime: s, duration: r, stick: o }
    );
  }
  function yt(t, e) {
    var n, i;
  ...
  function bt(t) {
    ...
    for (e = 0; e < t.length; e++)
      for (n = t[e], i = 0; i < n.length; i++)
        for (s = n[i], s.forwardSegs = [], r = e + 1; r < t.length; r++)
  ...
  function St(t) {
    ...
    if (void 0 === t.forwardPressure) {
      for (e = 0; e < i.length; e++)
        (n = i[e]), St(n), (s = Math.max(s, 1 + n.forwardPressure));
      t.forwardPressure = s;
    }
  }
  function Et(t, e, n) {
          ...
          t.each(o.split(" "), function(n) {
            ...
            t.each(this.split(","), function(n, i) {
              ...
              "title" == i
                ...
                : ((r = a[i])
                    ? ((d = function(t) {
                      ...
                      (f = s.getCustomButtonIconClass(r)) ||
                        (f = s.getIconClass(i)) ||
                        (g = r.text))
                    : (h = e.getViewSpec(i))
                      ? (p.push(i),
                  ...
                  d &&
                    ...
                    (y = t(
                      ...
                      .click(function(t) {
                        y.hasClass(s.getClass("stateDisabled")) ||
                          (d(t),
                          (y.hasClass(s.getClass("stateActive")) ||
                            y.hasClass(s.getClass("stateDisabled"))) &&
                            y.removeClass(s.getClass("stateHover")));
                      })
                      .mousedown(function() {
                        y.not("." + s.getClass("stateActive"))
                          .not("." + s.getClass("stateDisabled"))
                          .addClass(s.getClass("stateDown"));
                      })
                      .mouseup(function() {
                      ...
                      .hover(
                        function() {
                          y.not("." + s.getClass("stateActive"))
                            .not("." + s.getClass("stateDisabled"))
                            .addClass(s.getClass("stateHover"));
                        },
                        function() {
                          y.removeClass(s.getClass("stateHover")).removeClass(
                            s.getClass("stateDown")
                          );
                        }
                      )),
                    (o = o.add(y))));
              ...
              c &&
                o
                  .first()
                  .addClass(s.getClass("cornerLeft"))
                  .end()
                  .last()
                  .addClass(s.getClass("cornerRight"))
                  .end(),
              o.length > 1
                ? ((i = t("<div/>")),
  ...
  function Mt(t, e) {
    ...
    for (n = 0; n < t.length; n++) {
      if (((i = t[n].eventInstance), (s = i.def), !1 === (r = s.getOverlap())))
        return !1;
  ...
  function Pt(t, e) {
    var n,
      ...
      s = [],
      r = e.startMs;
    for (t.sort(Bt), n = 0; n < t.length; n++)
      (i = t[n]),
  ...
  var Vt = (t.fullCalendar = { version: "3.5.1", internalApiVersion: 10 }),
    Ut = (Vt.views = {});
            ...
            : "destroy" === e
              ...
              : l
                ? t.isFunction(l[e])
                  ...
                  : Vt.warn("'" + e + "' is an unknown FullCalendar method.")
                : Vt.warn(
                    "Attempting to call a FullCalendar method on an element with no calendar."
                  )
          : l || ((l = new Ee(a, e)), a.data("fullCalendar", l), l.render());
      }),
      i
    );
  };
  ...
  Xt.push("_fullCalendar"),
    ...
    (Qt.week = Qt.weeks = function(t) {
      ...
      return null == t && "function" == typeof e
        ? e(this)
        : "ISO" === e
          ? $t.isoWeek.apply(this, arguments)
          : $t.week.apply(this, arguments);
    }),
    (Qt.time = function(t) {
    ...
    (Qt.local = function(t) {
      return (
        $t.local.call(this, this._ambigZone || t),
        (this._ambigTime = !1),
        (this._ambigZone = !1),
        this
      );
    ...
    (Qt.format = function() {
      return this._fullCalendar && arguments[0]
        ? Kt(this, arguments[0])
        : this._ambigTime
          ? te(ct(this), "YYYY-MM-DD")
          : this._ambigZone
            ? te(ct(this), "YYYY-MM-DD[T]HH:mm:ss")
            : this._fullCalendar
              ? te(ct(this))
              : $t.format.apply(this, arguments);
    }),
    (Qt.toISOString = function() {
      return this._ambigTime
        ...
        : this._ambigZone
          ? te(ct(this), "YYYY-MM-DD[T]HH:mm:ss")
          : this._fullCalendar
            ? $t.toISOString.apply(ct(this), arguments)
            : $t.toISOString.apply(this, arguments);
    }),
    (function() {
      function t(t, e) {
      ...
      function u(t) {
        ...
        for (e = 0; e < t.length; e++)
          (n = t[e]),
            n.token
              ? ((i = w[n.token.charAt(0)]), s.push(i ? i.unit : "second"))
              : n.maybe
                ? s.push.apply(s, u(n.maybe))
                : s.push(null);
        return s;
      }
      function c(t, e) {
  ...
  de.mixin({
    ...
    initAutoScroll: function() {
      ...
      (this.isAutoScroll =
        ...
        this.isAutoScroll &&
          this.listenTo(t, "scroll", lt(this.handleDebouncedScroll, 100));
    },
  ...
  var pe = ht.extend(ne, {
    ...
    ve = oe.extend({
      ...
      buildGotoAnchorHtml: function(e, n, i) {
        ...
        return (
          t.isPlainObject(e)
            ? ((s = e.date), (r = e.type), (o = e.forceOff))
            : (s = e),
          (s = Vt.moment(s)),
          (a = { date: s.format("YYYY-MM-DD"), type: r || "day" }),
      ...
      formatRange: function(t, e, n, i) {
        var s = t.end;
        return (
          e && (s = s.clone().subtract(1)), Jt(t.start, s, n, i, this.isRTL)
        );
      },
      ...
      getDayClasses: function(t, e) {
        var n,
          ...
          s = [];
        return (
          i.activeUnzonedRange.containsDate(t)
            ? (s.push("fc-" + _t[t.day()]),
              i.isDateInOtherMonth(t) && s.push("fc-other-month"),
              (n = i.calendar.getNow()),
              t.isSame(n, "day")
                ? (s.push("fc-today"),
                  !0 !== e && s.push(i.calendar.theme.getClass("today")))
                : t < n
                  ? s.push("fc-past")
                  : s.push("fc-future"))
            : s.push("fc-disabled-day"),
          s
        );
      },
      computeDayRange: function(t) {
        var e = this._getCalendar(),
          ...
          r = i.clone().stripTime();
        return (
          s && s >= this.nextDayThreshold && r.add(1, "days"),
    ...
    me = (Vt.Grid = ve.extend({
      ...
      getSafeHitFootprint: function(t) {
        ...
        return this.view.activeUnzonedRange.containsRange(e.unzonedRange)
          ? e
          : null;
      },
      ...
      bindDayHandler: function(e, n) {
        ...
        this.el.on(e, function(e) {
          if (
            !t(e.target).is(
              i.segSelector + "," + i.segSelector + " *,.fc-more,a[data-goto]"
            )
          )
            return n.call(i, e);
        });
      ...
      dayTouchStart: function(t) {
        ...
        n.isSelected ||
          n.selectedEvent ||
          ((e = this.opt("selectLongPressDelay")),
          null == e && (e = this.opt("longPressDelay")),
          this.dayClickListener.startInteraction(t),
          this.opt("selectable") &&
            this.daySelectListener.startInteraction(t, { delay: e }));
      },
      ...
      eventRangeToEventFootprints: function(t) {
        return [
          new Ue(
            new xe(t.unzonedRange, t.eventDef.isAllDay()),
            t.eventDef,
            t.eventInstance
          )
        ];
  ...
  me.mixin({
      ...
      var t,
        ...
        n = new fe(this, {
          ...
          interactionEnd: function(n, i) {
            ...
            !i &&
              t &&
              (s = e.getSafeHitFootprint(t)) &&
              e.view.triggerDayClick(s, e.getHitEl(t), n);
          }
        });
    ...
    me.mixin({
      ...
      isSelectionFootprintAllowed: function(t) {
        return (
          this.view.validUnzonedRange.containsRange(t.unzonedRange) &&
    ...
    me.mixin({
      ...
      buildBusinessHourSegs: function(t) {
        return this.eventFootprintsToSegs(
          this.buildBusinessHourEventFootprints(t)
        );
      },
      buildBusinessHourEventFootprints: function(t) {
        var e = this.view.calendar;
        return this._buildBusinessHourEventFootprints(
          t,
          e.opt("businessHours")
        );
      },
      _buildBusinessHourEventFootprints: function(t, e) {
        ...
        return (
          (n = s.buildBusinessInstanceGroup(t, e, this.unzonedRange)),
    ...
    me.mixin({
        ...
        for (e in t)
          (n = t[e]),
            ...
            n.getEventDef().hasBgRendering()
              ...
              : a.push.apply(a, r);
        this.segs = [].concat(
          this.renderBgSegs(o) || o,
          this.renderFgSegs(a) || a
        );
      },
      unrenderEvents: function() {
      ...
      getSegBackgroundColor: function(t) {
        var e = t.footprint.eventDef;
        return (
          e.backgroundColor || e.color || this.getSegDefaultBackgroundColor(t)
        );
      },
      ...
      getSegDefaultTextColor: function(t) {
        return (
          t.footprint.eventDef.source.textColor || this.opt("eventTextColor")
        );
      },
      ...
      compareEventSegs: function(t, e) {
        ...
        return (
          i.startMs - r.startMs ||
          r.endMs - r.startMs - (i.endMs - i.startMs) ||
          s.isAllDay - n.isAllDay ||
          F(
    ...
    me.mixin({
      ...
      handleSegMousedown: function(t, e) {
        !this.startSegResize(t, e, { distance: 5 }) &&
          this.view.isEventDefDraggable(t.footprint.eventDef) &&
          this.buildSegDragListener(t).startInteraction(e, { distance: 5 });
      },
      handleSegTouchStart: function(t, e) {
        ...
        o && l && (u = this.startSegResize(t, e)),
          u ||
            (!a && !l) ||
            ((i = this.opt("eventLongPressDelay")),
      ...
      isEventInstanceGroupAllowed: function(t) {
        var e,
          n = this.eventRangesToEventFootprints(t.getAllEventRanges());
        for (e = 0; e < n.length; e++)
          if (
            !this.view.validUnzonedRange.containsRange(
              n[e].componentFootprint.unzonedRange
            )
          )
            return !1;
        ...
        var f = (this.segDragListener = new fe(a, {
          ...
          hitOver: function(e, o, c) {
            ...
            t.hit && (c = t.hit),
              ...
              d && g
                ? ((i = s.computeEventDropMutation(d, g, h)),
                  i
                    ? ((p = u.buildMutatedEventInstanceGroup(h.id, i)),
                      (m = s.isEventInstanceGroupAllowed(p)))
                    : (m = !1))
                : (m = !1),
              m || ((i = null), r()),
              i &&
              (v = a.renderDrag(
                s.eventRangesToEventFootprints(
                  p.sliceRenderRanges(s.unzonedRange, l)
                ),
                t
              ))
                ? (v.addClass("fc-dragging"),
          ...
          interactionEnd: function(r) {
            delete t.component,
              n.stop(!i, function() {
                e && (a.unrenderDrag(), s.segDragStop(t, r)),
      ...
      computeEventDropMutation: function(t, e, n) {
        ...
        return (
          t.isAllDay !== e.isAllDay &&
            ((l = !0), e.isAllDay ? ((c = !0), o.stripTime()) : (u = !0)),
    ...
    me.mixin({
      ...
      buildSegResizeListener: function(t, e) {
        ...
        return (this.segResizeListener = new fe(this, {
          ...
          hitOver: function(n, o, c) {
            ...
            g && p
              ? ((i = e
                  ? s.computeEventStartResizeMutation(g, p, t.footprint)
                  : s.computeEventEndResizeMutation(g, p, t.footprint)),
                i
                  ? ((d = u.buildMutatedEventInstanceGroup(h.id, i)),
                    (f = s.isEventInstanceGroupAllowed(d)))
                  : (f = !1))
              : (f = !1),
              f ? i.isEmpty() && (i = null) : ((i = null), r()),
              i &&
                (a.hideEventsWithId(h.id),
                s.renderEventResize(
                  s.eventRangesToEventFootprints(
                    d.sliceRenderRanges(s.unzonedRange, l)
                  ),
                  t
                ));
          },
      ...
      computeEventStartResizeMutation: function(t, e, n) {
        var i,
          s,
          r = n.componentFootprint.unzonedRange,
          o = this.diffDates(
            e.unzonedRange.getStart(),
            t.unzonedRange.getStart()
          );
        return (
          r.getStart().add(o) < r.getEnd() &&
          ((i = new We()),
          i.setStartDelta(o),
          (s = new Ge()),
          s.setDateMutation(i),
    ...
    me.mixin({
      ...
      externalDragStart: function(e, n) {
        ...
        this.opt("droppable") &&
          ...
          (t.isFunction(s) ? s.call(i[0], i) : i.is(s)) &&
            (this.isDraggingExternal || this.listenToExternalDrag(i, e, n)));
      },
      listenToExternalDrag: function(t, e, n) {
        ...
        (s.externalDragListener = new fe(this, {
          ...
          hitOver: function(t) {
            ...
            o
              ? ((i = s.computeExternalDrop(o, l)),
                i
                  ? ((e = new Oe(i.buildInstances())),
                    (n = l.eventProps
              ...
              i &&
                s.renderDrag(
                  s.eventRangesToEventFootprints(
                    e.sliceRenderRanges(s.unzonedRange, a.calendar)
                  )
                );
          },
          hitOut: function() {
      ...
      computeExternalDrop: function(e, n) {
        ...
        return (
          e.isAllDay && (n.startTime ? r.time(n.startTime) : r.stripTime()),
          n.duration && (i = r.clone().add(n.duration)),
          (r = s.applyTimezone(r)),
          i && (i = s.applyTimezone(i)),
          ke.parse(t.extend({}, n.eventProps, { start: r, end: i }), new _e(s))
        );
      },
  ...
  var ye = (Vt.DayTableMixin = {
      ...
      updateDayTable: function() {
        for (
          var t,
            ...
            i = this.view,
            s = i.calendar,
            r = s.msToUtcMoment(this.unzonedRange.startMs, !0),
            o = s.msToUtcMoment(this.unzonedRange.endMs, !0),
            a = -1,
            l = [],
            u = [];
          r.isBefore(o);
      ...
      renderBgCellHtml: function(t, e) {
        ...
        return (
          s.unshift("fc-day", n.calendar.theme.getClass("widgetContent")),
          '<td class="' +
            s.join(" ") +
            '"' +
    ...
    we = (Vt.DayGrid = me.extend(ye, {
      ...
      renderDates: function(t) {
        ...
        for (
          this.el.html(o),
            ...
            this.rowCoordCache = new he({ els: this.rowEls, isVertical: !0 }),
      ...
      renderFill: function(e, n, i) {
        var s,
          ...
          o,
          a = [];
        for (n = this.renderFillSegEls(e, n), s = 0; s < n.length; s++)
          (r = n[s]),
        ...
        return (
          this.elsByFill[e]
            ? (this.elsByFill[e] = this.elsByFill[e].add(a))
            : (this.elsByFill[e] = t(a)),
          n
        );
      },
    ...
    fgSegHtml: function(t, e) {
      ...
      return (
        ...
        t.isStart &&
          ...
          (d = '<span class="fc-time">' + tt(n) + "</span>"),
        (i =
          '<span class="fc-title">' +
          (tt(r.title || "") || "&nbsp;") +
          "</span>"),
    ...
    we.mixin({
      ...
      computeRowLevelLimit: function(e) {
        ...
        for (i = 0; i < l.length; i++)
          if (
            ((s = l.eq(i).removeClass("fc-limited")),
            (r = 0),
      ...
      limitRow: function(e, n) {
        ...
        if (n && n < D.segLevels.length) {
          for (
            ...
            for (l = s[a], i(l.leftCol), h = [], c = 0; S <= l.rightCol; )
              (u = this.getCellSegs(e, S, n)), h.push(u), (c += u.length), S++;
            if (c) {
              for (
                d = r[n - 1][l.leftCol],
                  f = d.attr("rowspan") || 1,
      ...
      renderMoreLink: function(e, n, i) {
        ...
        return t('<a class="fc-more"/>')
          ...
          .on("click", function(o) {
            ...
            "function" == typeof a &&
              (a = s.publiclyTrigger("eventLimitClick", {
                context: r,
                args: [
                  {
                    date: l.clone(),
              ...
              "popover" === a
                ? s.showSegPopover(e, n, u, d)
                : "string" == typeof a && r.calendar.zoomTo(l, a);
          });
      },
      showSegPopover: function(t, e, n, i) {
        ...
        (s = 1 == this.rowCnt ? a.el : this.rowEls.eq(t)),
          ...
          this.isRTL
            ? (r.right = l.offset().left + l.outerWidth() + 1)
            : (r.left = l.offset().left - 1),
      ...
      renderSegPopoverContent: function(e, n, i) {
        ...
        for (
          i = this.renderFgSegEls(i, !0), this.popoverSegs = i, s = 0;
          s < i.length;
          s++
        )
          this.hitsNeeded(),
      ...
      getCellSegs: function(t, e, n) {
        for (
          var i, s = this.rowStructs[t].segMatrix, r = n || 0, o = [];
          r < s.length;

        )
          (i = s[r][e]), i && o.push(i), r++;
        return o;
      }
    });
  var De = (Vt.TimeGrid = me.extend(ye, {
    ...
    renderDates: function() {
      this.el.html(this.renderHtml()),
        ...
        (this.colCoordCache = new he({ els: this.colEls, isHorizontal: !0 })),
        (this.slatCoordCache = new he({ els: this.slatEls, isVertical: !0 })),
    ...
    renderHtml: function() {
      ...
      return (
        ...
        '</table></div><div class="fc-slats"><table class="' +
        t.getClass("tableGrid") +
        '">' +
    ...
    renderSlatRowHtml: function() {
      for (
        var t,
          ...
          a = this.isRTL,
          l = "",
          u = e.duration(+this.view.minTime),
          c = e.duration(0);
        u < s.maxTime;
        ...
        (t = r.msToUtcMoment(this.unzonedRange.startMs).time(u)),
          ...
          (i =
            ...
            s.axisStyleAttr() +
            ">" +
            (n ? "<span>" + tt(t.format(this.labelFormat)) + "</span>" : "") +
            "</td>"),
          (l +=
            '<tr data-time="' +
            t.format("HH:mm:ss") +
    ...
    renderSelectionFootprint: function(t) {
      this.opt("selectHelper")
        ? this.renderHelperEventFootprints([this.fabricateEventFootprint(t)])
        : this.renderHighlight(t);
    },
    unrenderSelection: function() {
      this.unrenderHelper(), this.unrenderHighlight();
  ...
  De.mixin({
    ...
    renderHelperSegs: function(e, n) {
      var i,
        ...
        o = [];
      for (
        e = this.renderFgSegsIntoContainers(e, this.helperContainerEls), i = 0;
        i < e.length;
        i++
      )
        (s = e[i]),
      ...
      return (
        ...
        (n
          ? '<div class="fc-time" data-start="' +
            ...
            "</span></div>"
          : "") +
        (u.title ? '<div class="fc-title">' + tt(u.title) + "</div>" : "") +
        '</div><div class="fc-bg"/>' +
    ...
    computeFgSegForwardBack: function(t, e, n) {
      ...
      if (void 0 === t.forwardCoord)
        for (
          s.length
            ? (this.sortForwardSegs(s),
              this.computeFgSegForwardBack(s[0], e + 1, n),
              (t.forwardCoord = s[0].backwardCoord))
            : (t.forwardCoord = 1),
    ...
    generateFgSegHorizontalCss: function(t) {
      ...
      return (
        i && (r = Math.min(1, s + 2 * (r - s))),
        this.isRTL ? ((e = 1 - r), (n = s)) : ((e = s), (n = 1 - r)),
        (o.zIndex = t.level + 1),
        (o.left = 100 * e + "%"),
        (o.right = 100 * n + "%"),
        i &&
  ...
  var be = (Vt.View = ve.extend({
    ...
    buildRenderQueue: function() {
      var t = this,
        e = new ue({ event: this.opt("eventRenderWait") });
      return (
        e.on("start", function() {
    ...
    executeEventsRender: function(t) {
      this.renderEvents
        ? this.renderEvents(Tt(t))
        : this.renderEventsPayload(t),
    ...
    onEventsRender: function() {
      ...
      (e || this.hasPublicHandlers("eventAfterAllRender")) &&
        this.applyScreenState(),
        e &&
          this.getEventSegs().forEach(function(e) {
            var n;
            e.el &&
              ((n = e.footprint.getEventLegacy()),
    ...
    renderSelectionFootprint: function(t, e) {
      this.renderSelection
        ...
        : ve.prototype.renderSelectionFootprint.apply(this, arguments);
    },
    ...
    isEventDefSelected: function(t) {
      return (
        this.selectedEventInstance && this.selectedEventInstance.def.id === t.id
      );
    },
    ...
    be.mixin({
      ...
      setDateProfileForRendering: function(t) {
        ...
        (this.currentUnzonedRange = t.currentUnzonedRange),
          ...
          (this.start = e.msToMoment(
            t.activeUnzonedRange.startMs,
            this.isRangeAllDay
          )),
          (this.end = e.msToMoment(
            t.activeUnzonedRange.endMs,
            this.isRangeAllDay
          )),
          (this.intervalStart = e.msToMoment(
            t.currentUnzonedRange.startMs,
            this.isRangeAllDay
          )),
          (this.intervalEnd = e.msToMoment(
            t.currentUnzonedRange.endMs,
            this.isRangeAllDay
          )),
      ...
      buildDateProfile: function(t, n, i) {
        var s,
          ...
          h = null;
        return (
          i && (t = this.calendar.msToUtcMoment(u.constrainDate(t), l)),
      ...
      buildCurrentRangeInfo: function(t, e) {
        ...
        return (
          this.viewSpec.duration
            ...
            : (n = this.opt("dayCount"))
              ? ((s = "day"), (r = this.buildRangeFromDayCount(t, e, n)))
              : (r = this.buildCustomVisibleRange(t))
                ? (s = O(r.getStart(), r.getEnd()))
                : ((i = this.getFallbackDuration()),
                  (s = O(i)),
                  (r = this.buildRangeFromDuration(t, e, i, s))),
          { duration: i, unit: s, unzonedRange: r }
        );
      },
      ...
      adjustActiveRange: function(t, e, n) {
        ...
        return (
          this.usesMinMaxTime &&
            (e < 0 && i.time(0).add(e), n > 864e5 && s.time(n - 864e5)),
          new Me(i, s)
        );
      },
      buildRangeFromDuration: function(t, n, i, s) {
        ...
        return (
          ...
          l ||
            ...
            o ? ((a = e.duration(o)), (l = a < i ? N(a, o) : s)) : (l = s)),
          u.startOf(l),
          (r = u.clone().add(i)),
          new Me(u, r)
        );
  ...
  Ee.mixin({
    ...
    setOptions: function(t) {
      ...
      if (1 === n) {
        ...
        if ("businessHours" === e)
          return void (
            this.view &&
            (this.view.unrenderBusinessHours(), this.view.renderBusinessHours())
          );
    ...
    Ee.mixin({
          ...
          this.optionsModel.watch(
            ...
            function(e) {
              ...
              e.monthNames && (r._months = e.monthNames),
                ...
                null == s && "ISO" === i && (s = 1),
                null != s &&
                  ((n = Object.create(r._week)), (n.dow = s), (r._week = n)),
                ("ISO" !== i && "local" !== i && "function" != typeof i) ||
                  (r._fullCalendar_weekCalc = i),
                (t.localeData = r),
      ...
      moment: function() {
        ...
        return (
          "local" === this.opt("timezone")
            ? ((t = Vt.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
      ...
      footprintToDateProfile: function(t, e) {
        var n,
          i = Vt.moment.utc(t.unzonedRange.startMs);
        return (
          e || (n = Vt.moment.utc(t.unzonedRange.endMs)),
          t.isAllDay
        ...
        for (
          ...
          (i = Ut[d]),
            ...
            i &&
              ...
              (r = r || i.duration),
              (d = d || i.type)),
            s && (h.unshift(s), (r = r || s.duration), (d = d || s.type));
        return (
          (i = j(u)),
          (i.type = t),
          !!i.class &&
            ((r =
              r || this.dynamicOverrides.duration || this.overrides.duration),
            r &&
              ((o = e.duration(r)),
              o.valueOf() &&
                ((a = N(o, r)),
      ...
      initialRender: function() {
        ...
        n.addClass("fc"),
          n.on("click.fc", "a[data-goto]", function(n) {
            ...
            "function" == typeof a
              ? a(r, n)
              : ("string" == typeof a && (o = a), e.zoomTo(r, o));
          }),
          this.optionsModel.watch(
            "settingTheme",
            ["?theme", "?themeSystem"],
    ...
    Ee.mixin({
      ...
      updateToolbarButtons: function() {
        ...
        this.toolbarsManager.proxyCall(
          n.isValid && !e.currentUnzonedRange.containsDate(t)
            ? "enableButton"
            : "disableButton",
          "today"
        ),
  ...
  (Ee.prototype.buildCurrentBusinessFootprints = function(t) {
    ...
    (Ee.prototype._buildCurrentBusinessFootprints = function(t, e) {
      var n,
        i = this.eventManager.currentPeriod;
      return i && (n = this.buildBusinessInstanceGroup(t, e, i.unzonedRange))
        ? this.eventInstancesToFootprints(n.eventInstances)
        : [];
    }),
    (Ee.prototype.buildBusinessInstanceGroup = function(t, e, n) {
      var i,
        s = this.buildBusinessDefs(t, e);
      if (s.length)
        return (i = new Oe(At(s, n))), (i.explicitEventDef = s[0]), i;
    }),
    ...
    (Ee.prototype.isFootprintAllowed = function(t, e, n, i, s) {
      ...
      if (
        null != n &&
        ((r = this.constraintValToFootprints(n, t.isAllDay)),
    ...
    Ee.mixin({
      ...
      removeEvents: function(t) {
        ...
        if (null == t) s.removeAllEventDefs();
          ...
          for (
            ...
            (n = this.eventManager.getEventDefByUid(e[i]._id)), (o[n.id] = !0);
          s.freeze();
      ...
      clientEvents: function(t) {
        return xt(
          this.eventManager.getEventInstances().map(function(t) {
            return t.toLegacy();
          }),
          t
        );
  ...
  var Me = (Vt.UnzonedRange = ht.extend({
    ...
    ze = ht.extend(ee, ne, {
      ...
      querySources: function(e) {
        ...
        return (i = this.getSourceById(_e.normalizeId(e)))
          ? [i]
          : ((e = qe.parse(e, this.calendar)),
            e
              ? t.grep(s, function(t) {
                  return kt(e, t);
                })
          ...
          ? (i.freeze(),
            ...
            function() {
              ...
              for (var t = 0; t < n.length; t++)
                i.removeEventDef(n[t]), s[t](), i.addEventDef(n[t]);
              i.thaw();
            })
          : function() {};
      },
      buildMutatedEventInstanceGroup: function(t, e) {
        var n,
          i,
          s = this.getEventDefsById(t),
          r = [];
        for (n = 0; n < s.length; n++)
          (i = s[n].clone()) instanceof ke &&
            (e.mutateSingle(i), r.push.apply(r, i.buildInstances()));
        return new Oe(r);
      },
      freeze: function() {
  ...
  var Fe = ht.extend(ee, {
      ...
      addEventDef: function(t) {
        ...
        for (
          s.push(t), this.eventDefsByUid[t.uid] = t, e = 0;
          e < r.length;
          e++
        )
      ...
      whenReleased: function() {
        ...
        return this.releaseCnt
          ? ae.resolve(this.eventInstanceGroupsById)
          : ae.construct(function(e) {
              t.one("release", e);
            });
      },
      freeze: function() {
    ...
    Be = (Vt.EventDef = ht.extend(ie, {
      ...
      applyManualRawProps: function(e) {
        return (
          null != e.id
            ? (this.id = Be.normalizeId((this.rawId = e.id)))
            : (this.id = Be.generateId()),
          null != e._id
            ? (this.uid = String(e._id))
            : (this.uid = Be.generateId()),
  ...
  var Ae = Be.extend({
    ...
    buildInstances: function(t) {
      for (
        ...
        (this.dowHash && !this.dowHash[r.day()]) ||
          ((e = s.applyTimezone(r)),
          (n = e.clone()),
          (i = null),
    ...
    Oe = ht.extend({
      ...
      sliceNormalRenderRanges: function(t) {
        var e,
          n,
          i,
          s = this.eventInstances,
          r = [];
        for (e = 0; e < s.length; e++)
          (n = s[e]),
            (i = n.dateProfile.unzonedRange.intersect(t)) &&
              r.push(new Ve(i, n.def, n));
        return r;
      },
  ...
  Ne.parse = function(t, e) {
    ...
    return (
      !!r.isValid() &&
      (!o || (o.isValid() && o.isAfter(r)) || (o = null),
      null == a &&
        null == (a = e.allDayDefault) &&
        (a = s.opt("allDayDefault")),
      !0 === a
        ? (r.stripTime(), o && o.stripTime())
        : !1 === a &&
          (r.hasTime() || r.time(0), o && !o.hasTime() && o.time(0)),
  ...
  var We = ht.extend({
    ...
    buildNewDateProfile: function(t, e) {
      var n = t.start.clone(),
        ...
        s = !1;
      return (
        !this.clearEnd && t.end && (i = t.end.clone()),
        this.forceTimed
          ? ((s = !0), n.hasTime() || n.time(0), i && !i.hasTime() && i.time(0))
          : this.forceAllDay &&
            (n.hasTime() && n.stripTime(), i && i.hasTime() && i.stripTime()),
        this.dateDelta &&
          ((s = !0), n.add(this.dateDelta), i && i.add(this.dateDelta)),
        this.endDelta &&
          ((s = !0),
          i || (i = e.getDefaultEventEnd(t.isAllDay(), n)),
          i.add(this.endDelta)),
        this.startDelta && ((s = !0), n.add(this.startDelta)),
        s && ((n = e.applyTimezone(n)), i && (i = e.applyTimezone(i))),
        !i &&
  ...
  We.createFromDiff = function(t, e, n) {
    ...
    return (
      (s = i(e.start, t.start)),
      e.end &&
        ((r = i(e.unzonedRange.getEnd(), t.unzonedRange.getEnd())),
        (o = r.subtract(s))),
      (a = new We()),
      (a.clearEnd = l),
      (a.forceTimed = u),
  ...
  var _e = ht.extend(ie, {
    ...
    applyManualRawProps: function(e) {
      return (
        null != e.id && (this.id = _e.normalizeId(e.id)),
  ...
  (Ze.AJAX_DEFAULTS = { dataType: "json", cache: !1 }),
    Ze.allowRawProps({ startParam: !0, endParam: !0, timezoneParam: !0 }),
  ...
  var tn = (Vt.BasicView = be.extend({
      ...
      initialize: function() {
        (this.dayGrid = this.instantiateDayGrid()),
          ...
          (this.scroller = new Se({ overflowX: "hidden", overflowY: "auto" }));
      },
  ...
  (Ut.basic = { class: tn }),
    (Ut.basicDay = { type: "basic", duration: { days: 1 } }),
    (Ut.basicWeek = { type: "basic", duration: { weeks: 1 } }),
    (Ut.month = {
      class: nn,
      duration: { months: 1 },
  ...
  var sn = (Vt.AgendaView = be.extend({
      ...
      renderEventsPayload: function(t) {
        var e,
          ...
          s = {};
        for (e in t)
          (n = t[e]), n.getEventDef().isAllDay() ? (i[e] = n) : (s[e] = n);
    ...
    rn = {
      renderHeadIntroHtml: function() {
        ...
        return this.opt("weekNumbers")
          ? ((t = n.format(this.opt("smallWeekFormat"))),
            '<th class="fc-axis fc-week-number ' +
              e.calendar.theme.getClass("widgetHeader") +
              '" ' +
              e.axisStyleAttr() +
              ">" +
              e.buildGotoAnchorHtml(
                { date: n, type: "week", forceOff: this.colCnt > 1 },
                tt(t)
              ) +
              "</th>")
          : '<th class="fc-axis ' +
    ...
    cn = me.extend({
      ...
      rangeUpdated: function() {
        for (
          var t = this.view.calendar,
            e = t.msToUtcMoment(this.unzonedRange.startMs, !0),
            n = t.msToUtcMoment(this.unzonedRange.endMs, !0),
            i = [],
            s = [];
          e < n;
      ...
      componentFootprintToSegs: function(t) {
        ...
        for (e = 0; e < r.length; e++)
          if (
            ...
            !i.isEnd &&
              !t.isAllDay &&
              t.unzonedRange.endMs < r[e + 1].startMs + s.nextDayThreshold)
          ) {
      ...
      renderSegList: function(e) {
        var n,
          i,
          s,
          r = this.groupSegsByDay(e),
          o = t(
            '<table class="fc-list-table ' +
              this.view.calendar.theme.getClass("tableList") +
              '"><tbody/></table>'
          ),
          a = o.find("tbody");
        for (n = 0; n < r.length; n++)
      ...
      fgSegHtml: function(t) {
        ...
        return (
          (e = u.isAllDay
            ? n.getAllDayHtml()
            : n.isMultiDayRange(u.unzonedRange)
              ? t.isStart || t.isEnd
                ? tt(
