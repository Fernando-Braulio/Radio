...
!(function(e, t) {
  ...
  function S(i, a) {
    if (d !== i) {
      ...
      h.length = 0;
      for (var s, l = [], c = [], f = 0; f < i.length; f++)
        ((s = W("div")).className = "full-image"),
          (s.id = "baguette-img-" + f),
          h.push(s),
          l.push("baguetteBox-figure-" + f),
          c.push("baguetteBox-figcaption-" + f),
          t.appendChild(h[f]);
      e.setAttribute("aria-labelledby", l.join(" ")),
        e.setAttribute("aria-describedby", c.join(" "));
    }
  }
  function F(t) {
    r.noScrollbars &&
  ...
  return (
      ...
      }),
    {
      run: function(r, u) {
        ...
        return (
          (c.transforms =
            "undefined" != typeof (d = W("div")).style.perspective ||
            "undefined" != typeof d.style.webkitPerspective),
          (c.svg = (((f = W("div")).innerHTML = "<svg/>"),
          "http://www.w3.org/2000/svg" ===
            (f.firstChild && f.firstChild.namespaceURI))),
          ...
          (function() {
            if ((e = U("baguetteBox-overlay")))
              return (
                (t = U("baguetteBox-slider")),
                (n = U("previous-button")),
                (o = U("next-button")),
                void (i = U("close-button"))
              );
            var r;
