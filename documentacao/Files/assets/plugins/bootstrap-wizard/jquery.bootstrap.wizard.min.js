  ...
  var n = function(d, k) {
    ...
    this.fixNavigationButtons = function() {
      f.length ||
        ...
        (f = e.find('li:has([data-toggle="tab"]):first')));
      c(b.previousSelector, d).toggleClass(
        "disabled",
        a.firstIndex() >= a.currentIndex()
      );
      c(b.nextSelector, d).toggleClass(
        "disabled",
        a.currentIndex() >= a.navigationLength()
      );
      c(b.nextSelector, d).toggleClass(
        "hidden",
        a.currentIndex() >= a.navigationLength() &&
          0 < c(b.finishSelector, d).length
      );
      c(b.lastSelector, d).toggleClass(
        "hidden",
        a.currentIndex() >= a.navigationLength() &&
          0 < c(b.finishSelector, d).length
      );
      c(b.finishSelector, d).toggleClass(
        "hidden",
        a.currentIndex() < a.navigationLength()
      );
      c(b.backSelector, d).toggleClass("disabled", 0 == h.length);
      c(b.backSelector, d).toggleClass(
        "hidden",
        a.currentIndex() >= a.navigationLength() &&
          0 < c(b.finishSelector, d).length
      );
      a.rebindClick(c(b.nextSelector, d), a.next);
      a.rebindClick(c(b.previousSelector, d), a.previous);
      ...
      if (
        b.onTabShow &&
        "function" === typeof b.onTabShow &&
        !1 === b.onTabShow(f, e, a.currentIndex())
      )
        return !1;
    };
    this.next = function(g) {
      if (
        d.hasClass("last") ||
        (b.onNext &&
          "function" === typeof b.onNext &&
          !1 === b.onNext(f, e, a.nextIndex()))
      )
        return !1;
      g = a.currentIndex();
      var c = a.nextIndex();
      c > a.navigationLength() ||
        (h.push(g),
        e
          .find(
            'li:has([data-toggle="tab"])' +
              (b.withVisible ? ":visible" : "") +
              ":eq(" +
              c +
              ") a"
          )
    ...
    this.previous = function(g) {
      if (
        d.hasClass("first") ||
        (b.onPrevious &&
          "function" === typeof b.onPrevious &&
          !1 === b.onPrevious(f, e, a.previousIndex()))
      )
        return !1;
      g = a.currentIndex();
    ...
    this.first = function(g) {
      if (
        (b.onFirst &&
          "function" === typeof b.onFirst &&
          !1 === b.onFirst(f, e, a.firstIndex())) ||
        d.hasClass("disabled")
      )
        return !1;
    ...
    this.last = function(g) {
      if (
        (b.onLast &&
          "function" === typeof b.onLast &&
          !1 === b.onLast(f, e, a.lastIndex())) ||
        d.hasClass("disabled")
      )
        return !1;
      h.push(a.currentIndex());
      e.find(
        'li:has([data-toggle="tab"]):eq(' + a.navigationLength() + ") a"
      ).tab("show");
    };
    this.finish = function(g) {
      if (b.onFinish && "function" === typeof b.onFinish)
        b.onFinish(f, e, a.lastIndex());
    };
    this.back = function() {
    ...
    this.currentIndex = function() {
      return e
        .find('li:has([data-toggle="tab"])' + (b.withVisible ? ":visible" : ""))
        .index(f);
    };
    ...
    this.navigationLength = function() {
      return (
        e.find(
          'li:has([data-toggle="tab"])' + (b.withVisible ? ":visible" : "")
        ).length - 1
      );
    };
    ...
    this.nextTab = function() {
      return e.find(
        'li:has([data-toggle="tab"]):eq(' + (a.currentIndex() + 1) + ")"
      ).length
        ? e.find(
            'li:has([data-toggle="tab"]):eq(' + (a.currentIndex() + 1) + ")"
          )
    ...
    this.previousTab = function() {
      return 0 >= a.currentIndex()
        ? null
        : e.find(
            'li:has([data-toggle="tab"]):eq(' +
              parseInt(a.currentIndex() - 1) +
              ")"
          );
    };
    this.show = function(b) {
      b = isNaN(b)
        ? d.find('li:has([data-toggle="tab"]) a[href="#' + b + '"]')
        : d.find('li:has([data-toggle="tab"]):eq(' + b + ") a");
      0 < b.length && (h.push(a.currentIndex()), b.tab("show"));
    };
    this.disable = function(a) {
      e.find('li:has([data-toggle="tab"]):eq(' + a + ")").addClass("disabled");
    };
    this.enable = function(a) {
      e.find('li:has([data-toggle="tab"]):eq(' + a + ")").removeClass(
        "disabled"
      );
    };
    ...
    var l = function(d) {
        ...
        if (
          ...
          !1 === b.onTabClick(f, e, a.currentIndex(), d, g)
        )
          return !1;
      },
      m = function(d) {
        ...
        if (
          d.hasClass("disabled") ||
          (b.onTabChange &&
            "function" === typeof b.onTabChange &&
            !1 === b.onTabChange(f, e, a.currentIndex(), g))
        )
          return !1;
        f = d;
    ...
    if (b.onShow && "function" === typeof b.onShow)
      b.onShow(f, e, a.nextIndex());
    c('a[data-toggle="tab"]', e).on("click", l);
    c('a[data-toggle="tab"]', e).on("show show.bs.tab", m);
  };
