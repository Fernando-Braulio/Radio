...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/pt"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badSecurityAnswer:
            "A pergunta de segurança não foi respondida corretamente",
          ...
          badUKVatAnswer:
            "O número do VAT digitado não é válido para o Reino Unido",
          ...
          badAlphaNumeric:
            "Use somente caracteres alfanuméricos (letras a-z e números)",
          badAlphaNumericExtra: " e",
          wrongFileSize:
            "O arquivo selecionado é maior que o tamanho máximo permitido (%s)",
          ...
          imageRatioNotAccepted:
            "A proporção da imagem (largura x altura) não é válida",
