...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/de"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badSecurityAnswer:
            "Sie haben die falsche Antwort auf die Sicherheitsfrage eingegeben",
          ...
          badSecurityNumber:
            "Sie haben eine falsche Sozialversicherungsnummer eingegeben",
          badUKVatAnswer:
            "Sie haben keine UK-Umsatzsteuer-Identifikationsnummer eingegeben",
          badStrength:
            "Sie haben ein Kennwort, das nicht sicher genug ist eingegeben",
          badNumberOfSelectedOptionsStart: "Wählen Sie zu mindestens ",
          badNumberOfSelectedOptionsEnd: " Antwort",
          badAlphaNumeric:
            "Sie können nur alphanumerische Zeichen (Buchstaben und Zahlen) eingeben",
          badAlphaNumericExtra: " und",
          wrongFileSize:
            "Die Datei, die Sie hochzuladen versuchen, ist zu groß (max %s)",
          ...
          badCreditCard:
            "Sie haben eine ungültige Kreditkartennummer eingegeben",
          ...
          badBrazilTelephoneAnswer:
            "Die eingegebene Telefonnummer ist nicht korrekt",
