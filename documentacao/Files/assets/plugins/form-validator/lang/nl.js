...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/nl"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          andSpaces: " en spaties ",
          badAlphaNumeric:
            "De ingevoerde waarde mag alleen alfabetische karakters bevatten",
          ...
          imageRatioNotAccepted:
            "De afbeeldingsverhouding wordt niet geaccepteerd",
          ...
          wrongFileSize:
            "Het bestand dat u probeert te uploaden is te groot (max %s)",
