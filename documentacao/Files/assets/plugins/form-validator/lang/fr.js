...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/fr"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badSecurityNumber:
            "Vous avez saisi un mauvais numéro de sécurité sociale",
          badUKVatAnswer:
            "Vous n'avez pas saisi un numéro de TVA au Royaume-Uni",
          ...
          badAlphaNumeric:
            "Vous ne pouvez répondre qu'avec des caractères alphanumériques et des chiffres ",
          badAlphaNumericExtra: " et ",
          wrongFileSize:
            "Le fichier que vous essayez de télécharger est trop grand (max %s)",
          ...
          badCreditCard:
            "Vous avez saisi un numéro de carte de crédit invalide",
