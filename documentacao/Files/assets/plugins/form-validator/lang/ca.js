...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/ca"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badSecurityAnswer:
            "La resposta a la seva pregunta de seguretat és incorrecte",
          ...
          badSecurityNumber:
            "El número de seguretat social proporcionat és incorrecte",
          badUKVatAnswer:
            "El número VAT proporcionat no és vàlid pel Regne Unit",
          badStrength:
            "La contrasenya proporcionada no és suficientment segura",
          badNumberOfSelectedOptionsStart: "Ha de seleccionar almenys",
          badNumberOfSelectedOptionsEnd: " resposta(es)",
          badAlphaNumeric:
            "El valor proporcionat només ha de contenir caràcters alfanumèrics (a-z i números)",
          badAlphaNumericExtra: " i",
          wrongFileSize:
            "L'arxiu que està tractant de pujar és massa gran (màx. %s)",
          ...
          badCreditCard:
            "El número de targeta de crèdit proporcionat no és vàlid",
          ...
          imageRatioNotAccepted:
            "La proporció de la imatge (alçada x amplada) no és vàlida"
        };
      });
  })(a, window);
});
