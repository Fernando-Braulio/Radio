...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/sv"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badAlphaNumeric:
            "Du kan endast svara med alfanumersika tecken (a-z och siffror)",
          ...
          imageRatioNotAccepted:
            "Bildens dimensioner (förhållandet mellan höjd och längd) kan inte accepteras"
        };
      });
  })(a, window);
});
