...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/pl"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badSecurityNumber:
            "Wprowadzono niepoprawny numer ubezpieczenia społecznego",
          ...
          badAlphaNumeric:
            "Wprowadzona wartość może zawierać tylko znaki alfanumeryczne ",
