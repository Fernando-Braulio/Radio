...
!(function(a, b) {
  ...
  !(function(a, b) {
    "use strict";
    a.formUtils.registerLoadedModule("lang/es"),
      a(b).bind("validatorsLoaded", function() {
        a.formUtils.LANG = {
          ...
          badSecurityAnswer:
            "La respuesta a su pregunta de seguridad es incorrecta",
          ...
          notConfirmed:
            "Los valores proporcionados no pudieron ser confirmados",
          ...
          badSecurityNumber:
            "El número de seguridad social proporcionado es incorrecto",
          badUKVatAnswer:
            "El número VAT proporcionado no es válido para el Reino Unido",
          badStrength:
            "La contraseña proporcionada no es lo suficientemente segura",
          badNumberOfSelectedOptionsStart: "Debe seleccionar al menos",
          badNumberOfSelectedOptionsEnd: " respuesta(s)",
          badAlphaNumeric:
            "El valor proporcionado solo debe contener caracteres alfanuméricos (a-z y números)",
          badAlphaNumericExtra: " y",
          wrongFileSize:
            "El archivo que está tratando de subir es demasiado grande (máx. %s)",
          ...
          badCreditCard:
            "El número de tarjeta de crédito proporcionado no es válido",
          ...
          imageRatioNotAccepted:
            "La proporción de imagen (alto x ancho) no es válida",
