...
!(function(a, b) {
  ...
  !(function(a, b) {
      ...
      a.formUtils.addValidator({
        ...
        validatorFunction: function(b, c, d, e, f) {
          ...
          if (!i.length)
            return (
              a.formUtils.warn(
                'Password confirmation validator: could not find an input with name "' +
                  h +
                  '"',
                !0
              ),
          ...
          if (
            ((g = i.val()), d.validateOnBlur && !i[0].hasValidationCallback)
          ) {
    ...
    a.formUtils.addValidator({
        ...
        if (
          ...
          if (
            (a.each(g, function(d, e) {
              if (e in c) {
                if (b.length >= c[e][0] && b.length <= c[e][1])
                  return (h = !0), !1;
      ...
      a.formUtils.addValidator({
        ...
        validatorFunction: function(b, c) {
          ...
          return (
            d && d > 3 && (d = 3),
            a.formUtils.validators.validate_strength.calculatePasswordStrength(
              b
            ) >= d
          );
        },
          ...
          var b = 0,
            c = function(a, b) {
              for (var c = "", d = 0; d < b.length; d++) {
                for (var e = !0, f = 0; f < a && f + d + a < b.length; f++)
                  e = e && b.charAt(f + d) === b.charAt(f + d + a);
                f < a && (e = !1),
                  e ? ((d += a - 1), (e = !1)) : (c += b.charAt(d));
              }
              return c;
            };
          return (
        ...
        strengthDisplay: function(b, c) {
          ...
          c && a.extend(d, c),
            b.bind("keyup", function() {
              var b = a(this).val(),
                c =
                  "undefined" == typeof d.parent
                    ? a(this).parent()
                    : a(d.parent),
                e = c.find(".strength-meter"),
                f = a.formUtils.validators.validate_strength.calculatePasswordStrength(
                  b
                ),
                g = {
                  background: "pink",
              ...
              0 === e.length &&
                ((e = a("<span></span>")),
                e.addClass("strength-meter").appendTo(c)),
                b ? e.show() : e.hide(),
                1 === f
                  ? (h = d.weak)
                  : 2 === f
                    ? ((g.background = "lightyellow"),
                      (g.borderColor = "yellow"),
                      (g.color = "goldenrod"),
                      (h = d.good))
                    : f >= 3 &&
                      ((g.background = "lightgreen"),
                      (g.borderColor = "darkgreen"),
                      (g.color = "darkgreen"),
                      (h = d.strong)),
                e.css(g).text(h);
            });
    ...
    var f = function(b, c, d, e, f) {
      ...
      if (!h)
        throw new Error(
          "Missing input name used for http requests made by server validator"
        );
      g || (g = {}),
    ...
    a.formUtils.addAsyncValidator({
      ...
      validatorFunction: function(a, b, c, d, e, g) {
        ...
        g.addClass("validating-server-side"),
          ...
          f(h, c, b, d, function(b) {
            g.removeClass("validating-server-side"),
              c.removeClass("validating-server-side"),
              b.message && c.attr(d.validationErrorMsgAttribute, b.message),
              a(b.valid);
          });
      },
      errorMessage: "",
              ...
              if (f) {
                ...
                (h = d.callback ? d.callback(b) : g.test(b)),
                  h
                    ...
                    : ("" === l && (l = e.passwordComplexityStart),
                      (l += e.passwordComplexitySeparator + f + d.dialogEnd),
                      c.trigger("complexityRequirementValidation", [!1, a]));
              }
            }),
      ...
      a.formUtils.addValidator({
        ...
        validatorFunction: function(a, b) {
          return (
            "" !== grecaptcha.getResponse(b.valAttr("recaptcha-widget-id"))
          );
        },
        errorMessage: "",
      ...
      (a.fn.displayPasswordStrength = function(b) {
        return (
          new a.formUtils.validators.validate_strength.strengthDisplay(this, b),
          this
        );
      });
    var g = function(b, c, d) {
      if (
        (c || (c = a("form")),
        "undefined" != typeof grecaptcha && !a.formUtils.hasLoadedGrecaptcha)
      )
        throw new Error(
          "reCaptcha API can not be loaded by hand, delete reCaptcha API snippet."
        );
      if (
        !a.formUtils.hasLoadedGrecaptcha &&
        a('[data-validation~="recaptcha"]', c).length
      ) {
          ...
          c &&
            a('[data-validation~="recaptcha"]', b).each(function() {
              ...
              var j = grecaptcha.render(e, {
                ...
                type: i,
                callback: function(a) {
                  b.find('[data-validation~="recaptcha"]').trigger(
                    "validation",
                    a && "" !== a
                  );
                },
