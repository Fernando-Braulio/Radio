          ...
          (i.isWindow = function(t) {
            ...
            (i.each = function(t, i, n) {
              var a,
                ...
                s = e(t);
              if (n) {
                if (s) for (; o > r && ((a = i.apply(t[r], n)), !1 !== a); r++);
                else for (r in t) if (((a = i.apply(t[r], n)), !1 === a)) break;
              } else if (s)
                for (; o > r && ((a = i.call(t[r], r, t[r])), !1 !== a); r++);
              else
                for (r in t) if (((a = i.call(t[r], r, t[r])), !1 === a)) break;
              return t;
            }),
      ...
      (function(t) {
        ...
        return (function(t, e, i, n) {
          ...
          function o(t, i, n, a) {
            ...
            function d(e) {
              for (var i = 0, a = 1, r = m - 1; a != r && x[a] <= e; ++a)
                i += v;
              var o = i + ((e - x[--a]) / (x[a + 1] - x[a])) * v,
                s = u(o, t, n);
              return s >= f
                ? (function(e, i) {
                    for (var a = 0; c > a; ++a) {
            ...
            function h() {
              (w = !0),
                (t != i || n != a) &&
                  (function() {
                    for (var e = 0; m > e; ++e) x[e] = l(e * v, t, n);
                  })();
            }
            var c = 4,
              f = 0.001,
                ...
                : (i =
                    p.isArray(t) && 1 === t.length
                      ...
                      : p.isArray(t) && 2 === t.length
                        ...
                        : !(!p.isArray(t) || 4 !== t.length) &&
                          o.apply(null, t)),
              !1 === i &&
                (i = b.Easings[b.defaults.easing] ? b.defaults.easing : v),
              i
            );
          }
          function l(t) {
            if (t) {
              ...
              for (var a = 0; i > a; a++)
                if (b.State.calls[a]) {
                  var o = b.State.calls[a],
                    s = o[0],
                    h = o[2],
                    c = o[3],
                    f = !!c,
                    g = null;
                  c || (c = b.State.calls[a][3] = e - 16);
                  for (
                    var m = Math.min((e - c) / h.duration, 1),
                      v = 0,
                      y = s.length;
                    y > v;
                    v++
                    ...
                    if (r(S)) {
                      ...
                      if (
                        ...
                        x.setPropertyValue(S, "display", h.display);
                      }
                      h.visibility !== n &&
                        "hidden" !== h.visibility &&
                        x.setPropertyValue(S, "visibility", h.visibility);
                      for (var M in w)
                        if ("element" !== M) {
                          var P,
                            A = w[M],
                            I = p.isString(A.easing)
                              ? b.Easings[A.easing]
                              : A.easing;
                          if (1 === m) P = A.endValue;
                          else {
                          ...
                          if (((A.currentValue = P), "tween" === M)) g = P;
                            ...
                            x.Hooks.registered[M] &&
                              (r(S).rootPropertyValueCache[D] = x.Normalizations
                                .registered[D]
            ...
            for (
              ...
              if (
                (e ||
                  o.loop ||
                  ("none" === o.display &&
                    x.setPropertyValue(c, "display", o.display),
                  "hidden" === o.visibility &&
                    x.setPropertyValue(c, "visibility", o.visibility)),
                !0 !== o.loop &&
                  (d.queue(c)[1] === n ||
                    !/\.velocityQueueEntryFlag/i.test(d.queue(c)[1])) &&
                  r(c))
              ) {
                ...
                d.each(x.Lists.transforms3D, function(t, e) {
                  var i = /^scale/.test(e) ? 1 : 0,
                    a = r(c).transformCache[e];
                  r(c).transformCache[e] !== n &&
                    new RegExp("^\\(" + i + "[^.]").test(a) &&
                    ((f = !0), delete r(c).transformCache[e]);
                }),
                  o.mobileHA &&
                    ((f = !0), delete r(c).transformCache.translate3d),
                  f && x.flushTransformCache(c),
                  x.Values.removeClass(c, "velocity-animating");
              }
              if (!e && o.complete && !o.loop && u === h - 1)
                try {
                  o.complete.call(a, a);
                } catch (t) {
                  setTimeout(function() {
              ...
              s && !0 !== o.loop && s(a),
                r(c) &&
                  !0 === o.loop &&
                  !e &&
                  (d.each(r(c).tweensContainer, function(t, e) {
                    /^rotate/.test(t) &&
                  ...
                  b(c, "reverse", { loop: !0, delay: o.delay })),
                !1 !== o.queue && d.dequeue(c, o.queue);
            }
            b.State.calls[t] = !1;
          ...
          if (!(7 >= c)) {
            ...
            var y = (function() {
              ...
              return function i(n, a, r) {
                var o,
                  ...
                  g,
                  m,
                  v = { x: -1, v: 0, tension: null, friction: null },
                  b = [0],
                  y = 0;
                for (
                  n = parseFloat(n) || 500,
                  ...
                  (d = s),
                    ...
                    (f = e(u, 0.5 * d, c)),
                    (p = e(u, d, f)),
                    (g = (1 / 6) * (h.dx + 2 * (c.dx + f.dx) + p.dx)),
                    (m = (1 / 6) * (h.dv + 2 * (c.dv + f.dv) + p.dv)),
                    (u.x = u.x + g * d),
                    (u.v = u.v + m * d),
                    (l = u),
                    b.push(1 + l.x),
                    (y += 16),
                    Math.abs(l.x) > 1e-4 && Math.abs(l.v) > 1e-4;

                );
                return o
                  ? function(t) {
                      return b[(t * (b.length - 1)) | 0];
                    }
                  : y;
              };
            })();
            (b.Easings = {
              ...
              d.each(
                ...
                function(t, e) {
                  b.Easings[e[0]] = o.apply(null, e[1]);
                }
              );
            var x = (b.CSS = {
              RegEx: {
              ...
              Hooks: {
                ...
                register: function() {
                  for (var t = 0; t < x.Lists.colors.length; t++) {
                    var e =
                      "color" === x.Lists.colors[t]
                        ? "0 0 0 1"
                        : "255 255 255 1";
                    x.Hooks.templates[x.Lists.colors[t]] = [
                  ...
                  if (c)
                    for (i in x.Hooks.templates) {
                      a = (n = x.Hooks.templates[i])[0].split(" ");
                ...
                cleanRootPropertyValue: function(t, e) {
                  return (
                    x.RegEx.valueUnwrap.test(e) &&
                      (e = e.match(x.RegEx.valueUnwrap)[1]),
                ...
                extractValue: function(t, e) {
                  ...
                  if (i) {
                    var n = i[0],
                      a = i[1];
                    return (e = x.Hooks.cleanRootPropertyValue(n, e))
                      .toString()
                      .match(x.RegEx.valueSplit)[a];
                  }
                  return e;
                },
                injectValue: function(t, e, i) {
                  ...
                  if (n) {
                    var a,
                      ...
                      o = n[1];
                    return (
                      ((a = (i = x.Hooks.cleanRootPropertyValue(r, i))
                        .toString()
                        .match(x.RegEx.valueSplit))[o] = e),
                      a.join(" ")
                    );
                  }
                  return i;
                      ...
                      case "extract":
                        ...
                        return (
                          x.RegEx.wrappedValueAlreadyExtracted.test(i)
                            ? (n = i)
                            : (n = (n = i.toString().match(x.RegEx.valueUnwrap))
                                ? n[1].replace(/,(\s+)?/g, " ")
                                : i),
                          n
                        );
                        ...
                        switch (t) {
                          ...
                          case "extract":
                            ...
                            if (x.RegEx.wrappedValueAlreadyExtracted.test(a))
                              ...
                              /^[A-z]+$/i.test(a)
                                ? (o = s[a] !== n ? s[a] : s.black)
                                : x.RegEx.isHex.test(a)
                                  ? (o =
                                      "rgb(" +
                                      x.Values.hexToRgb(a).join(" ") +
                                      ")")
              ...
              Names: {
                ...
                SVGAttribute: function(t) {
                  ...
                  return (
                    (c || (b.State.isAndroid && !b.State.isChrome)) &&
                      (e += "|transform"),
                ...
                prefixCheck: function(t) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      p.isString(b.State.prefixElement.style[a]))
                    )
              ...
              getPropertyValue: function(t, i, a, o) {
                function s(t, i) {
                  ...
                  if (8 >= c) l = d.css(t, i);
                    ...
                    if (
                      (/^(width|height)$/.test(i) &&
                        0 === x.getPropertyValue(t, "display") &&
                        ((h = !0),
                        x.setPropertyValue(
                          t,
                          "display",
                          x.Values.getDisplayType(t)
                        )),
                      !o)
                    ) {
                      if (
                        ...
                        var f =
                          t.offsetHeight -
                          (parseFloat(
                            x.getPropertyValue(t, "borderTopWidth")
                          ) || 0) -
                          (parseFloat(
                            x.getPropertyValue(t, "borderBottomWidth")
                          ) || 0) -
                          (parseFloat(x.getPropertyValue(t, "paddingTop")) ||
                            0) -
                          (parseFloat(x.getPropertyValue(t, "paddingBottom")) ||
                            0);
                        return a(), f;
                      }
                      if (
                        ...
                        var p =
                          t.offsetWidth -
                          (parseFloat(
                            x.getPropertyValue(t, "borderLeftWidth")
                          ) || 0) -
                          (parseFloat(
                            x.getPropertyValue(t, "borderRightWidth")
                          ) || 0) -
                          (parseFloat(x.getPropertyValue(t, "paddingLeft")) ||
                            0) -
                          (parseFloat(x.getPropertyValue(t, "paddingRight")) ||
                            0);
                        return a(), p;
                      }
                    }
                ...
                if (x.Hooks.registered[i]) {
                  var u = i,
                    h = x.Hooks.getRoot(u);
                  a === n &&
                    (a = x.getPropertyValue(t, x.Names.prefixCheck(h)[0])),
                    x.Normalizations.registered[h] &&
                      (a = x.Normalizations.registered[h]("extract", t, a)),
                    (l = x.Hooks.extractValue(u, a));
                } else if (x.Normalizations.registered[i]) {
                  var f, p;
                  "transform" !==
                    (f = x.Normalizations.registered[i]("name", t)) &&
                    ((p = s(t, x.Names.prefixCheck(f)[0])),
                    x.Values.isCSSNullValue(p) &&
                      x.Hooks.templates[i] &&
                      (p = x.Hooks.templates[i][1])),
                    (l = x.Normalizations.registered[i]("extract", t, p));
                }
                if (!/^[\d-]/.test(l))
              ...
              setPropertyValue: function(t, i, n, a, o) {
                ...
                if ("scroll" === i)
                  ...
                  "transform" === x.Normalizations.registered[i]("name", t)
                )
                  ...
                  if (x.Hooks.registered[i]) {
                    var l = i,
                      u = x.Hooks.getRoot(i);
                    (a = a || x.getPropertyValue(t, u)),
                      (n = x.Hooks.injectValue(l, n, a)),
                      (i = u);
                  }
                  if (
                    (x.Normalizations.registered[i] &&
                      ((n = x.Normalizations.registered[i]("inject", t, n)),
                    ...
                    r(t) && r(t).isSVG && x.Names.SVGAttribute(i)
                      ? t.setAttribute(i, n)
                      : (t.style[s] = n);
                  b.debug >= 2 &&
              ...
              if (
                ...
                switch (
                  ...
                  case "stop":
                    ...
                    var A = [];
                    return (
                      d.each(b.State.calls, function(t, e) {
                        e &&
                          d.each(e[1], function(i, a) {
                            ...
                            return (
                              (!0 !== o &&
                                e[2].queue !== o &&
                                (v !== n || !1 !== e[2].queue)) ||
                              void d.each(f, function(i, n) {
                                n === a &&
                                  ((!0 === v || p.isString(v)) &&
                                    (d.each(
                                      d.queue(n, p.isString(v) ? v : ""),
                                      function(t, e) {
                                  ...
                                  "stop" === g
                                    ? (r(n) &&
                                        r(n).tweensContainer &&
                                        !1 !== o &&
                                        d.each(r(n).tweensContainer, function(
                                          t,
                                          e
                                        ) {
                  ...
                  default:
                    if (!d.isPlainObject(g) || p.isEmptyObject(g)) {
                      if (p.isString(g) && b.Redirects[g]) {
                        var I = (V = d.extend({}, v)).duration,
                          T = V.delay || 0;
                        return (
                          !0 === V.backwards &&
                            (f = d.extend(!0, [], f).reverse()),
                          d.each(f, function(t, e) {
                            parseFloat(V.stagger)
                              ? (V.delay = T + parseFloat(V.stagger) * t)
                              : p.isFunction(V.stagger) &&
                                (V.delay = T + V.stagger.call(e, t, k)),
                              V.drag &&
                                ((V.duration =
                                  parseFloat(I) ||
                      ...
                      return (
                        P.promise ? P.rejecter(new Error(D)) : console.log(D),
                        t()
                      );
                    }
                    M = "start";
                ...
                if (
                      ...
                      function() {
                        function t(t) {
                          function c(t, e) {
                            ...
                            return (
                              p.isArray(t)
                                ...
                                : (i = t),
                              e || (a = a || u.easing),
                              p.isFunction(i) && (i = i.call(o, S, k)),
                              p.isFunction(r) && (r = r.call(o, S, k)),
                              [i || 0, a, r]
                            );
                          }
                          function m(t, e) {
                          ...
                          function y() {
                            var t = {
                              ...
                              n =
                                t.position === _.lastPosition &&
                                t.myParent === _.lastParent,
                              a = t.fontSize === _.lastFontSize;
                            (_.lastParent = t.myParent),
                              (_.lastPosition = t.position),
                              (_.lastFontSize = t.fontSize);
                            var s = {};
                            if (a && n)
                              (s.emToPx = _.lastEmToPx),
                                (s.percentToPxWidth = _.lastPercentToPxWidth),
                                (s.percentToPxHeight = _.lastPercentToPxHeight);
                            else {
                              var l = r(o).isSVG
                                ? i.createElementNS(
                              ...
                              b.init(l),
                                ...
                                d.each(
                                  ...
                                  function(t, e) {
                                    b.CSS.setPropertyValue(l, e, "100%");
                                  }
                                ),
                                b.CSS.setPropertyValue(
                                  l,
                                ...
                                (s.percentToPxWidth = _.lastPercentToPxWidth =
                                  (parseFloat(
                                    x.getPropertyValue(l, "width", null, !0)
                                  ) || 1) / 100),
                                (s.percentToPxHeight = _.lastPercentToPxHeight =
                                  (parseFloat(
                                    x.getPropertyValue(l, "height", null, !0)
                                  ) || 1) / 100),
                                (s.emToPx = _.lastEmToPx =
                                  (parseFloat(
                                    x.getPropertyValue(l, "paddingLeft")
                                  ) || 1) / 100),
                            ...
                            return (
                              null === _.remToPx &&
                                (_.remToPx =
                                  parseFloat(
                                    x.getPropertyValue(i.body, "fontSize")
                                  ) || 16),
                              null === _.vwToPx &&
                                ((_.vwToPx = parseFloat(e.innerWidth) / 100),
                                (_.vhToPx = parseFloat(e.innerHeight) / 100)),
                              (s.remToPx = _.remToPx),
                              (s.vwToPx = _.vwToPx),
                              (s.vhToPx = _.vhToPx),
                              b.debug >= 1 &&
                          ...
                          if ("scroll" === M) {
                            ...
                            u.container
                              ? p.isWrapped(u.container) ||
                                p.isNode(u.container)
                                ? ((u.container =
                                    u.container[0] || u.container),
                                  (A =
                                    (w = u.container["scroll" + I]) +
                                    d(o).position()[I.toLowerCase()] +
                                    T))
                                : (u.container = null)
                              : ((w =
                                  b.State.scrollAnchor[
                                    b.State["scrollProperty" + I]
                                  ]),
                                (C =
                                  b.State.scrollAnchor[
                                    b.State[
                            ...
                            for (var F in D)
                              if ("element" !== F) {
                                ...
                                (D[F].startValue = D[F].currentValue =
                                  D[F].endValue),
                                  (D[F].endValue = V),
                                  p.isEmptyObject(v) ||
                                    (D[F].easing = u.easing),
                                  ...
                                  if (x.RegEx.isHex.test(a)) {
                                    for (
                                      var s = ["Red", "Green", "Blue"],
                                        l = x.Values.hexToRgb(a),
                                        u = o ? x.Values.hexToRgb(o) : n,
                                        d = 0;
                                      d < s.length;
                                      d++
                                    ) {
                            ...
                            for (var O in g) {
                              ...
                              if (
                                r(o).isSVG ||
                                "tween" === B ||
                                !1 !== x.Names.prefixCheck(B)[1] ||
                                x.Normalizations.registered[B] !== n
                              ) {
                                ((u.display !== n &&
                                  null !== u.display &&
                                  "none" !== u.display) ||
                                  ...
                                  0 !== z &&
                                  (N = 0),
                                  u._cacheValues && D && D[O]
                                    ? (N === n &&
                                        (N = D[O].endValue + D[O].unitType),
                                      (W = r(o).rootPropertyValueCache[B]))
                                    : x.Hooks.registered[O]
                                      ? N === n
                                        ? ((W = x.getPropertyValue(o, B)),
                                          (N = x.getPropertyValue(o, O, W)))
                                        : (W = x.Hooks.templates[B][1])
                                      : N === n &&
                                        (N = x.getPropertyValue(o, O));
                                var H,
                                  j,
                                  q,
                                  Y = !1;
                          ...
                          h.element &&
                            ...
                            L.push(h),
                            "" === u.queue &&
                              ((r(o).tweensContainer = h), (r(o).opts = u)),
                            (r(o).isAnimating = !0),
                            S === k - 1
                              ? (b.State.calls.push([
                                  L,
                        ...
                        !1 !== b.mock &&
                          (!0 === b.mock
                            ...
                            : ((u.duration *= parseFloat(b.mock) || 1),
                              (u.delay *= parseFloat(b.mock) || 1))),
                          (u.easing = s(u.easing, u.duration)),
                          u.begin && !p.isFunction(u.begin) && (u.begin = null),
                          u.progress &&
                            !p.isFunction(u.progress) &&
                            (u.progress = null),
                          u.complete &&
                            !p.isFunction(u.complete) &&
                            (u.complete = null),
                          u.display !== n &&
                            null !== u.display &&
                            ((u.display = u.display.toString().toLowerCase()),
                            "auto" === u.display &&
                              (u.display = b.CSS.Values.getDisplayType(o))),
                          u.visibility !== n &&
                            null !== u.visibility &&
                  ...
                  ((V = d.extend({}, b.defaults, v)).loop = parseInt(V.loop)),
                  (F = 2 * V.loop - 1),
                  V.loop)
                )
                  for (var O = 0; F > O; O++) {
                    var R = { delay: V.delay, progress: V.progress };
                    O === F - 1 &&
                      ((R.display = V.display),
                ...
                i.addEventListener("visibilitychange", function() {
                  i.hidden
                    ? ((k = function(t) {
                      ...
                      l())
                    : (k = e.requestAnimationFrame || f);
                }),
              (t.Velocity = b),
              t !== e &&
                ((t.fn.velocity = w), (t.fn.velocity.defaults = b.defaults)),
        ...
        7: [
          function(t, e, i) {
            ...
            t(26)(n),
              ...
              t(14)(n);
            var a = [];
            a.push(t(41)(n), t(42)(n), t(43)(n)),
              n.plugins.register(a),
              (e.exports = n),
              ...
              (t.defaults.bar = {
                ...
                (t.controllers.bar = t.DatasetController.extend({
                  ...
                  updateElement: function(t, i, n) {
                    ...
                    (t._xScale = this.getScaleForId(r.xAxisID)),
                      (t._yScale = this.getScaleForId(r.yAxisID)),
                      (t._datasetIndex = this.index),
                      (t._index = i),
                      (t._model = {
                        datasetLabel: o.label,
                        label: a.data.labels[i],
                      ...
                      this.updateElementGeometry(t, i, n),
                      t.pivot();
                  },
                  updateElementGeometry: function(t, e, i) {
                    var n = t._model,
                      ...
                      u = this.calculateBarIndexPixels(this.index, e, s);
                    (n.horizontal = o),
                      (n.base = i ? r : l.base),
                      (n.x = o ? (i ? r : l.head) : u.center),
                      (n.y = o ? u.center : i ? r : l.head),
                      (n.height = o ? u.size : void 0),
                      (n.width = o ? void 0 : u.size);
                  },
                  ...
                  getRuler: function() {
                    var t = this.getIndexScale(),
                      ...
                      a =
                        (t.isHorizontal() ? t.width : t.height) /
                        t.ticks.length,
                  ...
                  calculateBarValuePixels: function(t, e) {
                    ...
                    return (
                      ...
                      {
                        size: (s = ((o = d.getPixelForValue(g + c)) - r) / 2),
                        base: r,
                        head: o,
                        center: o + s / 2
                      }
              ...
              (t.defaults.bubble = {
                ...
                (t.controllers.bubble = t.DatasetController.extend({
                  ...
                  updateElement: function(i, n, a) {
                    ...
                    e.extend(i, {
                      ...
                      _model: {
                        ...
                        y: a ? s.getBasePixel() : s.getPixelForValue(d, n, c),
                        radius: a ? 0 : l.radius ? l.radius : this.getRadius(d),
                    ...
                    var f = i._model;
                    (f.skip = l.skip ? l.skip : isNaN(f.x) || isNaN(f.y)),
                      i.pivot();
                  },
                  ...
                  removeHoverStyle: function(e) {
                    ...
                    var i = this.chart.data.datasets[e._datasetIndex].data[
                        e._index
                      ],
                      n = e.custom || {};
                ...
                tooltips: {
                  callbacks: {
                    ...
                    label: function(t, i) {
                      ...
                      return (
                        e.isArray(n) ? ((n = n.slice())[0] += a) : (n += a), n
                      );
                    }
                  }
                }
                ...
                (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
                  {
                    ...
                    update: function(t) {
                      ...
                      (n.borderWidth = i.getMaxBorderWidth(h.data)),
                        ...
                        (i.outerRadius =
                          n.outerRadius -
                          n.radiusLength * i.getRingIndex(i.index)),
                        (i.innerRadius = Math.max(
                          i.outerRadius - n.radiusLength,
                          0
                        )),
                        e.each(h.data, function(e, n) {
                          i.updateElement(e, n, t);
                        });
                    },
                    updateElement: function(t, i, n) {
                      var a = this.chart,
                        ...
                        f =
                          n && s.animateRotate
                            ...
                            : t.hidden
                              ? 0
                              : this.calculateCircumference(c.data[i]) *
                                (o.circumference / (2 * Math.PI)),
                        p = n && s.animateScale ? 0 : this.innerRadius,
                        g = n && s.animateScale ? 0 : this.outerRadius,
                      ...
                      e.extend(t, {
                        ...
                        _model: {
                          ...
                          outerRadius: g,
                          innerRadius: p,
                          label: m(c.label, i, a.data.labels[i])
                        }
                      });
                      var v = t._model;
                      this.removeHoverStyle(t),
                        (n && s.animateRotate) ||
                          ((v.startAngle =
                            0 === i
                              ? o.rotation
                              : this.getMeta().data[i - 1]._model.endAngle),
                ...
                (t.controllers.line = t.DatasetController.extend({
                  ...
                  update: function(t) {
                    var n,
                      ...
                      d = u.elements.line,
                      h = this.getScaleForId(o.yAxisID),
                      c = this.getDataset(),
                      f = i(c, u);
                    for (
                      f &&
                        ...
                        (s._model = {
                          ...
                          tension: r.tension
                            ? r.tension
                            : e.getValueOrDefault(c.lineTension, d.tension),
                          ...
                          borderCapStyle: r.borderCapStyle
                            ? r.borderCapStyle
                            : c.borderCapStyle || d.borderCapStyle,
                          borderDash: r.borderDash
                            ? r.borderDash
                            : c.borderDash || d.borderDash,
                          borderDashOffset: r.borderDashOffset
                            ? r.borderDashOffset
                            : c.borderDashOffset || d.borderDashOffset,
                          borderJoinStyle: r.borderJoinStyle
                            ? r.borderJoinStyle
                            : c.borderJoinStyle || d.borderJoinStyle,
                          fill: r.fill
                            ? r.fill
                            : void 0 !== c.fill
                              ? c.fill
                          ...
                          steppedLine: r.steppedLine
                            ? r.steppedLine
                            : e.getValueOrDefault(c.steppedLine, d.stepped),
                  ...
                  draw: function() {
                    var e = this.chart,
                      ...
                      s = 0;
                    for (
                      t.canvasHelpers.clipArea(e.ctx, r),
                        i(this.getDataset(), e.options) && n.dataset.draw(),
                ...
                legend: {
                  ...
                  onClick: function(t, e) {
                    var i,
                      ...
                      o = this.chart;
                    for (i = 0, n = (o.data.datasets || []).length; i < n; ++i)
                      (a = o.getDatasetMeta(i)).data[r].hidden = !a.data[r]
                        .hidden;
                    o.update();
                  }
                },
                  ...
                  update: function(t) {
                    ...
                    (n.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                      ...
                      (n.radiusLength =
                        ...
                        n.getVisibleDatasetCount()),
                      (i.outerRadius =
                        n.outerRadius - n.radiusLength * i.index),
                  ...
                  updateElement: function(t, i, n) {
                    for (
                      var a = this.chart,
                        ...
                        u = e.getValueAtIndexOrDefault,
                        d = a.data.labels,
                        h = this.calculateCircumference(r.data[i]),
                        c = l.xCenter,
                        f = l.yCenter,
                        p = 0,
                        g = this.getMeta(),
                    ...
                    var v = o.startAngle,
                      b = t.hidden
                        ? 0
                        : l.getDistanceFromCenterForValue(r.data[i]),
                      y = v + h * p,
                      x = y + (t.hidden ? 0 : h),
                      w = s.animateScale
                        ? 0
                    ...
                    e.extend(t, {
                      ...
                      _model: {
                        ...
                        innerRadius: 0,
                        outerRadius: n ? w : b,
                        startAngle: n && s.animateRotate ? v : y,
                ...
                (t.controllers.radar = t.DatasetController.extend({
                  ...
                  updateElement: function(t, i, n) {
                    var a = t.custom || {},
                      ...
                      l = o.getPointPositionForValue(i, r.data[i]);
                    void 0 !== r.radius &&
                  ...
                  removeHoverStyle: function(t) {
                    ...
                    (r.radius = n.radius
                      ? n.radius
                      : e.getValueAtIndexOrDefault(i.pointRadius, a, o.radius)),
              ...
              (t.defaults.global.animation = {
                ...
                (t.animationService = {
                  ...
                  cancelAnimation: function(t) {
                    ...
                    -1 !== i &&
                      (this.animations.splice(i, 1), (t.animating = !1));
                  },
                  ...
                  startDigest: function() {
                    ...
                    this.dropFrames > 1 &&
                      ...
                      this.advance(1 + e);
                    var i = Date.now();
                    (this.dropFrames += (i - t) / this.frameDuration),
                  ...
                  advance: function(t) {
                    for (var i, n, a = this.animations, r = 0; r < a.length; )
                      (n = (i = a[r]).chart),
                        (i.currentStep = (i.currentStep || 0) + t),
                        (i.currentStep = Math.min(i.currentStep, i.numSteps)),
                        e.callback(i.render, [n, i], n),
                        e.callback(i.onAnimationProgress, [i], n),
          ...
          function(t, e, i) {
            ...
            e.exports = function(t) {
              ...
              (e.drawPoint = function(e, i, n, a, r) {
                ...
                if (
                  "object" != typeof i ||
                  ("[object HTMLImageElement]" !== (o = i.toString()) &&
                  ...
                  if (!(isNaN(n) || n <= 0)) {
                    switch (i) {
                      ...
                      case "triangle":
                        e.beginPath(),
                          (d =
                            ((s = (3 * n) / Math.sqrt(3)) * Math.sqrt(3)) / 2),
                      ...
                      case "rect":
                        (h = (1 / Math.SQRT2) * n),
                          e.beginPath(),
                          e.fillRect(a - h, r - h, 2 * h, 2 * h),
                          e.strokeRect(a - h, r - h, 2 * h, 2 * h);
                        break;
                      case "rectRounded":
                        var c = n / Math.SQRT2,
                          f = a - c,
                          p = r - c,
                          g = Math.SQRT2 * n;
                        t.helpers.drawRoundedRectangle(e, f, p, g, g, n / 2),
                          e.fill();
                        break;
                      case "rectRot":
                        (h = (1 / Math.SQRT2) * n),
                ...
                e.extend(t.prototype, {
                  construct: function(i, a) {
                    var r,
                      o,
                      s = this;
                    ((o = (r = (r = a) || {}).data = r.data || {}).datasets =
                      o.datasets || []),
                      (o.labels = o.labels || []),
                      (r.options = e.configMerge(
                        t.defaults.global,
                        t.defaults[r.type],
                        r.options || {}
                      )),
                      (a = r);
                    var l = n.acquireContext(i, a),
                      u = l && l.canvas,
                      d = u && u.height,
                      h = u && u.width;
                    (s.id = e.uid()),
                  ...
                  resize: function(t) {
                    var n = this.options,
                      a = this.canvas,
                      r = (n.maintainAspectRatio && this.aspectRatio) || null,
                      o = Math.floor(e.getMaximumWidth(a)),
                      s = Math.floor(r ? o / r : e.getMaximumHeight(a));
                    if (
                      (this.width !== o || this.height !== s) &&
                      ((a.width = this.width = o),
                      (a.height = this.height = s),
                      (a.style.width = o + "px"),
                      (a.style.height = s + "px"),
                      e.retinaScale(this),
                      !t)
                    ) {
                      var l = { width: o, height: s };
                      i.notify(this, "resize", [l]),
                        this.options.onResize && this.options.onResize(this, l),
                        this.stop(),
                  ...
                  updateDataset: function(t) {
                    ...
                    !1 !== i.notify(this, "beforeDatasetUpdate", [n]) &&
                      (e.controller.update(),
                      i.notify(this, "afterDatasetUpdate", [n]));
                  },
                  render: function(n, a) {
                    var r = this;
                    if (!1 !== i.notify(r, "beforeRender")) {
                      ...
                      if (
                        ...
                        r.draw(), s(new t.Animation({ numSteps: 0, chart: r }));
                      return r;
                    }
                  },
                  draw: function(t) {
                  ...
                  drawDatasets: function(t) {
                    if (!1 !== i.notify(this, "beforeDatasetsDraw", [t])) {
                      for (
                        var e = (this.data.datasets || []).length - 1;
                        e >= 0;
                        --e
                      )
                        this.isDatasetVisible(e) && this.drawDataset(e, t);
                      i.notify(this, "afterDatasetsDraw", [t]);
                    }
                  },
                  drawDataset: function(t, e) {
                    ...
                    !1 !== i.notify(this, "beforeDatasetDraw", [a]) &&
                      (n.controller.draw(e),
                      i.notify(this, "afterDatasetDraw", [a]));
                  },
                  ...
                  destroy: function() {
                    var a,
                      ...
                      s = this.canvas;
                    for (
                      this.stop(), r = 0, o = this.data.datasets.length;
                      r < o;
                      ++r
                    )
                      (a = this.getDatasetMeta(r)).controller &&
                        (a.controller.destroy(), (a.controller = null));
                    s &&
                      (this.unbindEvents(),
                      e.clear(this),
                      n.releaseContext(this.ctx),
                      (this.canvas = null),
                      (this.ctx = null)),
                      i.notify(this, "destroy"),
                  ...
                  eventHandler: function(t) {
                    var e = this.tooltip;
                    if (!1 !== i.notify(this, "beforeEvent", [t])) {
                      (this._bufferedRender = !0),
                        (this._bufferedRequest = null);
                      var n = this.handleEvent(t);
                      (n |= e && e.handleEvent(t)),
                        i.notify(this, "afterEvent", [t]);
                      var a = this._bufferedRequest;
                      return (
                        a
                          ? this.render(a.duration, a.lazy)
                          : n &&
                            !this.animating &&
                            (this.stop(),
                            this.render(
                  ...
                  handleEvent: function(t) {
                    ...
                    return (
                      ...
                      "mouseout" === t.type
                        ? (this.active = [])
                        : (this.active = this.getElementsAtEventForMode(
                            t,
                            a.mode,
                            a
                          )),
                      a.onHover && a.onHover.call(this, t.native, this.active),
                      ("mouseup" !== t.type && "click" !== t.type) ||
                        (n.onClick &&
                          n.onClick.call(this, t.native, this.active)),
                      this.lastActive.length &&
                        this.updateHoverStyle(this.lastActive, a.mode, !1),
                      this.active.length &&
                        a.mode &&
                        this.updateHoverStyle(this.active, a.mode, !0),
                      (i = !e.arrayEquals(this.active, this.lastActive)),
                ...
                e.extend(t.DatasetController.prototype, {
                            ...
                            Object.defineProperty(t, i, {
                              ...
                              value: function() {
                                var i = Array.prototype.slice.call(arguments),
                                  r = a.apply(this, i);
                                return (
                                  e.each(t._chartjs.listeners, function(t) {
                                    "function" == typeof t[n] &&
                                      t[n].apply(t, i);
                                  }),
                                  r
                  ...
                  removeHoverStyle: function(t, i) {
                    ...
                    (s.backgroundColor = r.backgroundColor
                      ? r.backgroundColor
                      : o(n.backgroundColor, a, i.backgroundColor)),
                      (s.borderColor = r.borderColor
                        ? r.borderColor
                        : o(n.borderColor, a, i.borderColor)),
                  ...
                  setHoverStyle: function(t) {
                    ...
                    (s.backgroundColor = a.hoverBackgroundColor
                      ? a.hoverBackgroundColor
                      : r(i.hoverBackgroundColor, n, o(s.backgroundColor))),
                      (s.borderColor = a.hoverBorderColor
                        ? a.hoverBorderColor
                        : r(i.hoverBorderColor, n, o(s.borderColor))),
            ...
            e.exports = function(t) {
              ...
              (t.elements = {}),
                ...
                e.extend(t.Element.prototype, {
                  ...
                  transition: function(t) {
                    ...
                    return e && 1 !== t
                      ? (a || (a = this._view = {}),
                        ...
                        this)
                      : ((this._view = e), (this._start = null), this);
                  },
                  ...
                  hasValue: function() {
                    return (
                      e.isNumber(this._model.x) && e.isNumber(this._model.y)
                    );
                  }
                }),
            ...
            e.exports = function(t) {
              ...
              (i.each = function(t, e, n, a) {
                ...
                (i.configMerge = function(e) {
                  var n = i.clone(e);
                  return (
                    i.each(Array.prototype.slice.call(arguments, 1), function(
                      e
                    ) {
                    ...
                    i.each(n, function(e, n) {
                      "xAxes" === n || "yAxes" === n
                        ? a.hasOwnProperty(n)
                          ...
                          : ((a[n] = []),
                            i.each(e, function(e) {
                              var r = i.getValueOrDefault(
                                e.type,
                                "xAxes" === n ? "category" : "linear"
                              );
                              a[n].push(
                                i.configMerge(
                                  t.scaleService.getScaleDefaults(r),
                                  e
                                )
                              );
                            }))
                ...
                (i.where = function(t, e) {
                  if (i.isArray(t) && Array.prototype.filter)
                    return t.filter(e);
                  var n = [];
                  return (
                    i.each(t, function(t) {
                ...
                (i.splineCurveMonotone = function(t) {
                  var e,
                    n,
                    a,
                    r,
                  ...
                  for (e = 0; e < c; ++e)
                    if (!(a = h[e]).model.skip) {
                      if (
                        ((n = e > 0 ? h[e - 1] : null),
                        (r = e < c - 1 ? h[e + 1] : null) && !r.model.skip)
                      ) {
              ...
              function s(t, e, i) {
                ...
                return u || d
                  ? Math.min(u ? r(s, t, i) : h, d ? r(l, a, i) : h)
                  : "none";
              }
              (i.requestAnimFrame =
                "undefined" == typeof window
                ...
                (i.getRelativePosition = function(t, e) {
                  ...
                  var u = parseFloat(i.getStyle(o, "padding-left")),
                    ...
                    h = parseFloat(i.getStyle(o, "padding-right")),
                    c = parseFloat(i.getStyle(o, "padding-bottom")),
                  ...
                  if (t) {
                    ...
                    isNaN(s)
                      ? ((l = s.left || 0),
                        ...
                        (h = s.bottom || 0))
                      : ((l = s), (u = s), (d = s), (h = s));
                    var c = i(t.boxes, "left"),
                      f = i(t.boxes, "right"),
                      p = i(t.boxes, "top"),
                      g = i(t.boxes, "bottom"),
                      m = i(t.boxes, "chartArea");
                    n(c, !0), n(f, !1), n(p, !0), n(g, !1);
                    var v = a - l - u,
                      b = r - d - h,
                      y = b / 2,
                      ...
                      S = b,
                      C = [];
                    e.each(c.concat(f, p, g), function(t) {
                      var e,
                        i = t.isHorizontal();
                      i
                        ? ((e = t.update(t.fullWidth ? v : k, w)),
                          (S -= e.height))
                        : ((e = t.update(x, y)), (k -= e.width)),
              ...
              (t.defaults.scale = {
                ...
                (t.Scale = t.Element.extend({
                  ...
                  beforeTickToLabelConversion: function() {
                    e.callback(this.options.beforeTickToLabelConversion, [
                      this
                    ]);
                  },
                  ...
                  beforeCalculateTickRotation: function() {
                    e.callback(this.options.beforeCalculateTickRotation, [
                      this
                    ]);
                  },
                  calculateTickRotation: function() {
                    ...
                    if (this.options.display && this.isHorizontal())
                      for (
                        ...
                        var d = e.toRadians(r);
                        if (
                          ((o = Math.cos(d)), Math.sin(d) * s > this.maxHeight)
                        ) {
                          r--;
                          break;
                        }
                  ...
                  fit: function() {
                    var t = (this.minSize = { width: 0, height: 0 }),
                      a = this.options,
                      r = a.ticks,
                      o = a.scaleLabel,
                      s = a.gridLines,
                    ...
                    if (
                      ...
                      (t.height = u
                        ? l && s.drawTicks
                          ...
                          : 0
                        : this.maxHeight),
                      o.display && l && (u ? (t.height += h) : (t.width += h)),
                      r.display && l)
                    ) {
                      var f = e.longestText(
                          this.ctx,
                        ...
                        p = e.numberOfLabelLines(this.ticks),
                        g = 0.5 * d.size;
                      if (u) {
                        this.longestLabelWidth = f;
                        var m = e.toRadians(this.labelRotation),
                          v = Math.cos(m),
                          b = Math.sin(m) * f + d.size * p + g * p;
                        (t.height = Math.min(this.maxHeight, t.height + b)),
                          (this.ctx.font = d.font);
                        var y = this.ticks[0],
                          x = i(this.ctx, y, d.font),
                          w = this.ticks[this.ticks.length - 1],
                          k = i(this.ctx, w, d.font);
                        0 !== this.labelRotation
                          ? ((this.paddingLeft =
                              "bottom" === a.position ? v * x + 3 : v * g + 3),
                            (this.paddingRight =
                              "bottom" === a.position ? v * g + 3 : v * k + 3))
                          : ((this.paddingLeft = x / 2 + 3),
                            (this.paddingRight = k / 2 + 3));
                      } else
                        r.mirror ? (f = 0) : (f += this.options.ticks.padding),
                          (t.width = Math.min(this.maxWidth, t.width + f)),
                          (this.paddingTop = d.size / 2),
                          (this.paddingBottom = d.size / 2);
                    }
                    this.handleMargins(),
                      (this.width = t.width),
                    ...
                    if (r.display) {
                      ...
                      if (
                        (e.each(a.ticks, function(t, n) {
                          if (void 0 !== t && null !== t) {
                            ...
                            if (
                              ...
                              var l, c, p, m, v, y, x, k, S, T, D, F, V, _;
                              n ===
                              (void 0 !== a.zeroLineIndex ? a.zeroLineIndex : 0)
                                ? ((l = h.zeroLineWidth),
                                  (c = h.zeroLineColor),
                                  (p = h.zeroLineBorderDash),
                                  (m = h.zeroLineBorderDashOffset))
                                : ((l = e.getValueAtIndexOrDefault(
                                    h.lineWidth,
                                    n
                                  )),
                                  (c = e.getValueAtIndexOrDefault(h.color, n)),
                              ...
                              if (g) {
                                ...
                                (V =
                                  a.getPixelForTick(n, h.offsetGridLines) +
                                  d.labelOffset),
                                  (v = x = S = D = R),
                                  (y = A),
                                  (k = I),
                                ...
                                d.mirror
                                  ? ((L = E ? "left" : "right"), (z = N))
                                  : ((L = E ? "right" : "left"), (z = b + N)),
                                  (V = E ? a.right - z : a.left + z);
                                var B = a.getPixelForTick(n);
                                (B += e.aliasPixel(l)),
                                  (_ = a.getPixelForTick(n, h.offsetGridLines)),
                                  (v = M),
                                  (x = P),
                                  (S = i.left),
                                  (D = i.right),
                        ...
                        if (g)
                          ...
                          (T = V ? a.left + x.size / 2 : a.right - x.size / 2),
                            (D = a.top + (a.bottom - a.top) / 2),
                            (F = V ? -0.5 * Math.PI : 0.5 * Math.PI);
                        }
                        l.save(),
                          l.translate(T, D),
                          l.rotate(F),
                      ...
                      if (h.drawBorder) {
                        ...
                        g
                          ? ((O = R = "top" === r.position ? a.bottom : a.top),
                            (O += z),
                            (R += z))
                          : ((_ = L = "left" === r.position ? a.right : a.left),
                            (_ += z),
                            (L += z)),
                          l.beginPath(),
                          l.moveTo(_, O),
                ...
                (t.Tooltip = t.Element.extend({
                  ...
                  getBody: function(t, i) {
                    ...
                    return (
                      e.each(t, function(t) {
                        ...
                        n(e.before, r.beforeLabel.call(a, t, i)),
                          n(e.lines, r.label.call(a, t, i)),
                          n(e.after, r.afterLabel.call(a, t, i)),
                          o.push(e);
                      }),
                      o
                    );
                  ...
                  update: function(i) {
                    var n,
                      ...
                      V = { x: M.caretX, y: M.caretY };
                    if (A.length) {
                      P.opacity = 1;
                      var _ = [];
                      V = t.Tooltip.positioners[C.position](
                        A,
                        S._eventPosition
                      );
                      var L = [];
                      for (n = 0, r = A.length; n < r; ++n)
                        L.push(
                          ...
                          void 0,
                          (y = b._xScale),
                          (x = b._yScale || b._scale),
                          (w = b._index),
                          (k = b._datasetIndex),
                          {
                            xLabel: y ? y.getLabelForIndex(w, k) : "",
                      ...
                      C.filter &&
                        ...
                        C.itemSort &&
                          (L = L.sort(function(t, e) {
                            return C.itemSort(t, e, I);
                          })),
                        e.each(L, function(t) {
                          _.push(C.callbacks.labelColor.call(S, t, S._chart));
                        }),
                        (P.title = S.getTitle(L, I)),
                        (P.beforeBody = S.getBeforeBody(L, I)),
                        (P.body = S.getBody(L, I)),
                        (P.afterBody = S.getAfterBody(L, I)),
                        (P.footer = S.getFooter(L, I)),
                        (P.x = Math.round(V.x)),
                        (P.y = Math.round(V.y)),
                        (P.caretPadding = C.caretPadding),
                        (P.labelColors = _),
                        (P.dataPoints = L),
                        (T = (function(t, e) {
                          var i,
                          ...
                          (F = (function(t, i) {
                            ...
                            var l = i.title.length,
                              ...
                              c = i.footerFontSize;
                            (a += l * d),
                              (a += l ? (l - 1) * i.titleSpacing : 0),
                              (a += l ? i.titleMarginBottom : 0),
                              (a += s * h),
                              (a += s ? (s - 1) * i.bodySpacing : 0),
                              (a += u ? i.footerMarginTop : 0),
                              (a += u * c),
                              (a += u ? (u - 1) * i.footerSpacing : 0);
                            var f = 0,
                              p = function(t) {
                            ...
                            return (
                              ...
                              e.each(i.beforeBody.concat(i.afterBody), p),
                              (f = i.displayColors ? h + 2 : 0),
                              e.each(o, function(t) {
                                e.each(t.before, p),
                                  e.each(t.lines, p),
                                  e.each(t.after, p);
                        ...
                        "right" === p
                          ? (u -= s.width)
                          : "center" === p && (u -= s.width / 2),
                        "top" === g
                          ? (d += m)
                          : (d -= "bottom" === g ? s.height + m : s.height / 2),
                        "center" === g
                          ? "left" === p
                            ? (u += m)
                            : "right" === p && (u -= m)
                  ...
                  drawTitle: function(t, n, a, r) {
                    ...
                    if (o.length) {
                      ...
                      var s,
                        ...
                        d = n.titleSpacing;
                      for (
                        a.fillStyle = i(n.titleFontColor, r),
                          a.font = e.fontString(
                            u,
                            n._titleFontStyle,
                            n._titleFontFamily
                  ...
                  drawBody: function(t, n, a, r) {
                    ...
                    e.each(n.beforeBody, h);
                    var c = n.displayColors;
                    (d = c ? o + 2 : 0),
                      e.each(l, function(s, l) {
                        e.each(s.before, h),
                          e.each(s.lines, function(e) {
                            c &&
                  ...
                  drawFooter: function(t, n, a, r) {
                    ...
                    o.length &&
                      ...
                      e.each(o, function(e) {
                        a.fillText(e, t.x, t.y),
                          (t.y += n.footerFontSize + n.footerSpacing);
                      }));
                  },
                  drawBackground: function(t, e, n, a, r) {
                    (n.fillStyle = i(e.backgroundColor, r)),
                      (n.strokeStyle = i(e.borderColor, r)),
                  ...
                  handleEvent: function(t) {
                    ...
                    if (
                      ...
                      "mouseout" === t.type
                        ? (this._active = [])
                        : (this._active = this._chart.getElementsAtEventForMode(
                            t,
                            i.mode,
                            i
                          )),
                      !(n = !e.arrayEquals(this._active, this._lastActive)))
                    )
                      return !1;
                    if (
                      ((this._lastActive = this._active), i.enabled || i.custom)
                    ) {
                      this._eventPosition = { x: t.x, y: t.y };
                      var a = this._model;
                      this.update(!0),
                        this.pivot(),
                        (n |= a.x !== this._model.x || a.y !== this._model.y);
                    }
                    return n;
                  }
                })),
                    ...
                    for (a = 0, r = t.length; a < r; ++a) {
                      ...
                      if (u && u.hasValue()) {
                        var d = u.getCenterPoint(),
                          h = e.distanceBetweenPoints(i, d);
                        h < l && ((l = h), (n = u));
                      }
                    }
                    if (n) {
                      var c = n.tooltipPosition();
                      (o = c.x), (s = c.y);
                    }
                    return { x: o, y: s };
                  }
                  ...
                  draw: function() {
                    ...
                    for (
                      this._loop && u.length && u.push(u[0]),
                        s.save(),
                        s.lineCap = o.borderCapStyle || d.borderCapStyle,
                        s.setLineDash &&
                          s.setLineDash(o.borderDash || d.borderDash),
                        s.lineDashOffset =
                          o.borderDashOffset || d.borderDashOffset,
                        s.lineJoin = o.borderJoinStyle || d.borderJoinStyle,
                        s.lineWidth = o.borderWidth || d.borderWidth,
                        s.strokeStyle = o.borderColor || i.defaultColor,
                        s.beginPath(),
                        h = -1,
                        t = 0;
                      t < u.length;
                        ...
                        (o.x < a.left
                          ...
                          : 1.01 * a.right < o.x
                            ...
                            : o.y < a.top
                              ? (f = (h - o.y) / (a.top - o.y))
                              : 1.01 * a.bottom < o.y &&
                                (f = (o.y - h) / (o.y - a.bottom)),
                        (f = Math.round(100 * f) / 100),
                        (s.strokeStyle = c(s.strokeStyle)
                          .alpha(f)
                          .rgbString()),
                        (s.fillStyle = c(s.fillStyle)
                          .alpha(f)
                          .rgbString())),
                      t.canvasHelpers.drawPoint(s, l, u, d, h));
                  }
                }));
            };
          },
            ...
            e.exports = function(t) {
              ...
              function r(t, i, n) {
                ...
                (s.resizer = ((r = function() {
                  s.ticking ||
                    ((s.ticking = !0),
                    e.requestAnimFrame.call(window, function() {
          ...
          function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                n = {
                  dataset: function(t) {
                    var e = t.fill,
                      ...
                      a =
                        (n && i.isDatasetVisible(e) && n.dataset._children) ||
                        [];
                    return a.length
                      ? function(t, e) {
              ...
              function a(t, e, i) {
                ...
                if (
                  ((n = parseFloat(r, 10)), isFinite(n) && Math.floor(n) === n)
                )
                  return (
                    ("-" !== r[0] && "+" !== r[0]) || (n = e + n),
                    !(n === e || n < 0 || n >= i) && n
              ...
              return {
                ...
                afterDatasetsUpdate: function(e, i) {
                  ...
                  for (l = 0; l < p; ++l)
                    (d = null),
                      (u = (s = e.getDatasetMeta(l)).dataset) &&
                        u._model &&
                    ...
                    u &&
                      ...
                      (function(t, e, i, n, a, r) {
                        var o,
                          ...
                          y = 0,
                          x = 0;
                        for (t.beginPath(), o = 0, u = g + !!r; o < u; ++o)
                          (c = i((h = e[(d = o % g)]._view), d, n)),
                            (f = s(h)),
                            (p = s(c)),
                            f && p
                              ? ((y = v.push(h)), (x = b.push(c)))
                              : y &&
                                x &&
                                (m
                                  ? (f && v.push(h), p && b.push(c))
                                  : (l(t, v, b, y, x),
                                    (y = x = 0),
                                    (v = []),
                                    (b = [])));
        ...
        42: [
          function(t, e, i) {
            ...
            e.exports = function(t) {
              ...
              function r(e, n) {
                var a = new t.Legend({ ctx: e.ctx, options: n, chart: e });
                ...
                (t.Legend = t.Element.extend({
                  ...
                  fit: function() {
                    var i = this,
                      ...
                      h = u(r.fontStyle, l.defaultFontStyle),
                      c = u(r.fontFamily, l.defaultFontFamily),
                      f = e.fontString(d, h, c),
                      p = (i.legendHitBoxes = []),
                      g = i.minSize,
                      m = i.isHorizontal();
                    if (
                      ...
                      if (((s.font = f), m)) {
                        ...
                        (s.textAlign = "left"),
                          ...
                          e.each(i.legendItems, function(t, e) {
                            var n =
                              a(r, d) + d / 2 + s.measureText(t.text).width;
                            v[v.length - 1] + n + r.padding >= i.width &&
                              ((b += d + r.padding), (v[v.length] = i.left)),
                        ...
                        e.each(i.legendItems, function(t, e) {
                          ...
                          S + C > g.height &&
                            ((w += k + r.padding), x.push(k), (k = 0), (S = 0)),
                            (k = Math.max(k, i)),
                            (S += C),
                            (p[e] = { left: 0, top: 0, width: i, height: d });
                        }),
                          (w += k),
                          x.push(k),
                          (g.width += w);
                  ...
                  draw: function() {
                    ...
                    if (n.display) {
                      var d,
                        ...
                        f = c(r.fontColor, o.defaultFontColor),
                        p = c(r.fontSize, o.defaultFontSize),
                        g = c(r.fontStyle, o.defaultFontStyle),
                        m = c(r.fontFamily, o.defaultFontFamily),
                      ...
                      e.each(i.legendItems, function(e, a) {
                        ...
                        x
                          ? C + S >= l &&
                            ((M = d.y += w),
                            d.line++,
                            (C = d.x = i.left + (l - u[d.line]) / 2))
                          : M + w > i.bottom &&
                            ((C = d.x = C + i.columnWidths[d.line] + r.padding),
                            (M = d.y = i.top + r.padding),
                            d.line++),
                          (function(e, i, a) {
                            if (!(isNaN(b) || b <= 0)) {
                              h.save(),
                                (h.fillStyle = c(a.fillStyle, o.defaultColor)),
                                (h.lineCap = c(a.lineCap, s.borderCapStyle)),
                                (h.lineDashOffset = c(
                                  a.lineDashOffset,
                                  s.borderDashOffset
                                )),
                                (h.lineJoin = c(a.lineJoin, s.borderJoinStyle)),
                                (h.lineWidth = c(a.lineWidth, s.borderWidth)),
                                (h.strokeStyle = c(
                                  a.strokeStyle,
                                  o.defaultColor
                                ));
                              var r = 0 === c(a.lineWidth, s.borderWidth);
                              if (
                                (h.setLineDash &&
                                  h.setLineDash(c(a.lineDash, s.borderDash)),
                          ...
                          (m = e),
                          (v = k),
                          h.fillText(m.text, b + p / 2 + f, g),
                          m.hidden &&
                            (h.beginPath(),
                            (h.lineWidth = 2),
                            h.moveTo(b + p / 2 + f, g + p / 2),
                            h.lineTo(b + p / 2 + f + v, g + p / 2),
                            h.stroke()),
                          x ? (d.x += S + r.padding) : (d.y += w);
                      });
                    }
                  },
                  handleEvent: function(t) {
                    ...
                    if (
                      ...
                      for (
                        ...
                        if (
                          ...
                          if ("click" === i) {
                            e.onClick.call(this, t.native, this.legendItems[s]),
                              (n = !0);
                            break;
                          }
                          if ("mousemove" === i) {
                            e.onHover.call(this, t.native, this.legendItems[s]),
                              (n = !0);
                            break;
                          }
                        }
                ...
                (t.Title = t.Element.extend({
                  ...
                  fit: function() {
                    var i = e.getValueOrDefault,
                      ...
                      a = t.defaults.global,
                      r = n.display,
                      o = i(n.fontSize, a.defaultFontSize),
                      s = this.minSize;
                    this.isHorizontal()
                      ? ((s.width = this.maxWidth),
                        (s.height = r ? o + 2 * n.padding : 0))
                      : ((s.width = r ? o + 2 * n.padding : 0),
                        (s.height = this.maxHeight)),
                      (this.width = s.width),
                  ...
                  draw: function() {
                    ...
                    if (a.display) {
                      var o,
                        s,
                        l,
                        u = n(a.fontSize, r.defaultFontSize),
                        d = n(a.fontStyle, r.defaultFontStyle),
                        h = n(a.fontFamily, r.defaultFontFamily),
                        c = e.fontString(u, d, h),
                        f = 0,
                        p = this.top,
                        g = this.left,
                        m = this.bottom,
                        v = this.right;
                      (i.fillStyle = n(a.fontColor, r.defaultFontColor)),
                        (i.font = c),
                        this.isHorizontal()
                          ? ((o = g + (v - g) / 2),
                            (s = p + (m - p) / 2),
                ...
                })),
                {
                  ...
                  beforeUpdate: function(n) {
                    ...
                    r
                      ...
                      : o &&
                        (t.layoutService.removeBox(n, o), delete n.titleBlock);
                  }
                }
              );
            };
                ...
                i = t.Scale.extend({
                  ...
                  determineDataLimits: function() {
                    ...
                    (this.minIndex = 0),
                      ...
                      void 0 !== this.options.ticks.min &&
                        ((t = e.indexOf(i, this.options.ticks.min)),
                        (this.minIndex = -1 !== t ? t : this.minIndex)),
                      void 0 !== this.options.ticks.max &&
                        ((t = e.indexOf(i, this.options.ticks.max)),
                        (this.maxIndex = -1 !== t ? t : this.maxIndex)),
                      (this.min = i[this.minIndex]),
                      (this.max = i[this.maxIndex]);
                  },
                  buildTicks: function() {
                  ...
                  getPixelForValue: function(t, e, i, n) {
                    ...
                    if (this.isHorizontal()) {
                      var l = this.width / r,
                        u = l * (e - this.minIndex);
                      return (
                        ((this.options.gridLines.offsetGridLines && n) ||
                          (this.maxIndex === this.minIndex && n)) &&
                          (u += l / 2),
                  ...
                  getValueForPixel: function(t) {
                    ...
                    return (
                      ...
                      this.options.gridLines.offsetGridLines && (t -= n / 2),
                      t <= 0 ? 0 : Math.round(t / n)
                    );
                  },
                  getBasePixel: function() {
                    return this.bottom;
              ...
              var e = t.helpers,
                ...
                n = t.LinearScaleBase.extend({
                  determineDataLimits: function() {
                      ...
                      e.each(a, function(a, r) {
                        ...
                        e.each(l, function(i) {
                          var n = i.positiveValues.concat(i.negativeValues),
                            a = e.min(n),
                            r = e.max(n);
                          (t.min = null === t.min ? a : Math.min(t.min, a)),
                    ...
                    (t.min = isFinite(t.min) ? t.min : 0),
                      (t.max = isFinite(t.max) ? t.max : 1),
                  ...
                  getPixelForValue: function(t) {
                    ...
                    return this.isHorizontal()
                      ? ((e = this.left + (this.width / a) * (n - i)),
                        Math.round(e))
                      : ((e = this.bottom - (this.height / a) * (n - i)),
                        Math.round(e));
                  },
                  getValueForPixel: function(t) {
                ...
                handleTickRangeOptions: function() {
                  ...
                  void 0 !== t.min
                    ...
                    : void 0 !== t.suggestedMin &&
                      (null === this.min
                        ? (this.min = t.suggestedMin)
                        : (this.min = Math.min(this.min, t.suggestedMin))),
                    void 0 !== t.max
                      ? (this.max = t.max)
                      : void 0 !== t.suggestedMax &&
                        (null === this.max
                          ? (this.max = t.suggestedMax)
                          : (this.max = Math.max(this.max, t.suggestedMax))),
                    this.min === this.max &&
                      (this.max++, t.beginAtZero || this.min--);
                },
                getTickLimit: i,
                handleDirectionalChanges: i,
                buildTicks: function() {
                  var i = this.options.ticks,
                    n = this.getTickLimit(),
                    a = {
                    ...
                    r = (this.ticks = t.Ticks.generators.linear(a, this));
              ...
              var e = t.helpers,
                ...
                n = t.Scale.extend({
                        ...
                        a.isDatasetVisible(r) &&
                          ...
                          e.each(n.data, function(e, n) {
                            ...
                            isNaN(r) ||
                              o.data[n].hidden ||
                              ((a[n] = a[n] || 0),
                              i.relativePoints ? (a[n] = 100) : (a[n] += r));
                          }));
                      }),
                        e.each(d, function(i) {
                          var n = e.min(i),
                    ...
                    (t.min = o(n.min, t.min)),
                      ...
                      t.min === t.max &&
                        (0 !== t.min && null !== t.min
                          ? ((t.min = Math.pow(
                              10,
                              Math.floor(e.log10(t.min)) - 1
                            )),
                            (t.max = Math.pow(
                              10,
                              Math.floor(e.log10(t.max)) + 1
                            )))
                          : ((t.min = 1), (t.max = 10)));
                  },
                  buildTicks: function() {
                    var i = this.options.ticks,
                      n = { min: i.min, max: i.max },
                      a = (this.ticks = t.Ticks.generators.logarithmic(
                        n,
                        this
                      ));
                    this.isHorizontal() || a.reverse(),
                      (this.max = e.max(a)),
                      (this.min = e.min(a)),
                      i.reverse
                        ? (a.reverse(),
                  ...
                  getPixelForValue: function(t) {
                    ...
                    return (
                      this.isHorizontal()
                        ? ((a = e.log10(this.end) - e.log10(r)),
                          0 === o
                            ? (n = this.left)
                            : ((i = this.width),
                              (n =
                                this.left +
                                (i / a) * (e.log10(o) - e.log10(r)))))
                        : ((i = this.height),
                          0 !== r || s.reverse
                            ? 0 === this.end && s.reverse
                              ? ((a =
                                  e.log10(this.start) -
                                  e.log10(this.minNotZero)),
                                (n =
                                  o === this.end
                                    ? this.top
                                    : o === this.minNotZero
                                      ...
                                      : this.top +
                                        ...
                                        ((0.98 * i) / a) *
                                          (e.log10(o) -
                                            e.log10(this.minNotZero))))
                              : 0 === o
                                ? (n = s.reverse ? this.top : this.bottom)
                                : ((a = e.log10(this.end) - e.log10(r)),
                                  (i = this.height),
                                  (n =
                                    this.bottom -
                                    (i / a) * (e.log10(o) - e.log10(r))))
                            : ((a =
                                e.log10(this.end) - e.log10(this.minNotZero)),
                              (n =
                                o === r
                                  ? this.bottom
                                  : o === this.minNotZero
                    ...
                    return (
                      this.isHorizontal()
                        ? ((n = this.width),
                          (i =
                            this.start *
                            Math.pow(10, ((t - this.left) * a) / n)))
                        : ((n = this.height),
                          (i =
                            Math.pow(10, ((this.bottom - t) * a) / n) /
                            this.start)),
                      i
                    );
                  }
        ...
        48: [
          function(t, e, i) {
            ...
            e.exports = function(t) {
              ...
              function s(t, i, n, a) {
                if (e.isArray(i))
                  for (var r = n.y, o = 1.5 * a, s = 0; s < i.length; ++s)
              ...
              var u = t.LinearScaleBase.extend({
                setDimensions: function() {
                  var t = this.options,
                    n = t.ticks;
                  (this.width = this.maxWidth),
                  ...
                  e.each(i.data.datasets, function(r, o) {
                    if (i.isDatasetVisible(o)) {
                      ...
                      e.each(r.data, function(e, i) {
                        ...
                        isNaN(r) ||
                          s.data[i].hidden ||
                          ((n = Math.min(r, n)), (a = Math.max(r, a)));
                      });
                    }
                  }),
                    (t.min = n === Number.POSITIVE_INFINITY ? 0 : n),
                    (t.max = a === Number.NEGATIVE_INFINITY ? 0 : a),
                  ...
                  this.options.pointLabels.display
                    ? (function(t) {
                        ...
                        var c,
                          ...
                          g = a(t);
                        for (i = 0; i < g; i++) {
                          (s = t.getPointPosition(i, u)),
                            (c = t.ctx),
                            (f = l.size),
                            (p = t.pointLabels[i] || ""),
                            (n = e.isArray(p)
                              ? {
                                  w: e.longestText(c, c.font, p),
                                  h: p.length * f + 1.5 * (p.length - 1) * f
                                }
                              : { w: c.measureText(p).width, h: f }),
                            (t._pointLabelSizes[i] = n);
                          var m = t.getIndexAngle(i),
                            v = e.toDegrees(m) % 360,
                            b = o(v, s.x, n.w, 0, 180),
                            y = o(v, s.y, n.h, 90, 270);
                          b.start < d.l && ((d.l = b.start), (h.l = m)),
                            b.end > d.r && ((d.r = b.end), (h.r = m)),
                            y.start < d.t && ((d.t = y.start), (h.t = m)),
                            y.end > d.b && ((d.b = y.end), (h.b = m));
                        }
                ...
                setCenterPoint: function(t, e, i, n) {
                  ...
                  (this.xCenter = Math.round((r + a) / 2 + this.left)),
                    (this.yCenter = Math.round((o + s) / 2 + this.top));
                },
                ...
                draw: function() {
                  ...
                  if (n.display) {
                    var d = t.ctx,
                      h = u(l.fontSize, i.defaultFontSize),
                      c = u(l.fontStyle, i.defaultFontStyle),
                      f = u(l.fontFamily, i.defaultFontFamily),
                      p = e.fontString(h, c, f);
                    e.each(t.ticks, function(r, s) {
                      if (s > 0 || n.reverse) {
                        ...
                        if (
                          (o.display &&
                            ...
                            (function(t, i, n, r) {
                              ...
                              if (
                                ...
                                (o.lineWidth = e.getValueAtIndexOrDefault(
                                  i.lineWidth,
                                  r - 1
                                )),
                          ...
                          var g = u(l.fontColor, i.defaultFontColor);
                          if (((d.font = p), l.showLabelBackdrop)) {
                            var m = d.measureText(r).width;
                            (d.fillStyle = l.backdropColor),
                              d.fillRect(
                                t.xCenter - m / 2 - l.backdropPaddingX,
                                f - h / 2 - l.backdropPaddingY,
                                m + 2 * l.backdropPaddingX,
                                h + 2 * l.backdropPaddingY
                              );
                          }
                          (d.textAlign = "center"),
                            (d.textBaseline = "middle"),
                            (d.fillStyle = g),
                            d.fillText(r, t.xCenter, f);
                        }
                      }
                    }),
                      (n.angleLines.display || n.pointLabels.display) &&
                        (function(t) {
                          var n = t.ctx,
                            ...
                            u = l.angleLines,
                            d = l.pointLabels;
                          (n.lineWidth = u.lineWidth),
                            (n.strokeStyle = u.color);
                          var h,
                            c,
                            f,
                            p,
                            g = t.getDistanceFromCenterForValue(
                              l.reverse ? t.min : t.max
                            ),
                            m = r(t);
                          n.textBaseline = "top";
                          for (var v = a(t) - 1; v >= 0; v--) {
                            if (u.display) {
                              var b = t.getPointPosition(v, g);
                              n.beginPath(),
                            ...
                            if (d.display) {
                              var y = t.getPointPosition(v, g + 5),
                                x = o(d.fontColor, i.defaultFontColor);
                              (n.font = m.font), (n.fillStyle = x);
                              var w = t.getIndexAngle(v),
                                k = e.toDegrees(w);
                              (n.textAlign =
                                0 === (p = k) || 180 === p
                                  ? "center"
                                  : p < 180
                                    ...
                                    : "right"),
                                (h = k),
                                (c = t._pointLabelSizes[v]),
                                (f = y),
                                90 === h || 270 === h
                                  ? (f.y -= c.h / 2)
                                  : (h > 270 || h < 90) && (f.y -= c.h),
                                s(n, t.pointLabels[v] || "", y, m.size);
                            }
                          }
                        })(t);
                  }
              ...
              (e.exports = function(t) {
                ...
                var r = t.Scale.extend({
                  ...
                  determineDataLimits: function() {
                    ...
                    e.each(s.labels, function(e, s) {
                      ...
                      e.each(s.datasets, function(s, u) {
                        ...
                        null !== s.data[0] &&
                        i.chart.isDatasetVisible(u)
                          ? e.each(s.data, function(e, s) {
                  ...
                  buildTicks: function() {
                    ...
                    if (o.min) {
                      var u = a(this, o.min);
                      o.round && u.round(o.round), (n = u.valueOf());
                    }
                    o.max && (r = a(this, o.max).valueOf());
                    var d = this.getLabelCapacity(n || s),
                      h =
                        o.unit ||
                        (function(t, e, n, a) {
                          for (
                            ...
                            var u = i[r],
                              d =
                                (u.steps && u.steps[u.steps.length - 1]) ||
                                u.maxStep;
                            if (
                              void 0 === d ||
                              Math.ceil((n - e) / (d * u.size)) <= a
                            )
                              break;
                          }
                          return r;
                        })(o.minUnit, n || s, r || l, d);
                    this.displayFormat = o.displayFormats[h];
                    var c =
                      o.stepSize ||
                      (function(t, e, n, a) {
                        var r = i[n],
                        ...
                        if (r.steps)
                          for (
                            var d = r.steps.length, h = 0;
                            h < d && s > a;
                            h++
                          )
                            (l = r.steps[h]), (s = Math.ceil(u / (o * l)));
                        else
                          for (; s > a && a > 0; )
                            ++l, (s = Math.ceil(u / (o * l)));
                        return l;
                      })(n || s, r || l, h, d);
                    (this.ticks = t.Ticks.generators.time(
                      {
                        maxTicks: d,
                        min: n,
                        max: r,
                  ...
                  convertTicksToLabels: function() {
                    (this.ticksAsTimestamps = this.ticks),
                  ...
                  getPixelForValue: function(t, e, i) {
                    ...
                    if (
                      (void 0 !== e &&
                        void 0 !== i &&
                        (n = this._parsedData.datasets[i][e]),
                      null === n &&
                        ((t && t.isValid) ||
                          (t = a(this, this.getRightValue(t))),
                  ...
                  getValueForPixel: function(t) {
                    var e = this.isHorizontal() ? this.width : this.height,
                      i =
                        (t - (this.isHorizontal() ? this.left : this.top)) / e;
                    return n(this.min + i * (this.max - this.min));
                  },
                  ...
                  getLabelCapacity: function(t) {
                    ...
                    var e = this.tickFormatFunction(n(t), 0, []),
  ...
  (function(t, e) {
    ...
    var l = {
        ...
        show: function(t, e, i) {
          ...
          (c["-webkit-transition-duration"] = f + "ms"),
            (c["-moz-transition-duration"] = f + "ms"),
            (c["-o-transition-duration"] = f + "ms"),
            (c["transition-duration"] = f + "ms"),
            n.setAttribute("style", s(c));
        },
        hide: function(t, e) {
          for (
    ...
    function c(t) {
      ...
      if (null !== e) {
        if (
          ...
          return;
        if ((h.registerEvent(t), "touchstart" === t.type && l.delay)) {
          var i = !1,
        ...
        if (
          ...
          for (
            ...
            if (
              ...
              setTimeout(c({ type: "mouseup", button: 1 }, n), e.wait);
            }
      }),
      (t.calm = function(t) {
        for (
  ...
  (function(t) {
    t(document).ready(function() {
      ...
      t(e).each(function(e, i) {
        ...
        n(a), i.validity.badInput && r.addClass("active");
      }),
        ...
        t(document).on("blur", e, function(e) {
          ...
          n && r && o && i.siblings("label, i").removeClass("active"), a(i);
        }),
