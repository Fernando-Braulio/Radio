...
!(function(t, e) {
  ...
  var o,
    ...
    (k = (function() {
      ...
      return (
        ...
        (t._jQueryInterface = function(e) {
          return this.each(function() {
            var n = m(this).data(v);
            n || ((n = new t(this)), m(this).data(v, n)),
              "toggle" === e && n[e]();
          });
        }),
        s(t, null, [
    ...
    (m.fn[p].noConflict = function() {
      return (m.fn[p] = y), k._jQueryInterface;
    }),
    k),
    j = (function(t) {
      var e = "carousel",
          ...
          return (
            ...
            (C._slide = function(e, n) {
              ...
              if (
                ...
                P.supportsTransitionEnd() && t(this._element).hasClass(m)
                  ? (t(c).addClass(s),
                    P.reflow(c),
                    t(a).addClass(i),
                    t(c).addClass(i),
    ...
    M = (function(t) {
      var e,
        ...
        I = ".dropdown-menu",
        A = ".navbar-nav",
        D = ".dropdown-menu .dropdown-item:not(.disabled)",
        b = (((e = {})[u ? "TOPEND" : "TOP"] = "top-start"),
        (e[u ? "TOP" : "TOPEND"] = "top-end"),
        (e[u ? "BOTTOMEND" : "BOTTOM"] = "bottom-start"),
        (e[u ? "BOTTOM" : "BOTTOMEND"] = "bottom-end"),
        (e[u ? "LEFT" : "RIGHT"] = "right-start"),
        (e[u ? "LEFTEND" : "RIGHTEND"] = "right-end"),
        (e[u ? "RIGHT" : "LEFT"] = "left-start"),
        (e[u ? "RIGHTEND" : "LEFTEND"] = "left-end"),
        e),
          ...
          return (
              ...
              if (!this._element.disabled && !t(this._element).hasClass(d)) {
                ...
                if ((e._clearMenus(), !s)) {
                  ...
                  if ((t(i).trigger(o), !o.isDefaultPrevented())) {
                    ...
                    "ontouchstart" in document.documentElement &&
                      0 === t(i).closest(A).length &&
                      t("body")
                        .children()
                        .on("mouseover", null, t.noop),
                      this._element.focus(),
                      this._element.setAttribute("aria-expanded", !0),
                      t(this._menu).toggleClass(_),
                      t(i)
                        .toggleClass(_)
                        .trigger(t.Event(f.SHOWN, r));
                  }
                }
              }
            }),
            ...
            (l._getConfig = function(e) {
              return (
                ...
                P.typeCheckConfig(i, e, this.constructor.DefaultType),
                e
              );
            }),
            ...
            (l._getPlacement = function() {
              ...
              return (
                e.hasClass(g)
                  ? ((n = b.TOP), t(this._menu).hasClass(v) && (n = b.TOPEND))
                  : e.hasClass(m)
                    ? (n = b.RIGHT)
                    : e.hasClass(p)
                      ? (n = b.LEFT)
                      : t(this._menu).hasClass(v) && (n = b.BOTTOMEND),
                n
              );
            }),
      ...
      return (
        t(document)
          ...
          .on(f.CLICK_DATA_API, C, function(t) {
            t.stopPropagation();
          }),
        (t.fn[i] = N._jQueryInterface),
        (t.fn[i].Constructor = N),
        (t.fn[i].noConflict = function() {
          return (t.fn[i] = h), N._jQueryInterface;
        }),
        N
      );
    })(e),
    W = (function(t) {
      ...
      return (
        ...
        (t.fn.modal.noConflict = function() {
          return (t.fn.modal = o), m._jQueryInterface;
        }),
        m
      );
    })(e),
    U = (function(t) {
      var e,
        ...
        f = (((e = { AUTO: "auto", TOP: "top" })[c ? "LEFT" : "RIGHT"] =
          "right"),
        (e.BOTTOM = "bottom"),
        (e[c ? "RIGHT" : "LEFT"] = "left"),
        e),
        ...
        D = (function() {
          ...
          return (
            ...
            (l.show = function() {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                o.setAttribute("id", a),
                  ...
                  this.setContent(),
                  this.config.animation && t(o).addClass(p);
                var l =
                  ...
                  (this._popper = new n(this.element, o, {
                    ...
                    onCreate: function(t) {
                      t.originalPlacement !== t.placement &&
                        i._handlePopperPlacementChange(t);
                    },
                    onUpdate: function(t) {
                      i._handlePopperPlacementChange(t);
                    }
                ...
                P.supportsTransitionEnd() && t(this.tip).hasClass(p)
                  ? t(this.tip)
                      .one(P.TRANSITION_END, u)
                      .emulateTransitionEnd(e._TRANSITION_DURATION)
                  : u();
              }
            }),
            (l.hide = function(e) {
            ...
            (l.addAttachmentClass = function(e) {
            ...
            (l.setContent = function() {
              ...
              this.setElementContent(e.find(E), this.getTitle()),
                e.removeClass(p + " " + v);
            }),
            (l.setElementContent = function(e, n) {
            ...
            (l._enter = function(e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                e && (n._activeTrigger["focusin" === e.type ? C : y] = !0),
                t(n.getTipElement()).hasClass(v) || n._hoverState === _
                  ? (n._hoverState = _)
            ...
            (l._leave = function(e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                t(e.currentTarget).data(i, n)),
                e && (n._activeTrigger["focusout" === e.type ? C : y] = !1),
                n._isWithActiveTrigger() ||
                  (clearTimeout(n._timeout),
                  (n._hoverState = g),
                  n.config.delay && n.config.delay.hide
                    ? (n._timeout = setTimeout(function() {
                        n._hoverState === g && n.hide();
                      }, n.config.delay.hide))
                    : n.hide());
            }),
            ...
            (l._handlePopperPlacementChange = function(t) {
              this._cleanTipClass(),
            ...
            (e._jQueryInterface = function(n) {
              return this.each(function() {
                ...
                if (
                  ...
                  (i || ((i = new e(this, s)), t(this).data(o, i)),
                  "string" == typeof n)
                ) {
                  if ("undefined" == typeof i[n])
                    throw new TypeError('No method named "' + n + '"');
      ...
      return (
        (t.fn[i] = D._jQueryInterface),
        (t.fn[i].Constructor = D),
        (t.fn[i].noConflict = function() {
          return (t.fn[i] = l), D._jQueryInterface;
        }),
        D
      );
    })(e),
    x = (function(t) {
      var e = "popover",
        ...
        g = (function(r) {
          ...
          (g = r),
            ((o = m).prototype = Object.create(g.prototype)),
            ...
            (m._jQueryInterface = function(e) {
              return this.each(function() {
                ...
                if (
                  ...
                  (i || ((i = new m(this, s)), t(this).data(n, i)),
                  "string" == typeof e)
                ) {
