...
function setDefaults(cli, configFileFlags) {
  ...
  compositeFlags.stripPrefix =
    compositeFlags.stripPrefix ||
    configFileFlags.stripPrefix ||
    compositeFlags.root;

  compositeFlags.stripPrefixMulti =
    compositeFlags.stripPrefixMulti || configFileFlags.stripPrefixMulti || {};

  compositeFlags.swFile =
    compositeFlags.swFile || configFileFlags.swFile || "service-worker.js";
  compositeFlags.swFilePath =
    compositeFlags.swFilePath ||
    configFileFlags.swFilePath ||
    path.join(compositeFlags.root, compositeFlags.swFile);

  compositeFlags.cacheId =
    compositeFlags.cacheId || configFileFlags.cacheId || cli.pkg.name;

  compositeFlags.dynamicUrlToDependencies =
    compositeFlags.dynamicUrlToDependencies ||
    configFileFlags.dynamicUrlToDependencies;

  compositeFlags.directoryIndex =
    compositeFlags.directoryIndex || configFileFlags.directoryIndex;

  compositeFlags.navigateFallback =
    compositeFlags.navigateFallback || configFileFlags.navigateFallback;

  compositeFlags.navigateFallbackWhitelist =
    compositeFlags.navigateFallbackWhitelist ||
    configFileFlags.navigateFallbackWhitelist;

  compositeFlags.staticFileGlobs =
    compositeFlags.staticFileGlobs || configFileFlags.staticFileGlobs;
  ...
  if (
    ...
    compositeFlags.ignoreUrlParametersMatching = compositeFlags.ignoreUrlParametersMatching
      .split(",")
      .map(function(s) {
        return new RegExp(s);
      });
  ...
  compositeFlags.importScripts =
    compositeFlags.importScripts || configFileFlags.importScripts;
  if (
    compositeFlags.importScripts &&
  ...
  compositeFlags.runtimeCaching =
    compositeFlags.runtimeCaching || configFileFlags.runtimeCaching;

  compositeFlags.templateFilePath =
    compositeFlags.templateFilePath || configFileFlags.templateFilePath;
...
var cli = meow({
  help:
    "Options from https://github.com/GoogleChrome/sw-precache#options " +
