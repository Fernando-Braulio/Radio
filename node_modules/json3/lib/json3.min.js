  ...
  function O(u, v) {
    ...
    function q(a) {
      ...
      if ("bug-string-char-index" == a) var d = !1;
        ...
        d = q("json-stringify") && q("date-serialization") && q("json-parse");
      else if ("date-serialization" == a) {
        if ((d = q("json-stringify") && y)) {
          var c = v.stringify;
          B(function() {
            d =
              '"-271821-04-20T00:00:00.000Z"' == c(new z(-864e13)) &&
              '"+275760-09-13T00:00:00.000Z"' == c(new z(864e13)) &&
              '"-000001-01-01T00:00:00.000Z"' == c(new z(-621987552e5)) &&
              '"1969-12-31T23:59:59.999Z"' == c(new z(-1));
          });
        }
      } else {
        var e;
    ...
    "object" == typeof u &&
      u &&
      ((v.stringify = u.stringify), (v.parse = u.parse));
    I = I.prototype;
    var w = I.toString,
      J = I.hasOwnProperty,
      x,
      y = new z(-0xc782b5b800cec);
    B(function() {
      y =
    ...
    q["bug-string-char-index"] = q["date-serialization"] = q.json = q[
      "json-stringify"
    ] = q["json-parse"] = null;
    if (!q("json")) {
      var P = q("bug-string-char-index"),
        G = function(a, d) {
          ...
          c
            ...
            : ((l = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(
                " "
              )),
              (G = function(b, h) {
                var p = "[object Function]" == w.call(b),
                  ...
                  n =
                    (!p &&
                      "function" != typeof b.constructor &&
                      H[typeof b.hasOwnProperty] &&
                      b.hasOwnProperty) ||
                    J;
          ...
          var ka = function(a) {
            ...
            R = function(a, d, c, e, g, l, b) {
              ...
              "object" == typeof h &&
                h &&
                (h.getUTCFullYear &&
                "[object Date]" == w.call(h) &&
                h.toJSON === z.prototype.toJSON
                  ? (h = L(h))
                  : "function" == typeof h.toJSON && (h = h.toJSON(a)));
              c && (h = c.call(d, a, h));
              ...
              if ("object" == typeof h) {
                ...
                if ("[object Array]" == p) {
                  ...
                  for (k = h.length; D < k; D++)
                    (p = R(D, h, c, e, g, l, b)), n.push(p === x ? "null" : p);
                  k = n.length
                    ? g
                      ? "[\n" + l + n.join(",\n" + l) + "\n" + K + "]"
                      : "[" + n.join(",") + "]"
              ...
              if ("[object Function]" == g) var l = d;
                ...
                for (var h = 0, p = d.length, k; h < p; )
                  if (
                    ((k = d[h++]),
                    (g = w.call(k)),
                    "[object String]" == g || "[object Number]" == g)
                  )
                    b[k] = 1;
              }
            }
      ...
      if (!q("json-parse")) {
        var la = U.fromCharCode,
          ...
          E = function() {
            for (var a = M, d = a.length, c, e, g, l, b; f < d; )
              switch (((b = a.charCodeAt(f)), b)) {
                case 9:
                case 10:
                case 13:
                case 32:
                ...
                default:
                  ...
                  if (48 <= b && 57 >= b) {
                    for (
                      48 == b &&
                      ((b = a.charCodeAt(f + 1)), 48 <= b && 57 >= b) &&
                      t();
                      f < d && ((b = a.charCodeAt(f)), 48 <= b && 57 >= b);
                      f++
                    );
                    if (46 == a.charCodeAt(f)) {
                      for (
                        g = ++f;
                        g < d && !((b = a.charCodeAt(g)), 48 > b || 57 < b);
                        g++
                      );
                      g == f && t();
                      f = g;
        ...
        v.parse = function(a, d) {
          ...
          "$" != E() && t();
          f = M = null;
          return d && "[object Function]" == w.call(d)
            ? W(((c = {}), (c[""] = a), c), "", d)
            : a;
        };
      }
