    ...
    test: function(testName, expected, callback, async) {
      ...
      synchronize(function() {
        ...
        try {
          ...
          fail(
            "Test " + name + " died, exception and test follows",
            e,
            callback
          );
          QUnit.ok(
      ...
      synchronize(function() {
        ...
        if (tests) {
          ...
          for (var i = 0; i < config.assertions.length; i++) {
            ...
            li.appendChild(
              document.createTextNode(assertion.message || "(no message)")
            );
            ol.appendChild(li);
          ...
          b.innerHTML =
            name +
            " <b style='color:black;'>(<b class='fail'>" +
            bad +
            "</b>, <b class='pass'>" +
            good +
            "</b>, " +
    ...
    var jsDump = {
      ...
      typeOf: function(obj) {
        ...
        if (obj === null) {
          ...
          QUnit.is("HTMLCollection", obj) ||
          QUnit.is("NodeList", obj)
        ) {
          type = "nodelist";
