...
function _testIt(keys, message, t) {
  ...
  t.test(message.toString(), function(t) {
    ...
    t.equals(
      myCrypto.privateDecrypt(priv, nodeEnc).toString("hex"),
      message.toString("hex"),
      "my decrypter node's message"
    );
    t.equals(
      nodeCrypto.privateDecrypt(priv, myEnc).toString("hex"),
      message.toString("hex"),
      "node decrypter my message"
    );
    t.equals(
      nodeCrypto.privateDecrypt(priv, nodeEnc).toString("hex"),
      message.toString("hex"),
      "node decrypter node's message"
    );
    ...
    t.equals(
      myCrypto.publicDecrypt(pub, nodeEnc).toString("hex"),
      message.toString("hex"),
      "reverse methods my decrypter node's message"
    );
    t.equals(
      nodeCrypto.publicDecrypt(pub, myEnc).toString("hex"),
      message.toString("hex"),
      "reverse methods node decrypter my message"
    );
    t.equals(
      nodeCrypto.publicDecrypt(pub, nodeEnc).toString("hex"),
      message.toString("hex"),
      "reverse methods node decrypter node's message"
    );
  });
}
