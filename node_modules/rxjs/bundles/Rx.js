...
***************************************************************************** */
  ...
  var rxSubscriber =
    typeof Symbol$2 === "function" && typeof Symbol$2.for === "function"
      ? Symbol$2.for("rxSubscriber")
      : "@@rxSubscriber";
  /**
  ...
  function isTrustedSubscriber(obj) {
    return (
      ...
      ("syncErrorThrowable" in obj && obj[rxSubscriber])
    );
  }
  ...
  var Observable = (function() {
    ...
    /** @deprecated internal use only */ Observable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var Subject = (function(_super) {
    ...
    /** @deprecated internal use only */ Subject.prototype._subscribe = function(
      subscriber
    ) {
      if (this.closed) {
        throw new ObjectUnsubscribedError();
  ...
  var AnonymousSubject = (function(_super) {
    ...
    /** @deprecated internal use only */ AnonymousSubject.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var AsyncSubject = (function(_super) {
    ...
    /** @deprecated internal use only */ AsyncSubject.prototype._subscribe = function(
      subscriber
    ) {
      if (this.hasError) {
        subscriber.error(this.thrownError);
  ...
  var BoundCallbackObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ BoundCallbackObservable.prototype._subscribe = function(
      subscriber
    ) {
      ...
      if (!scheduler) {
        if (!subject) {
          ...
          handler.source = this;
          var result = tryCatch(callbackFunc).apply(
            this.context,
            args.concat(handler)
          );
  ...
  var BoundNodeCallbackObservable = (function(_super) {
    ...
    BoundNodeCallbackObservable.create = function(func, selector, scheduler) {
      ...
      return function() {
        ...
        return new BoundNodeCallbackObservable(
          func,
          selector,
          args,
          this,
    ...
    /** @deprecated internal use only */ BoundNodeCallbackObservable.prototype._subscribe = function(
      subscriber
    ) {
      var callbackFunc = this.callbackFunc;
      var args = this.args;
  ...
  function dispatch(state) {
    ...
    if (!subject) {
      ...
      var handler = function handlerFn() {
        ...
        if (err) {
          self.add(
            scheduler.schedule(dispatchError$1, 0, {
              err: err,
              subject: subject
            })
          );
  ...
  var ScalarObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ ScalarObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var EmptyObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ EmptyObservable.prototype._subscribe = function(
      subscriber
    ) {
      var scheduler = this.scheduler;
      if (scheduler) {
  ...
  var ArrayObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ ArrayObservable.prototype._subscribe = function(
      subscriber
    ) {
      var index = 0;
  ...
  function subscribeToResult(outerSubscriber, result, outerValue, outerIndex) {
    var destination = new InnerSubscriber(
      outerSubscriber,
      outerValue,
      outerIndex
    );
  ...
  function combineLatest$1() {
    ...
    return function(source) {
      return source.lift.call(
        new ArrayObservable([source].concat(observables)),
  ...
  var CombineLatestOperator = (function() {
    ...
    CombineLatestOperator.prototype.call = function(subscriber, source) {
      return source.subscribe(
        new CombineLatestSubscriber(subscriber, this.project)
      );
    };
  ...
  var PromiseObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ PromiseObservable.prototype._subscribe = function(
      subscriber
    ) {
      var _this = this;
          ...
          promise
            .then(
              function(value) {
                ...
                if (!subscriber.closed) {
                  subscriber.add(
                    scheduler.schedule(dispatchNext$2, 0, {
                      value: value,
                      subscriber: subscriber
                    })
                  );
              ...
              function(err) {
                if (!subscriber.closed) {
                  subscriber.add(
                    scheduler.schedule(dispatchError$2, 0, {
                      err: err,
                      subscriber: subscriber
                    })
                  );
  ...
  var IteratorObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ IteratorObservable.prototype._subscribe = function(
      subscriber
    ) {
      var index = 0;
      var _a = this,
  ...
  var ArrayLikeObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ ArrayLikeObservable.prototype._subscribe = function(
      subscriber
    ) {
      var index = 0;
      var _a = this,
  ...
  var FromObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ FromObservable.prototype._subscribe = function(
      subscriber
    ) {
      var ish = this.ish;
      var scheduler = this.scheduler;
      if (scheduler == null) {
        ...
        return ish[observable]().subscribe(
          new ObserveOnSubscriber(subscriber, scheduler, 0)
        );
      }
    };
  ...
  function concat() {
    ...
    if (
      ...
      (observables.length === 2 && isScheduler(observables[1]))
    ) {
  ...
  var DeferObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ DeferObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var ForkJoinObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ ForkJoinObservable.prototype._subscribe = function(
      subscriber
    ) {
      return new ForkJoinSubscriber(
        subscriber,
        this.sources,
        this.resultSelector
      );
    ...
    ForkJoinSubscriber.prototype.notifyComplete = function(innerSub) {
      ...
      if (haveValues === len) {
        var value = resultSelector
          ? resultSelector.apply(this, values)
          : values;
        destination.next(value);
      }
      destination.complete();
  ...
  var FromEventObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ FromEventObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var FromEventPatternObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ FromEventPatternObservable.prototype._subscribe = function(
      subscriber
    ) {
      var _this = this;
  ...
  var GenerateObservable = (function(_super) {
    ...
    GenerateObservable.create = function(
      ...
      if (arguments.length == 1) {
        return new GenerateObservable(
          initialStateOrOptions.initialState,
          initialStateOrOptions.condition,
          initialStateOrOptions.iterate,
          initialStateOrOptions.resultSelector || selfSelector,
          initialStateOrOptions.scheduler
        );
      }
      if (
    ...
    /** @deprecated internal use only */ GenerateObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var IfObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ IfObservable.prototype._subscribe = function(
      subscriber
    ) {
      var _a = this,
        condition = _a.condition,
  ...
  var IntervalObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ IntervalObservable.prototype._subscribe = function(
      subscriber
    ) {
      var index = 0;
  ...
  var NeverObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ NeverObservable.prototype._subscribe = function(
      subscriber
    ) {
      noop();
    };
 ...
 */
  ...
  function onErrorResumeNextStatic() {
    ...
    return new FromObservable(source, null).lift(
  ...
  var PairsObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ PairsObservable.prototype._subscribe = function(
      subscriber
    ) {
      var _a = this,
        keys = _a.keys,
  ...
  var RangeObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ RangeObservable.prototype._subscribe = function(
      subscriber
    ) {
      var index = 0;
  ...
  var UsingObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ UsingObservable.prototype._subscribe = function(
      subscriber
    ) {
      var _a = this,
  ...
  var ErrorObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ ErrorObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var TimerObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ TimerObservable.prototype._subscribe = function(
      subscriber
    ) {
      var index = 0;
      var _a = this,
  ...
  function zip$1() {
    ...
    return function zipOperatorFunction(source) {
      return source.lift.call(
        zipStatic.apply(void 0, [source].concat(observables))
      );
    };
  }
  /* tslint:enable:max-line-length */
  ...
  var AjaxObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ AjaxObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var AjaxSubscriber = (function(_super) {
    ...
    function AjaxSubscriber(destination, request) {
      ...
      if (
        ...
        !(_root.FormData && request.body instanceof _root.FormData) &&
      ...
      request.body = this.serializeBody(
        request.body,
    ...
    AjaxSubscriber.prototype.send = function() {
      ...
      if (xhr === errorObject) {
        ...
        result = body
          ? tryCatch(xhr.send).call(xhr, body)
          : tryCatch(xhr.send).call(xhr);
        if (result === errorObject) {
          this.error(errorObject.e);
          return null;
        }
      ...
      function xhrReadyStateChange(e) {
        ...
        if (this.readyState === 4) {
          ...
          if (200 <= status_1 && status_1 < 300) {
            ...
            subscriber.error(
              new AjaxError("ajax error " + status_1, this, request)
            );
          }
        }
      }
  ...
  var ReplaySubject = (function(_super) {
    ...
    /** @deprecated internal use only */ ReplaySubject.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var WebSocketSubject = (function(_super) {
    ...
    /** @deprecated internal use only */ WebSocketSubject.prototype._subscribe = function(
      subscriber
    ) {
      var _this = this;
      var source = this.source;
  ...
  var SubscriptionDelayObservable = (function(_super) {
    ...
    function SubscriptionDelayObservable(
      /** @deprecated internal use only */ source,
      subscriptionDelay
    ) {
      _super.call(this);
      this.source = source;
    ...
    /** @deprecated internal use only */ SubscriptionDelayObservable.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var SwitchFirstMapSubscriber = (function(_super) {
    ...
    SwitchFirstMapSubscriber.prototype.notifyNext = function(
      outerValue,
      innerValue,
      outerIndex,
      innerIndex,
    ...
    SwitchFirstMapSubscriber.prototype.trySelectResult = function(
      outerValue,
      innerValue,
      outerIndex,
      innerIndex
  ...
  var ElementAtOperator = (function() {
    ...
    ElementAtOperator.prototype.call = function(subscriber, source) {
      return source.subscribe(
        new ElementAtSubscriber(subscriber, this.index, this.defaultValue)
      );
    };
  ...
  var GroupBySubscriber = (function(_super) {
    ...
    GroupBySubscriber.prototype._group = function(value, key) {
      ...
      if (!groups) {
        groups = this.groups =
          typeof key === "string" ? new FastMap() : new Map();
      }
  ...
  var GroupedObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ GroupedObservable.prototype._subscribe = function(
      subscriber
    ) {
      var subscription = new Subscription();
      var _a = this,
  ...
  function mergeMapTo$1(innerObservable, resultSelector, concurrent) {
    ...
    return function(source) {
      return source.lift(
        new MergeMapToOperator(innerObservable, resultSelector, concurrent)
      );
    };
  }
  ...
  var ConnectableObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ ConnectableObservable.prototype._subscribe = function(
      subscriber
    ) {
 ...
 */
  ...
  var BehaviorSubject = (function(_super) {
    ...
    /** @deprecated internal use only */ BehaviorSubject.prototype._subscribe = function(
      subscriber
    ) {
  ...
  var SequenceEqualOperator = (function() {
    ...
    SequenceEqualOperator.prototype.call = function(subscriber, source) {
      return source.subscribe(
        new SequenceEqualSubscriber(subscriber, this.compareTo, this.comparor)
      );
    };
  ...
  function shareReplay$1(bufferSize, windowTime, scheduler) {
    return function(source) {
      return source.lift(
        shareReplayOperator(bufferSize, windowTime, scheduler)
      );
    };
  }
 ...
 */
  ...
  var SkipUntilOperator = (function() {
    ...
    SkipUntilOperator.prototype.call = function(subscriber, source) {
      return source.subscribe(
        new SkipUntilSubscriber(subscriber, this.notifier)
      );
    };
...
*/
  ...
  var SubscribeOnObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ SubscribeOnObservable.prototype._subscribe = function(
      subscriber
    ) {
 ...
 */
  ...
  var SwitchMapOperator = (function() {
    ...
    SwitchMapOperator.prototype.call = function(subscriber, source) {
      return source.subscribe(
        new SwitchMapSubscriber(subscriber, this.project, this.resultSelector)
      );
    };
  ...
  var SwitchMapSubscriber = (function(_super) {
    ...
    SwitchMapSubscriber.prototype._innerSub = function(result, value, index) {
      ...
      this.add(
        (this.innerSubscription = subscribeToResult(this, result, value, index))
      );
    };
  ...
  function switchMapTo$1(innerObservable, resultSelector) {
    return function(source) {
      return source.lift(
        new SwitchMapToOperator(innerObservable, resultSelector)
      );
    };
  }
  ...
  var TakeWhileOperator = (function() {
    ...
    TakeWhileOperator.prototype.call = function(subscriber, source) {
      return source.subscribe(
        new TakeWhileSubscriber(subscriber, this.predicate)
      );
    };
  ...
  var TimeIntervalOperator = (function() {
    ...
    TimeIntervalOperator.prototype.call = function(observer, source) {
      return source.subscribe(
        new TimeIntervalSubscriber(observer, this.scheduler)
      );
    };
  ...
  var HotObservable = (function(_super) {
    ...
    /** @deprecated internal use only */ HotObservable.prototype._subscribe = function(
      subscriber
    ) {
      var subject = this;
  ...
  var TestScheduler = (function(_super) {
    ...
    TestScheduler.prototype.expectObservable = function(
      ...
      var unsubscriptionFrame = TestScheduler.parseMarblesAsSubscriptions(
        unsubscriptionMarbles
      ).unsubscribedFrame;
      var subscription;
  ...
  var RequestAnimationFrameDefinition = (function() {
    function RequestAnimationFrameDefinition(root$$1) {
      if (root$$1.requestAnimationFrame) {
        ...
        this.requestAnimationFrame = root$$1.requestAnimationFrame.bind(
          root$$1
        );
      } else if (root$$1.mozRequestAnimationFrame) {
        this.cancelAnimationFrame = root$$1.mozCancelAnimationFrame.bind(
          root$$1
        );
        this.requestAnimationFrame = root$$1.mozRequestAnimationFrame.bind(
          root$$1
        );
      } else if (root$$1.webkitRequestAnimationFrame) {
        this.cancelAnimationFrame = root$$1.webkitCancelAnimationFrame.bind(
          root$$1
        );
        this.requestAnimationFrame = root$$1.webkitRequestAnimationFrame.bind(
          root$$1
        );
      } else if (root$$1.msRequestAnimationFrame) {
        this.cancelAnimationFrame = root$$1.msCancelAnimationFrame.bind(
          root$$1
        );
        this.requestAnimationFrame = root$$1.msRequestAnimationFrame.bind(
          root$$1
        );
      } else if (root$$1.oRequestAnimationFrame) {
        this.cancelAnimationFrame = root$$1.oCancelAnimationFrame.bind(root$$1);
        this.requestAnimationFrame = root$$1.oRequestAnimationFrame.bind(
          root$$1
        );
      } else {
  ...
  var AnimationFrameAction = (function(_super) {
    ...
    AnimationFrameAction.prototype.requestAsyncId = function(
      ...
      return (
        scheduler.scheduled ||
        (scheduler.scheduled = AnimationFrame.requestAnimationFrame(
          scheduler.flush.bind(scheduler, null)
        ))
      );
    };
