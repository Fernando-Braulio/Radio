...
NodeFsHandler.prototype._watchWithNodeFs = function(path, listener) {
  ...
  if (this.options.usePolling) {
    options.interval =
      this.enableBinaryInterval && isBinaryPath(basename)
...
// Returns close function for the watcher instance
NodeFsHandler.prototype._handleFile = function(
  file,
  stats,
  initialAdd,
  callback
  ...
  var closer = this._watchWithNodeFs(
    file,
    function(path, newStats) {
      if (!this._throttle("watch", file, 5)) return;
      if (!newStats || (newStats && newStats.mtime.getTime() === 0)) {
        fs.stat(
          file,
          function(error, newStats) {
...
NodeFsHandler.prototype._handleSymlink = function(
  entry,
  directory,
  path,
  item
...
// Returns close function for the watcher instance
NodeFsHandler.prototype._handleDir = function(
  dir,
  stats,
  initialAdd,
  depth,
      ...
      .on(
        ...
        function(entry) {
          ...
          if (
            ...
            this._handleSymlink(entry, directory, path, item)
          )
            return;
...
// Returns nothing
NodeFsHandler.prototype._addToNodeFs = function(
  path,
  initialAdd,
  priorWh,
  depth,
