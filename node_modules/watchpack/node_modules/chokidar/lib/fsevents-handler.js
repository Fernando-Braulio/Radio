...
function canUse() {
  return (
    fsevents &&
    Object.keys(FSEventsWatchers).length < 128 &&
    isConstructor(fsevents)
  );
}
...
// Returns nothing
FsEventsHandler.prototype._handleFsEventsSymlink = function(
  linkPath,
  fullPath,
  transform,
  curDepth
...
// Returns nothing
FsEventsHandler.prototype._addToFsEvents = function(
  path,
  transform,
  forceAdd,
  priorDepth
            ...
            function(entry) {
              ...
              if (wh.followSymlinks && entry.stat.isSymbolicLink()) {
                ...
                var curDepth =
                  this.options.depth === undefined
                    ? undefined
                    : depth(joinedPath, sysPath.resolve(wh.watchPath)) + 1;
