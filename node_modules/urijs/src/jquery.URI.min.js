...
(function(d, e) {
  "object" === typeof module && module.exports
    ? (module.exports = e(require("jquery"), require("./URI")))
  ...
  function l(a, b) {
    if (!k(a) || !b) return !1;
    var c = b.match(p);
    if (!c || (!c[5] && ":" !== c[2] && !g[c[2]])) return !1;
    var e = d(a).uri();
    if (c[5]) return e.is(c[5]);
    if (":" === c[2]) {
      var f = c[1].toLowerCase() + ":";
      return g[f] ? g[f](e, c[4]) : !1;
    }
    f = c[1].toLowerCase();
    return m[f] ? g[c[2]](e[f](), c[4], f) : !1;
  }
  var m = {},
    g = {
      "=": function(a, b) {
      ...
      "^=": function(a, b) {
        return !!(a + "").match(new RegExp("^" + h(b), "i"));
      },
      "$=": function(a, b) {
        return !!(a + "").match(new RegExp(h(b) + "$", "i"));
      },
  ...
  d.each(["src", "href", "action", "uri", "cite"], function(a, b) {
    d.attrHooks[b] = { set: q };
  });
  d.attrHooks.uri.get = function(a) {
    return d(a).uri();
  };
  d.fn.uri = function(a) {
    var b = this.first(),
    ...
    if (void 0 !== a) {
      var f = b.data("uri");
      if (f) return f.href(a);
      a instanceof e || (a = e(a || ""));
    } else {
      if ((a = b.data("uri"))) return a;
      a = e(b.attr(d) || "");
    }
    a._dom_element = c;
    a._dom_attribute = d;
  ...
  e.prototype.build = function(a) {
    ...
    else if (!0 === a) this._deferred_build = !0;
    else if (void 0 === a || this._deferred_build)
      (this._string = e.build(this._parts)), (this._deferred_build = !1);
    return this;
  };
  var p = /^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/;
  var r = d.expr.createPseudo
    ? d.expr.createPseudo(function(a) {
        return function(b) {
          return l(b, a);
        };
      })
