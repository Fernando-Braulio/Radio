...
(function(root, factory) {
  ...
  var validate = (exports._validate = function(
    ...
    function getType(schema) {
      return (
        schema.type ||
        (primitiveConstructors[schema.name] == schema &&
      ...
      if (
        ...
        if (typeof schema == "function") {
          if (!(value instanceof schema)) {
            addError(
              "is not an instance of the class/constructor " + schema.name
            );
          }
        } else if (schema) {
      ...
      if (value === undefined) {
        ...
        if (value !== null) {
          ...
          if (schema["enum"]) {
            ...
            if (!found) {
              addError(
                "does not have a value in the enumeration " + enumer.join(", ")
              );
            }
          }
          if (
            ...
            value
              .toString()
              .match(new RegExp("\\.[0-9]{" + (schema.maxDecimal + 1) + ",}"))
          ) {
            addError(
              "may only have " + schema.maxDecimal + " digits of decimal places"
            );
          }
        }
      }
    ...
    function checkObj(instance, objTypeDef, path, additionalProp) {
      ...
      for (i in instance) {
        ...
        if (
          additionalProp &&
          (!(objTypeDef && typeof objTypeDef == "object") || !(i in objTypeDef))
        ) {
          if (options.coerce) {
