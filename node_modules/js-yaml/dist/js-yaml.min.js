  ...
  })(
    {
      ...
      3: [
        function(e, t, n) {
          ...
          function o(e) {
            (this.schema = e.schema || M),
              (this.indent = Math.max(1, e.indent || 2)),
              (this.skipInvalid = e.skipInvalid || !1),
              (this.flowLevel = F.isNothing(e.flowLevel) ? -1 : e.flowLevel),
          ...
          function a(e, t) {
            for (
              var n, i = F.repeat(" ", t), r = 0, o = -1, a = "", s = e.length;
              r < s;
          ...
          function d(e, t, n, i, r) {
            ...
            if (t)
              ...
              for (o = 0; o < e.length; o++) {
                if (((a = e.charCodeAt(o)), a === U))
                  (s = !0),
                    d &&
                      ((c = c || (o - h - 1 > i && " " !== e[h + 1])), (h = o));
            ...
            for (r = 0, o = d.length; r < o; r += 1)
              (l = ""),
                ...
                j(e, t + 1, a, !0, !0, !0) &&
                  ...
                  u && (l += e.dump && U === e.dump.charCodeAt(0) ? "?" : "? "),
                  (l += e.dump),
                  u && (l += s(e, t)),
                  j(e, t + 1, c, !0, u) &&
                    ((l += e.dump && U === e.dump.charCodeAt(0) ? ":" : ": "),
                    (l += e.dump),
                    (p += l)));
            (e.tag = f), (e.dump = p || "{}");
          }
          function k(e, t, n) {
            var i, r, o, a, s, c;
            for (
              r = n ? e.explicitTypes : e.implicitTypes, o = 0, a = r.length;
              o < a;
              o += 1
            )
              if (
                ...
                if (((e.tag = n ? s.tag : "?"), s.represent)) {
                  if (
                    ...
                    "[object Function]" === T.call(s.represent))
                  )
                    i = s.represent(t, c);
                  else {
                    if (!L.call(s.represent, c))
                      throw new N(
                        "!<" +
                          s.tag +
          ...
          function j(e, t, n, i, r, o) {
            ...
            if (
              (u && ((s = e.duplicates.indexOf(n)), (c = s !== -1)),
              ((null !== e.tag && "?" !== e.tag) ||
                c ||
                (2 !== e.indent && t > 0)) &&
                (r = !1),
              ...
              if (
                ...
                i && 0 !== Object.keys(e.dump).length
                  ? (C(e, t, e.dump, r), c && (e.dump = "&ref_" + s + e.dump))
                  : (w(e, t, e.dump),
                    c && (e.dump = "&ref_" + s + " " + e.dump));
              else if ("[object Array]" === a)
                i && 0 !== e.dump.length
                  ? (b(e, t, e.dump, r), c && (e.dump = "&ref_" + s + e.dump))
                  : (A(e, t, e.dump),
                    c && (e.dump = "&ref_" + s + " " + e.dump));
              else {
                if ("[object String]" !== a) {
          ...
          function I(e, t) {
            var n,
              ...
              r = [],
              o = [];
            for (S(e, r, o), n = 0, i = o.length; n < i; n += 1)
        ...
        function(e, t, n) {
          ...
          function A(e, t, n) {
            for (var o = 0, a = e.input.charCodeAt(e.position); 0 !== a; ) {
              ...
              if (!i(a)) break;
              for (
                v(e), a = e.input.charCodeAt(e.position), o++, e.lineIndent = 0;
                32 === a;
          ...
          function b(e) {
            ...
            return (
              ...
              !(
                ...
                ((n += 3), (t = e.input.charCodeAt(n)), 0 !== t && !o(t))
              )
            );
          }
          function w(e, t) {
          ...
          function C(e, t, n) {
            ...
            if (
              (63 === m || 45 === m) &&
              ((c = e.input.charCodeAt(e.position + 1)), o(c) || (n && a(c)))
            )
              return !1;
            for (
              e.kind = "scalar", e.result = "", u = l = e.position, p = !1;
              0 !== m;
            ...
            return (
              g(e, u, l, !1), !!e.result || ((e.kind = y), (e.result = x), !1)
            );
          }
          function k(e, t) {
            var n, r, o;
            ...
            for (
              ...
              if (39 === n) {
                ...
                i(n)
                  ? (g(e, r, o, !0), w(e, A(e, !1, t)), (r = o = e.position))
                  : e.position === e.lineStart && b(e)
                    ? h(
                        e,
          ...
          function j(e, t) {
            ...
            for (
              ...
              if (92 === l) {
                ...
                i(l)
                  ? (g(e, n, r, !0), w(e, A(e, !1, t)), (n = r = e.position))
                  : e.position === e.lineStart && b(e)
                    ? h(
                        e,
          ...
          function I(e, t) {
            var n,
              ...
              y = e.anchor,
              v = {};
            if (((d = e.input.charCodeAt(e.position)), 91 === d))
              (a = 93), (u = !1), (i = []);
            else {
              if (123 !== d) return !1;
              (a = 125), (u = !0), (i = {});
            ...
            for (
              ...
              if ((A(e, !0, t), (d = e.input.charCodeAt(e.position)), d === a))
                return (
                  e.position++,
                  (e.tag = g),
                  (e.anchor = y),
              ...
              m || h(e, "missed comma between flow collection entries"),
                (p = l = f = null),
                (s = c = !1),
                63 === d &&
                  ((r = e.input.charCodeAt(e.position + 1)),
                  o(r) && ((s = c = !0), e.position++, A(e, !0, t))),
                (n = e.line),
                _(e, t, H, !1, !0),
                (p = e.tag),
                (l = e.result),
          ...
          function S(e, t) {
            ...
            for (e.kind = "scalar", e.result = ""; 0 !== s; )
              if (
                ((s = e.input.charCodeAt(++e.position)), 43 === s || 45 === s)
              )
                z === c
                  ? (c = 43 === s ? Q : J)
            ...
            for (; 0 !== s; ) {
              for (
                v(e), e.lineIndent = 0, s = e.input.charCodeAt(e.position);
                (!p || e.lineIndent < f) && 32 === s;
              ...
              if ((!p && e.lineIndent > f && (f = e.lineIndent), i(s))) d++;
                ...
                for (
                  o
                    ? r(s)
                      ? ((m = !0), (e.result += R.repeat("\n", l ? 1 + d : d)))
                      : m
                        ? ((m = !1), (e.result += R.repeat("\n", d + 1)))
                        : 0 === d
                          ? l && (e.result += " ")
                          : (e.result += R.repeat("\n", d))
                    : (e.result += R.repeat("\n", l ? 1 + d : d)),
          ...
          function O(e, t) {
            ...
            for (
              ...
              0 !== r &&
              45 === r &&
              ((i = e.input.charCodeAt(e.position + 1)), o(i));

            )
              if (((u = !0), e.position++, A(e, !0, -1) && e.lineIndent <= t))
                c.push(null), (r = e.input.charCodeAt(e.position));
              else if (
                ((n = e.line),
                _(e, t, V, !1, !0),
                c.push(e.result),
          ...
          function E(e, t, n) {
            ...
            for (
              ...
              if (
                ...
                if (e.line === s) {
                  for (c = e.input.charCodeAt(e.position); r(c); )
                    c = e.input.charCodeAt(++e.position);
                  if (58 === c)
                    (c = e.input.charCodeAt(++e.position)),
                      o(c) ||
              ...
              if (
                ((e.line === s || e.lineIndent > t) &&
                  (_(e, t, Z, !0, a) && (y ? (m = e.result) : (g = e.result)),
                  y || (x(e, p, f, d, m, g), (d = m = g = null)),
                  A(e, !0, -1),
                  (c = e.input.charCodeAt(e.position))),
                e.lineIndent > t && 0 !== c)
              )
          ...
          function F(e) {
            ...
            if (
              (null !== e.tag && h(e, "duplication of a tag property"),
              (r = e.input.charCodeAt(++e.position)),
              60 === r
                ? ((a = !0), (r = e.input.charCodeAt(++e.position)))
                : 33 === r
                  ? ((s = !0),
                    (n = "!!"),
                    (r = e.input.charCodeAt(++e.position)))
              ...
              e.position < e.length
                ? ((i = e.input.slice(t, e.position)),
                  (r = e.input.charCodeAt(++e.position)))
                : h(e, "unexpected end of the stream within a verbatim tag");
            } else {
              for (; 0 !== r && !o(r); )
                33 === r &&
                  (s
                    ...
                    : ((n = e.input.slice(t - 1, e.position + 1)),
                      ne.test(n) ||
                        h(e, "named tag handle cannot contain such characters"),
                      (s = !0),
                      (t = e.position + 1))),
                  (r = e.input.charCodeAt(++e.position));
              (i = e.input.slice(t, e.position)),
                te.test(i) &&
                  h(e, "tag suffix cannot contain flow indicator characters");
            }
            return (
              i &&
                !ie.test(i) &&
                h(e, "tag name cannot contain such characters: " + i),
              a
                ? (e.tag = i)
                : $.call(e.tagMap, n)
                  ? (e.tag = e.tagMap[n] + i)
          ...
          function N(e) {
            ...
            for (
              null !== e.anchor && h(e, "duplication of an anchor property"),
                n = e.input.charCodeAt(++e.position),
                t = e.position;
              0 !== n && !o(n) && !a(n);
          ...
          function _(e, t, n, i, r) {
            ...
            if (
                        ...
                        : M(e)
                          ? ((g = !0),
                            (null === e.tag && null === e.anchor) ||
                              h(e, "alias node should not have any properties"))
                          : C(e, p, H === n) &&
              ...
              if ("?" === e.tag) {
                ...
                $.call(e.typeMap[e.kind || "fallback"], e.tag)
          ...
          function T(e) {
            ...
            for (
              ...
              for (
                u = !0, s = e.input.charCodeAt(++e.position), t = e.position;
                0 !== s && !o(s);
            ...
            return (
              ...
              45 === e.input.charCodeAt(e.position + 2)
                ? ((e.position += 3), A(e, !0, -1))
                : u && h(e, "directives end mark is expected"),
              _(e, e.lineIndent - 1, Z, !1, !0),
              A(e, !0, -1),
              e.checkLineBreaks &&
                ee.test(e.input.slice(c, e.position)) &&
          ...
          function q(e, t, n) {
            D(e, t, R.extend({ schema: B }, n));
          }
          function Y(e, t) {
            return U(e, R.extend({ schema: B }, t));
          }
          for (
            var R = e("./common"),
              P = e("./exception"),
              W = e("./mark"),
              B = e("./schema/default_safe"),
              K = e("./schema/default_full"),
            ...
            (re[ae] = l(ae) ? 1 : 0), (oe[ae] = l(ae));
          var se = {
            YAML: function(e, t, n) {
              var i, r, o;
              null !== e.version && h(e, "duplication of %YAML directive"),
                1 !== n.length &&
                  h(e, "YAML directive accepts exactly one argument"),
                (i = /^([0-9]+)\.([0-9]+)$/.exec(n[0])),
                null === i && h(e, "ill-formed argument of the YAML directive"),
                (r = parseInt(i[1], 10)),
                (o = parseInt(i[2], 10)),
                1 !== r && h(e, "unacceptable YAML version of the document"),
                (e.version = n[0]),
            ...
            TAG: function(e, t, n) {
              var i, r;
              2 !== n.length &&
                h(e, "TAG directive accepts exactly two arguments"),
                (i = n[0]),
                (r = n[1]),
                ne.test(i) ||
                  h(
        ...
        function(e, t, n) {
          ...
          function i(e) {
            ...
            for (t = 0, n = u.length; t < n; t += 1) {
              if (((i = u[t]), (o = !1), "[object Object]" !== s.call(i)))
                return !1;
              for (r in i)
                if (a.call(i, r)) {
                  if (o) return !1;
        ...
        function(e, t, n) {
          ...
          function r(e) {
            var t,
              ...
              d = 0,
              h = null;
            if (((t = s.exec(e)), null === t && (t = c.exec(e)), null === t))
            ...
            return (
              t[9] &&
                ...
                (h = 6e4 * (60 * l + p)),
                "-" === t[9] && (h = -h)),
              (f = new Date(Date.UTC(n, i, r, o, a, u, d))),
