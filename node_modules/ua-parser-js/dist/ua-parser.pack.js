  ...
  var c = "function",
    ...
    v = {
      ...
      device: [
        ...
        [[s, g.str, h.device.amazon.model], [n, "Amazon"], [o, l]],
        ...
        [[n, f.trim], [s, f.trim], [o, b]],
        [/hbbtv.+maple;(\d+)/i],
        [[s, /^/, "SmartTV"], [n, "Samsung"], [o, b]],
        [/\(dtv[\);].+(aquos)/i],
        [s, [n, "Sharp"], [o, b]],
        [
      ...
      os: [
        ...
        [[e, "Windows"], [a, g.str, h.os.windows.version]],
        [/\((bb)(10);/i],
        [[e, "BlackBerry"], a],
        [
          /(blackberry)\w*\/?([\w\.]*)/i,
