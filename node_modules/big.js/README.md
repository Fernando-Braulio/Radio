...
The BigDecimal in the npm registry is the GWT version. It has some bugs, see the Node.js script _perf/lib/bigdecimal_GWT/bugs.js_ for examples of flaws in its _remainder_, _divide_ and _compareTo_ methods.

_bigtime.js_ is a Node.js command-line application which tests the performance of big.js against the GWT version of
