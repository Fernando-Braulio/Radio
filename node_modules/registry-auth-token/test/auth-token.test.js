...
describe("auth-token", function() {
  ...
  describe("bearer token", function() {
    ...
    it("should use npmrc passed in", function(done) {
      ...
      fs.writeFile(npmRcPath, content, function(err) {
        ...
        assert.deepEqual(getAuthToken({ npmrc: npmrc }), {
          token: "qar",
          type: "Bearer"
        });
        done();
    ...
    it("recursively finds registries for deep url if option is set", function(
      done,
      undef
    ) {
  ...
  describe("basic token", function() {
    it("should return undefined if password or username are missing", function(
      done,
      undef
    ) {
      var content = [
