...
test("double operators", function(t) {
  ...
  t.same(parse("beep\\&\\&boop||byte"), ["beep&&boop", { op: "||" }, "byte"]);
  t.same(parse("beep\\&&boop||byte"), [
    "beep&",
    { op: "&" },
    "boop",
  ...
  t.same(parse("beep;;boop|&byte>>blip"), [
    "beep",
    { op: ";;" },
    "boop",
    { op: "|&" },
...
test("glob patterns", function(t) {
  t.same(parse("tap test/*.test.js"), [
    "tap",
    { op: "glob", pattern: "test/*.test.js" }
  ]);
