...
class ReplaceSource extends Source {
  ...
  replace(start, end, newValue, name) {
    ...
    this.replacements.push(
      new Replacement(start, end, newValue, this.replacements.length, name)
    );
  }
  ...
  insert(pos, newValue, name) {
    ...
    this.replacements.push(
      new Replacement(pos, pos - 1, newValue, this.replacements.length, name)
    );
  }
  ...
  node(options) {
    ...
    var replaceInStringNode = this._replaceInStringNode.bind(
      this,
      output,
      replace,
