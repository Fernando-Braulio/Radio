...
var _OptionalMemberExpression2 = _interopRequireDefault(
  _OptionalMemberExpression
);
...
var errorMessage = function errorMessage(expression) {
  return (
    "The prop value with an expression type of " +
    expression +
    " could not be resolved. Please file issue to get this fixed immediately."
  );
};
