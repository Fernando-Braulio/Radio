...
exports.assign = function(parser) {
  ...
  parser._insertTemplate = function(token) {
    ...
    var tmplContent = this.treeAdapter.getChildNodes(
  ...
  parser._findFosterParentingLocation = function() {
    ...
    this.lastFosterParentingLocation = parserProto._findFosterParentingLocation.call(
      this
    );
  ...
  parser._insertCharacters = function(token) {
    ...
    var hasFosterParent = this._shouldFosterParentOnInsertion(),
      ...
      parent =
        (hasFosterParent && parentingLocation.parent) ||
        this.openElements.currentTmplContent ||
        this.openElements.current,
      siblings = this.treeAdapter.getChildNodes(parent),
      textNodeIdx =
        hasFosterParent && parentingLocation.beforeElement
          ? siblings.indexOf(parentingLocation.beforeElement) - 1
          : siblings.length - 1,
      textNode = siblings[textNodeIdx];

    //NOTE: if we have location assigned by another token, then just update end position
    if (textNode.__location) textNode.__location.end = token.location.end;
