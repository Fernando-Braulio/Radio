...
OpenElementStack.prototype._updateCurrentElement = function() {
  ...
  this.currentTmplContent = this._isInTemplate()
    ? this.treeAdapter.getChildNodes(this.current)[0]
    : null;
};
...
OpenElementStack.prototype.insertAfter = function(
  referenceElement,
  newElement
) {
...
OpenElementStack.prototype.generateImpliedEndTagsWithExclusion = function(
  exclusionTagName
) {
  while (
