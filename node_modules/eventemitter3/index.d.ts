type EventNames<
  T extends string | symbol | { [K in string | symbol]: any[] }
...
declare class EventEmitter<
  EventTypes extends string | symbol | { [K in keyof EventTypes]: any[] } =
    | string
    | symbol
> {
  ...
  listeners<T extends EventNames<EventTypes>>(
    event: T
  ): Array<EventEmitter.ListenerFn<EventArgs<EventTypes, T>>>;
