...
test("equal", function(t) {
	t.deepEqualTest({ a: [2, 3], b: [4] }, { a: [2, 3], b: [4] }, "two equal objects", true, true, false);
	t.end();
});

test("not equal", function(t) {
	t.deepEqualTest({ x: 5, y: [6] }, { x: 5, y: 6 }, "two inequal objects are", false, false);
	t.end();
});

test("nested nulls", function(t) {
	t.deepEqualTest([null, null, null], [null, null, null], "same-length arrays of nulls", true, true, true);
	t.end();
});

test("objects with strings vs numbers", function(t) {
	t.deepEqualTest([{ a: 3 }, { b: 4 }], [{ a: "3" }, { b: "4" }], "objects with equivalent string/number values", true, false);
	t.end();
});
...
test("arguments class", function(t) {
	...
	t.ok(equal(getArgs(1, 2, 3), getArgs(1, 2, 3)), "equivalent arguments objects are equal");

	t.deepEqualTest(getArgs(1, 2, 3), [1, 2, 3], "array and arguments with same contents", false, false);
...
test("buffers", function(t) {
	...
	t.deepEqualTest(Buffer("abc"), Buffer("xyz"), "buffers with different contents", false, false);

	t.deepEqualTest(Buffer(""), [], "empty buffer and empty array", false, false);

	t.end();
});

test("booleans and arrays", function(t) {
	t.deepEqualTest(true, [], "true and an empty array", false, false);
	t.deepEqualTest(false, [], "false and an empty array", true, false);
	t.end();
});

test("arrays initiated", function(t) {
	var a0 = [undefined, null, -1, 0, 1, false, true, undefined, "", "abc", null, undefined],
		a1 = [undefined, null, -1, 0, 1, false, true, undefined, "", "abc", null, undefined];
...
test("Object.create", { skip: !Object.create }, function(t) {
	...
	t.deepEqualTest(b, c, "two objects with the same [[Prototype]] but a different own property", false, false);

	t.end();
});

test("Object.create(null)", { skip: !Object.create }, function(t) {
	t.deepEqualTest(Object.create(null), Object.create(null), "two empty null objects", true, true, true);
