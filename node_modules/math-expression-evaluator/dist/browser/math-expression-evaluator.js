	 ...
	 */
          ...
          Mexp.lex = function(inp, tokens) {
            ...
            for (i = 0; i < inpStr.length; i++) {
              ...
              sec: for (
                x =
                  inpStr.length - i > newAr.length - 2
                    ? newAr.length - 1
                    : inpStr.length - i;
                x > 0;
                x--
              ...
              i += key.length - 1;
              if (key === "") {
                throw new Mexp.exception(
                  "Can't understand after " + inpStr.slice(i)
                );
              }
                ...
                if (ptc[j] === 0) {
                  if ([0, 2, 3, 5, 9, 11, 12, 13].indexOf(cType) !== -1) {
                    if (allowed[cType] !== true) {
                      throw new Mexp.exception(
                        key + " is not allowed after " + prevKey
                      );
                    }
        ...
        function(require, module, exports) {
          ...
          Mexp.math = {
            ...
            P: function(n, r) {
              var pro = 1;
              for (
                var i = Math.floor(n) - Math.floor(r) + 1;
                i <= Math.floor(n);
                i++
              )
                pro *= i;
      ...
      5: [
        function(require, module, exports) {
          ...
          Mexp.prototype.postfixEval = function(UserDefined) {
            ...
            for (var i = 0; i < arr.length; i++) {
              if (arr[i].type === 1) {
                ...
                if (typeof stack[stack.length - 1].type === "undefined") {
                  ...
                  stack[stack.length - 1].value = arr[i].value(
            ...
            return stack[0].value > 1000000000000000
              ? "Infinity"
              : parseFloat(stack[0].value.toFixed(15));
          };
